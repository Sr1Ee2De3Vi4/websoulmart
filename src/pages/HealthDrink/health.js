...
import './health.css';
import slide2 from'../../assets/healthslide1.jpg'

import veg from'../../assets/veg.png'
import card1 from'../../assets/healthh1.jpg'
import card2 from'../../assets/healthh2.jpg'
import card3 from'../../assets/healthh3.jpg'
import card4 from'../../assets/healthh4.jpg'
import card5 from'../../assets/healthh5.jpg'
import card6 from'../../assets/healthh6.jpg'
import card7 from'../../assets/healthh7.jpg'
import card8 from'../../assets/healthh8.jpg'
...
<div className="uk-width-3-4" style={{}}>
 {/* fruits and veg cards */}
        ...
        <label class="header-label  ">Health Drink</label> 
        </div>
        <div class="col-3">
...
<label class="header-labels ">Health Drink </label>
</div>
<div>
...
const categorydatas = [
    {
    title: "Category",
    pagename:"Health Drink",
    pageurl:"/health",
    content: [
    {
        datas: "Children (2-5 Yrs) ",
       
        url:"/health"
    },
    {
        datas: "Diabetic Drinks",
        url:"/health"
    },
    {
        datas: "Glucose Powder, Tablets",
        url:"/health"
    },
...
const griditems = [
    { id: 1, title: 'Enfagrow', objectname: 'Syrup - Milk Booster', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1, card_link:'Healthcard' },
    { id: 2, title: 'Enfagrow',objectname: 'Pro-Health Drink - Chocolate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link:'Healthcard' },
    { id: 3, title: 'Enfagrow',objectname: 'Hot Chocolate Drink Powder Mix', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link:'Healthcard' },
    { id: 4, title: 'Enfagrow',objectname: 'Aloe Vera and Turmeric Juice', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4, card_link:'Healthcard' },
    { id: 5, title: 'Enfagrow', objectname: 'Kids Nutrition Shake - For Ages', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5, card_link:'Healthcard' },
    { id: 6, title: 'Enfagrow', objectname: 'Drink Mix - Badam', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6, card_link:'Healthcard' },
    { id: 7, title: 'Enfagrow', objectname: 'A+ Nutritional Milk Powder Health Drink for Children (3+ years), Chocolate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7, card_link:'Healthcard' },
    { id: 8, title: 'Enfagrow', objectname: 'Mango Slim Shake - Weight Control Powered By Ayurveda', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8, card_link:'Healthcard' },
    { id: 9, title: 'Enfagrow', objectname: 'Syrup - Milk Booster', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1, card_link:'Healthcard' },
    { id: 10, title: 'Enfagrow',objectname: 'Pro-Health Drink - Chocolate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link:'Healthcard' },
    { id: 11, title: 'Enfagrow',objectname: 'Hot Chocolate Drink Powder Mix', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link:'Healthcard' },
    { id: 12, title: 'Enfagrow',objectname: 'Aloe Vera and Turmeric Juice', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4, card_link:'Healthcard' },
    { id: 13, title: 'Enfagrow', objectname: 'Kids Nutrition Shake - For Ages', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5, card_link:'Healthcard' },
    { id: 14, title: 'Enfagrow', objectname: 'Drink Mix - Badam', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6, card_link:'Healthcard' },
    { id: 15, title: 'Enfagrow', objectname: 'A+ Nutritional Milk Powder Health Drink for Children (3+ years), Chocolate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7, card_link:'Healthcard' },
    { id: 16, title: 'Enfagrow', objectname: 'Mango Slim Shake - Weight Control Powered By Ayurveda', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8, card_link:'Healthcard' },
