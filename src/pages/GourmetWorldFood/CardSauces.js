...
const dataItems = [
    {
        ...
        content: [
        {datas: "Nutella"},
        {datas: "Nutella Chocolate, Peanut Spread"},
        ]
},
];
...
const griditems = [
    { id: 1, title: 'Nutella', objectname: 'Hazelnut Spread with Cocoa', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 2, title: 'bb Combo', objectname: 'Happy Chef Pasta- Fusilli 500g + Sauce - Arrabiata 270g + Borges Olive Oil 1L', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 3, title: 'bb Combo', objectname: 'Happy Chef Pasta- Penne Rigate 500g +Sauce - Arrabiata 270g +Borges Olive Oil 1L', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 4, title: 'Wingreens Farms', objectname: 'Garlic Dip', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
    { id: 5, title: 'Wingreens Farms', objectname: 'Pizza N Pasta Sauce', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 },
    { id: 6, title: 'Disano', objectname: 'Unsweetened Peanut Butter -100% Natural, Creamy', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 },
    { id: 7, title: 'Pintola', objectname: 'All Natural Peanut Butter - Unsweetened, Crunchy', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 },
    { id: 8, title: 'bb Combo', objectname: 'Disano Pasta Spaghetti 500G+Olive Oil Extra Light 1L+HappyChef Pasta Sauce 270', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 },
    { id: 9, title: 'Nutella', objectname: 'Hazelnut Spread with Cocoa', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 10, title: 'bb Combo', objectname: 'Happy Chef Pasta- Fusilli 500g + Sauce - Arrabiata 270g + Borges Olive Oil 1L', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 11, title: 'bb Combo', objectname: 'Happy Chef Pasta- Penne Rigate 500g +Sauce - Arrabiata 270g +Borges Olive Oil 1L', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 12, title: 'Wingreens Farms', objectname: 'Garlic Dip', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
    { id: 13, title: 'Wingreens Farms', objectname: 'Pizza N Pasta Sauce', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 },
    { id: 14, title: 'Disano', objectname: 'Unsweetened Peanut Butter -100% Natural, Creamy', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 },
    { id: 15, title: 'Pintola', objectname: 'All Natural Peanut Butter - Unsweetened, Crunchy', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 },
    { id: 16, title: 'bb Combo', objectname: 'Disano Pasta Spaghetti 500G+Olive Oil Extra Light 1L+HappyChef Pasta Sauce 270', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 },
  ];
  

export default CardSauces;