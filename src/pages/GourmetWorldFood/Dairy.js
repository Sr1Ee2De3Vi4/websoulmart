...
import card1 from'../../assets/dairy1.jpg'
import card2 from'../../assets/dairy2.jpg'
import card3 from'../../assets/dairy3.jpg'
import card4 from'../../assets/dairy4.jpg'
import card5 from'../../assets/dairy5.jpg'
import card6 from'../../assets/dairy6.jpg'
import card7 from'../../assets/dairy7.jpg'
import card8 from'../../assets/dairy8.jpg'
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Dairy & Cheese</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Dairy & Cheese</label>
                        </div>
...
const categorydatas = [
    ...
    {
        datas: "Cream & Cheese Spreads",
        url:"/Dairy"
    },
    {
        datas: "Flavoured & Greek Yogurt",
        url:"/Dairy"
        
    },
    {
        datas: "Gourmet Ice Cream",
        url:"/Dairy"
        
    },
    {
        datas: "International Cheese",
        url:"/Dairy"
    },
    {
        datas: "Milk & Soya Drinks",
        url:"/Dairy"
...
const griditems = [
    { id: 1, title: 'Diet Tofu', objectname: 'Soya Paneer', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardDairy'},
    { id: 2, title: 'bb Combo', objectname: 'Epigamia Greek Yogurt - Natural 90G + Fresho Strawberry 200G', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardDairy'},
    { id: 3, title: 'Epigamia', objectname: 'Greek Yogurt - Natural', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardDairy'},
    { id: 4, title: 'Epigamia', objectname: 'Greek Yogurt - Blueberry', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardDairy'},
    { id: 5, title: 'Epigamia', objectname: 'Greek Yogurt - Alphonso Mango', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardDairy'},
    { id: 6, title: 'Murginns', objectname: 'Organic Tofu - Soy Paneer', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardDairy'},
    { id: 7, title: 'Epigamia', objectname: 'Greek Yogurt - Strawberry', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardDairy'},
    { id: 8, title: 'MOOZ', objectname: 'Cheddar Cheese', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardDairy'},
    { id: 9, title: 'Diet Tofu', objectname: 'Soya Paneer', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardDairy'},
    { id: 10, title: 'bb Combo', objectname: 'Epigamia Greek Yogurt - Natural 90G + Fresho Strawberry 200G', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardDairy'},
    { id: 11, title: 'Epigamia', objectname: 'Greek Yogurt - Natural', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardDairy'},
    { id: 12, title: 'Epigamia', objectname: 'Greek Yogurt - Blueberry', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardDairy'},
    { id: 13, title: 'Epigamia', objectname: 'Greek Yogurt - Alphonso Mango', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardDairy'},
    { id: 14, title: 'Murginns', objectname: 'Organic Tofu - Soy Paneer', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardDairy'},
    { id: 15, title: 'Epigamia', objectname: 'Greek Yogurt - Strawberry', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardDairy'},
    { id: 16, title: 'MOOZ', objectname: 'Cheddar Cheese', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardDairy'},
  ];
