...
import slide3 from'../../assets/Gourmetslide5.jpg'
import card1 from'../../assets/cooking1.jpg'
import card2 from'../../assets/cooking2.jpg'
import card3 from'../../assets/cooking3.jpg'
import card4 from'../../assets/cooking4.jpg'
import card5 from'../../assets/cooking5.jpg'
import card6 from'../../assets/cooking6.jpg'
import card7 from'../../assets/cooking7.jpg'
import card8 from'../../assets/cooking8.jpg'
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Cooking & Baking Needs</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Cooking & Baking Needs</label>
                        </div>
...
const categorydatas = [
    ...
    {
        datas: "Baking, Cake Decorations",
        url:"/Cooking"
    },
    {
        datas: "Cooking Chocolate, Cocoa",
        url:"/Cooking"
    },
    {
        datas: "Curry Paste, Coconut Milk",
        url:"/Cooking"
        
    },
    {
        datas: "Exotic Sugar & Salt",
        url:"/Cooking"
        
    },
    {
        datas: "Flours & Pre-Mixes",
        url:"/Cooking"
        
    },
    {
        datas: "Herbs, Seasonings & Rubs",
        url:"/Cooking"
...
const griditems = [
    { id: 1, title: 'Puro', objectname: 'Salt - Unrefined, 100% Natural', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardCooking'},
    { id: 2, title: 'Real Thai', objectname: 'Coconut Cream', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardCooking'},
    { id: 3, title: 'Fresh Ground', objectname: 'Coriander Powder, Parrot Grade', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardCooking'},
    { id: 4, title: 'Puramate', objectname: 'Mixed Herbs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardCooking'},
    { id: 5, title: 'Puramate', objectname: 'Monosodium Glutamate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardCooking'},
    { id: 6, title: 'Puramate', objectname: 'Mugcake Mix - Chocolate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardCooking'},
    { id: 7, title: 'Puramate', objectname: 'Mugcake Mix - Vanilla', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardCooking'},
    { id: 8, title: 'Puramate', objectname: 'Onion Flakes', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardCooking'},
    { id: 9, title: 'Puro', objectname: 'Salt - Unrefined, 100% Natural', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardCooking'},
    { id: 10, title: 'Real Thai', objectname: 'Coconut Cream', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardCooking'},
    { id: 11, title: 'Fresh Ground', objectname: 'Coriander Powder, Parrot Grade', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardCooking'},
    { id: 12, title: 'Puramate', objectname: 'Mixed Herbs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardCooking'},
    { id: 13, title: 'Puramate', objectname: 'Monosodium Glutamate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardCooking'},
    { id: 14, title: 'Puramate', objectname: 'Mugcake Mix - Chocolate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardCooking'},
    { id: 15, title: 'Puramate', objectname: 'Mugcake Mix - Vanilla', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardCooking'},
    { id: 16, title: 'Puramate', objectname: 'Onion Flakes', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardCooking'},
  ];
