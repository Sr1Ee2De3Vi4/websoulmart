...
import slide2 from'../../assets/Gourmetslide1.jpg'
import slide3 from'../../assets/Gourmetslide2.jpg'
import card1 from'../../assets/sauce1.jpg'
import card2 from'../../assets/sauce2.jpg'
import card3 from'../../assets/sauce3.jpg'
import card4 from'../../assets/sauce4.jpg'
import card5 from'../../assets/sauce5.jpg'
import card6 from'../../assets/sauce6.jpg'
import card7 from'../../assets/sauce7.jpg'
import card8 from'../../assets/sauce8.jpg'
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Sauces, Spreads & Dips</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Sauces, Spreads & Dips</label>
                        </div>
...
const categorydatas = [
    ...
    {
        datas: "Chocolate, Peanut Spread",
        url:"/Sauces"
    },
    {
        datas: "Honey & Maple Syrup",
        url:"/Sauces"
    },
    {
        datas: "Hummus, Cheese, Salsa Dip",
        url:"/Sauces"
        
    },
    {
        datas: "Jams, Marmalade, Spreads",
        url:"/Sauces"
        
    },
    {
        datas: "Mustard & Cheese Sauces",
        url:"/Sauces"
    },
    {
        datas: "Salad Dressings",
        url:"/Sauces"
        
    },
    {
        datas: "Thai & Asian Sauces",
        url:"/Sauces"
...
const griditems = [
    { id: 1, title: 'Nutella', objectname: 'Hazelnut Spread with Cocoa', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardSauces'},
    { id: 2, title: 'bb Combo', objectname: 'Happy Chef Pasta- Fusilli 500g + Sauce - Arrabiata 270g + Borges Olive Oil 1L', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardSauces'},
    { id: 3, title: 'bb Combo', objectname: 'Happy Chef Pasta- Penne Rigate 500g +Sauce - Arrabiata 270g +Borges Olive Oil 1L', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardSauces'},
    { id: 4, title: 'Wingreens Farms', objectname: 'Garlic Dip', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardSauces'},
    { id: 5, title: 'Wingreens Farms', objectname: 'Pizza N Pasta Sauce', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardSauces'},
    { id: 6, title: 'Disano', objectname: 'Unsweetened Peanut Butter -100% Natural, Creamy', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardSauces'},
    { id: 7, title: 'Pintola', objectname: 'All Natural Peanut Butter - Unsweetened, Crunchy', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardSauces'},
    { id: 8, title: 'bb Combo', objectname: 'Disano Pasta Spaghetti 500G+Olive Oil Extra Light 1L+HappyChef Pasta Sauce 270', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardSauces'},
    { id: 9, title: 'Nutella', objectname: 'Hazelnut Spread with Cocoa', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardSauces'},
    { id: 10, title: 'bb Combo', objectname: 'Happy Chef Pasta- Fusilli 500g + Sauce - Arrabiata 270g + Borges Olive Oil 1L', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardSauces'},
    { id: 11, title: 'bb Combo', objectname: 'Happy Chef Pasta- Penne Rigate 500g +Sauce - Arrabiata 270g +Borges Olive Oil 1L', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardSauces'},
    { id: 12, title: 'Wingreens Farms', objectname: 'Garlic Dip', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardSauces'},
    { id: 13, title: 'Wingreens Farms', objectname: 'Pizza N Pasta Sauce', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardSauces'},
    { id: 14, title: 'Disano', objectname: 'Unsweetened Peanut Butter -100% Natural, Creamy', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardSauces'},
    { id: 15, title: 'Pintola', objectname: 'All Natural Peanut Butter - Unsweetened, Crunchy', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardSauces'},
    { id: 16, title: 'bb Combo', objectname: 'Disano Pasta Spaghetti 500G+Olive Oil Extra Light 1L+HappyChef Pasta Sauce 270', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardSauces'},
  ];
