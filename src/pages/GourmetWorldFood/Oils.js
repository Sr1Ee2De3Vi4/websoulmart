...
import card1 from'../../assets/oil1.jpg'
import card2 from'../../assets/oil2.webp'
import card3 from'../../assets/oil3.jpg'
import card4 from'../../assets/oil4.jpg'
import card5 from'../../assets/oil5.jpg'
import card6 from'../../assets/oil6.jpg'
import card7 from'../../assets/oil7.jpg'
import card8 from'../../assets/oil8.jpg'
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Oils & Vinegar</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Oils & Vinegar</label>
                        </div>
...
const categorydatas = [
    ...
    {
        datas: "Balsamic & Cider Vinegar",
        url:"/Oils"
    },
    {
        datas: "Canola & Rapeseed Oil",
        url:"/Oils"
    },
    {
        datas: "Extra Virgin Olive Oil",
        url:"/Oils"
        
    },
    {
        datas: "Flavoured & Other Oils",
        url:"/Oils"
        
    },
    {
        datas: "Organic & Cold Press Oil",
        url:"/Oils"
    },
    {
        datas: "Pure, Pomace Olive Oil",
        url:"/Oils"
        
    },
    {
        datas: "Regular & White Vinegar",
        url:"/Oils"
        
    },
    
    {
        datas: "Wine & Rice Vinegar",
        url:"/Oils"
...
const griditems = [
    { id: 1, title: 'BORGES', objectname: 'Extra Virgin Olive Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardOils'},
    { id: 2, title: 'Figaro', objectname: 'Pure Olive Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardOils'},
    { id: 3, title: 'Leonardo', objectname: 'Olive Pomace Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardOils'},
    { id: 4, title: 'Jivo', objectname: 'Canola Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardOils'},
    { id: 5, title: 'Disano', objectname: 'Oil - Canola', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardOils'},
    { id: 6, title: 'BORGES', objectname: 'Canola Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardOils'},
    { id: 7, title: 'Oleev', objectname: 'Pomace Olive Oil - For All Types Of Cooking', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardOils'},
    { id: 8, title: 'Oleev', objectname: 'Pomace Olive Oil - For All Types Of Cooking', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardOils'},
    { id: 9, title: 'BORGES', objectname: 'Extra Virgin Olive Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardOils'},
    { id: 10, title: 'Figaro', objectname: 'Pure Olive Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardOils'},
    { id: 11, title: 'Leonardo', objectname: 'Olive Pomace Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardOils'},
    { id: 12, title: 'Jivo', objectname: 'Canola Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardOils'},
    { id: 13, title: 'Disano', objectname: 'Oil - Canola', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardOils'},
    { id: 14, title: 'BORGES', objectname: 'Canola Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardOils'},
    { id: 15, title: 'Oleev', objectname: 'Pomace Olive Oil - For All Types Of Cooking', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardOils'},
    { id: 16, title: 'Oleev', objectname: 'Pomace Olive Oil - For All Types Of Cooking', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardOils'},
  ];
