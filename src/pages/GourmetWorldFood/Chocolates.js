...
import card1 from'../../assets/chocolate1.jpg'
import card2 from'../../assets/chocolate2.jpg'
import card3 from'../../assets/chocolate3.jpg'
import card4 from'../../assets/chocolate4.jpg'
import card5 from'../../assets/chocolate5.jpg'
import card6 from'../../assets/chocolate6.jpg'
import card7 from'../../assets/chocolate7.jpg'
import card8 from'../../assets/chocolate8.jpg'
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Chocolates & Biscuits</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Chocolates & Biscuits</label>
                        </div>
...
const categorydatas = [
    {
        ...
        {
            datas: "Cookies, Biscotti, Wafer",
            url:"/Chocolates"
        },
    {
        datas: "Crackers & Digestive",
        url:"/Chocolates"
    },
    {
        datas: "International Chocolates",
        url:"/Chocolates"
        
    },
    {
        datas: "Luxury Chocolates, Gifts",
        url:"/Chocolates"
        
    },
    {
        datas: "Marshmallow, Candy, Jelly",
        url:"/Chocolates"
...
const griditems = [
    { id: 1, title: 'Snickers', objectname: 'Peanut Filled Chocolate Bar', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardChocolates'},
    { id: 2, title: 'Bauli', objectname: 'Moonfils - Mango', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardChocolates'},
    { id: 3, title: 'Ferrero', objectname: 'Rocher - Chocolate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardChocolates'},
    { id: 4, title: 'Ferrero', objectname: 'Rocher - Chocolate (24 pcs)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardChocolates'},
    { id: 5, title: 'Open Secret', objectname: 'Nutty Cookies - Choco Almond, No Added Maida, 40-50% Nuts,', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardChocolates'},
    { id: 6, title: 'Gery Gone Mad', objectname: 'Crackers - Cheese & Sugar, 10 Crackers', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardChocolates'},
    { id: 7, title: 'Lindberg', objectname: 'Classic Milk Chocolate Crispies', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardChocolates'},
    { id: 8, title: 'Tasties', objectname: 'Multigrain Cookies', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardChocolates'},
    { id: 9, title: 'Snickers', objectname: 'Peanut Filled Chocolate Bar', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardChocolates'},
    { id: 10, title: 'Bauli', objectname: 'Moonfils - Mango', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardChocolates'},
    { id: 11, title: 'Ferrero', objectname: 'Rocher - Chocolate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardChocolates'},
    { id: 12, title: 'Ferrero', objectname: 'Rocher - Chocolate (24 pcs)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardChocolates'},
    { id: 13, title: 'Open Secret', objectname: 'Nutty Cookies - Choco Almond, No Added Maida, 40-50% Nuts,', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardChocolates'},
    { id: 14, title: 'Gery Gone Mad', objectname: 'Crackers - Cheese & Sugar, 10 Crackers', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardChocolates'},
    { id: 15, title: 'Lindberg', objectname: 'Classic Milk Chocolate Crispies', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardChocolates'},
    { id: 16, title: 'Tasties', objectname: 'Multigrain Cookies', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardChocolates'},
  ];
