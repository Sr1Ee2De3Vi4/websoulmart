...
const dataItems = [
    {
        ...
        {datas: "American Garden Beans & Pulses"},
        ]
},
];
...
const griditems = [
    { id: 1, title: 'American Garden', objectname: 'Baked Beans in Tomato Sauce', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 2, title: 'Deli Chic', objectname: 'Chicken Smoked Golden Franks Sausages', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 3, title: 'Deli Chic', objectname: 'Pork Bacon Slice', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 4, title: 'Deli Chic', objectname: 'Pork Salami Slice', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
    { id: 5, title: 'Deli Chic', objectname: 'Chicken Spicy Seekh Kabab', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 },
    { id: 6, title: 'Sugarless Bliss', objectname: 'Sugar Free & Digestive Cookies - Chocolate & Blackcurrants', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 },
    { id: 7, title: 'Daucy', objectname: 'Extra Crisp Sweet Corn', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 },
    { id: 8, title: 'Daucy', objectname: 'Extra Fine Green Peas', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 },
    { id: 9, title: 'American Garden', objectname: 'Baked Beans in Tomato Sauce', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 10, title: 'Deli Chic', objectname: 'Chicken Smoked Golden Franks Sausages', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 11, title: 'Deli Chic', objectname: 'Pork Bacon Slice', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 12, title: 'Deli Chic', objectname: 'Pork Salami Slice', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
    { id: 13, title: 'Deli Chic', objectname: 'Chicken Spicy Seekh Kabab', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 },
    { id: 14, title: 'Sugarless Bliss', objectname: 'Sugar Free & Digestive Cookies - Chocolate & Blackcurrants', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 },
    { id: 15, title: 'Daucy', objectname: 'Extra Crisp Sweet Corn', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 },
    { id: 16, title: 'Daucy', objectname: 'Extra Fine Green Peas', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 },
  ];
  

export default CardTinned;