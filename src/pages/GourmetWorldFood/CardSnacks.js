...
<div className="uk-grid uk-grid-collapse">
                        ...
                        <div className="uk-width-1-2@l uk-width-1-2@m uk-width-1-1@s">
                            ...
                            <button class="uk-button uk-button-default">Save</button></div> <br />
                                    <div class="uk-margin-small-left uk-margin-top sss uk-padding-remove-left"><img src={icon1} className="  " alt="" width="25px" height="25px" />&nbsp;<span style={{ color: "#979797", fontSize: "13px" }}>Standard: Today 5:00PM - 8:00PM</span></div>
...
const griditems = [
    { id: 1, title: 'Cornitos', objectname: 'Nacho Crisps - Sizzlin Jalapeno', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 2, title: 'Cornitos', objectname: 'Nacho Crisps - Cheese & Herbs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 3, title: 'GoodDiet', objectname: 'Multigrain Puffs - Butter Makhana', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 4, title: 'GoodDiet', objectname: 'Multigrain Puffs - Tangy Tomato', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
    { id: 5, title: 'GoodDiet', objectname: 'Healthy Spicy Mix', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 },
    { id: 6, title: 'GoodDiet', objectname: 'Family Snack', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 },
    { id: 7, title: 'GoodDiet', objectname: 'Quinoa Puffs - Onion Masala', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 },
    { id: 8, title: 'GoodDiet', objectname: 'Healthy Multigrain Mix', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 },
    { id: 9, title: 'Cornitos', objectname: 'Nacho Crisps - Sizzlin Jalapeno', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 10, title: 'Cornitos', objectname: 'Nacho Crisps - Cheese & Herbs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 11, title: 'GoodDiet', objectname: 'Multigrain Puffs - Butter Makhana', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 12, title: 'GoodDiet', objectname: 'Multigrain Puffs - Tangy Tomato', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
    { id: 13, title: 'GoodDiet', objectname: 'Healthy Spicy Mix', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 },
    { id: 14, title: 'GoodDiet', objectname: 'Family Snack', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 },
    { id: 15, title: 'GoodDiet', objectname: 'Quinoa Puffs - Onion Masala', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 },
    { id: 16, title: 'GoodDiet', objectname: 'Healthy Multigrain Mix', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 },
    { id: 17, title: 'Cornitos', objectname: 'Nacho Crisps - Sizzlin Jalapeno', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 18, title: 'Cornitos', objectname: 'Nacho Crisps - Cheese & Herbs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 19, title: 'GoodDiet', objectname: 'Multigrain Puffs - Butter Makhana', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 20, title: 'GoodDiet', objectname: 'Multigrain Puffs - Tangy Tomato', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
  ];
