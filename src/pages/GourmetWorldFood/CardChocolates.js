...
const dataItems = [
    {
        ...
        content: [
        {datas: "Snickers"},
        {datas: "Snickers Luxury Chocolates, Gifts"},
        ]
},
];
...
const griditems = [
    { id: 1, title: 'Snickers', objectname: 'Peanut Filled Chocolate Bar', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 2, title: 'Bauli', objectname: 'Moonfils - Mango', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 3, title: 'Ferrero', objectname: 'Rocher - Chocolate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 4, title: 'Ferrero', objectname: 'Rocher - Chocolate (24 pcs)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
    { id: 5, title: 'Open Secret', objectname: 'Nutty Cookies - Choco Almond, No Added Maida, 40-50% Nuts,', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 },
    { id: 6, title: 'Gery Gone Mad', objectname: 'Crackers - Cheese & Sugar, 10 Crackers', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 },
    { id: 7, title: 'Lindberg', objectname: 'Classic Milk Chocolate Crispies', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 },
    { id: 8, title: 'Tasties', objectname: 'Multigrain Cookies', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 },
    { id: 9, title: 'Snickers', objectname: 'Peanut Filled Chocolate Bar', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 10, title: 'Bauli', objectname: 'Moonfils - Mango', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 11, title: 'Ferrero', objectname: 'Rocher - Chocolate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 12, title: 'Ferrero', objectname: 'Rocher - Chocolate (24 pcs)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
    { id: 13, title: 'Open Secret', objectname: 'Nutty Cookies - Choco Almond, No Added Maida, 40-50% Nuts,', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 },
    { id: 14, title: 'Gery Gone Mad', objectname: 'Crackers - Cheese & Sugar, 10 Crackers', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 },
    { id: 15, title: 'Lindberg', objectname: 'Classic Milk Chocolate Crispies', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 },
    { id: 16, title: 'Tasties', objectname: 'Multigrain Cookies', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 },
  ];
