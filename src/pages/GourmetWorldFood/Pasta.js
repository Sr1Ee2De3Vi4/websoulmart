...
import slide2 from'../../assets/Gourmetslide4.jpg'
import slide3 from'../../assets/Gourmetslide2.jpg'
import card1 from'../../assets/pasta1.jpg'
import card2 from'../../assets/pasta2.jpg'
import card3 from'../../assets/pasta3.jpg'
import card4 from'../../assets/pasta4.jpg'
import card5 from'../../assets/pasta5.jpg'
import card6 from'../../assets/pasta6.jpg'
import card7 from'../../assets/pasta7.jpg'
import card8 from'../../assets/pasta8.jpg'
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Pasta, Soup & Noodles</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Pasta, Soup & Noodles</label>
                        </div>
...
const categorydatas = [
    ...
    {
        datas: "Imported Noodles",
        url:"/Pasta"
    },
    {
        datas: "Imported Soups",
        url:"/Pasta"
    },
    {
        datas: "Jasmine & Sushi Rice",
        url:"/Pasta"
        
    },
    {
        datas: "Pastas & Spaghetti",
        url:"/Pasta"
...
const griditems = [
    { id: 1, title: 'bb Combo', objectname: 'Happy Chef Pasta- Fusilli 500g + Sauce - Arrabiata 270g + Borges Olive Oil 1L', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardPasta'},
    { id: 2, title: 'BORGES', objectname: 'Whole Wheat Pasta - Penne Rigate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardPasta'},
    { id: 3, title: 'Disano', objectname: 'Durum Wheat Pasta - Penne Rigate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardPasta'},
    { id: 4, title: 'BORGES', objectname: 'Fusilli - Tricolor Pasta', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardPasta'},
    { id: 5, title: 'bb Combo', objectname: 'Happy Chef Pasta- Penne Rigate 500g +Sauce - Arrabiata 270g +Borges Olive Oil 1L', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardPasta'},
    { id: 6, title: 'Disano', objectname: 'Pasta - Fusilli', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardPasta'},
    { id: 7, title: 'BORGES', objectname: 'Durum Wheat Pasta - Farfalle', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardPasta'},
    { id: 8, title: 'Disano', objectname: 'Pasta - Spaghetti', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardPasta'},
    { id: 9, title: 'bb Combo', objectname: 'Happy Chef Pasta- Fusilli 500g + Sauce - Arrabiata 270g + Borges Olive Oil 1L', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardPasta'},
    { id: 10, title: 'BORGES', objectname: 'Whole Wheat Pasta - Penne Rigate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardPasta'},
    { id: 11, title: 'Disano', objectname: 'Durum Wheat Pasta - Penne Rigate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardPasta' },
    { id: 12, title: 'BORGES', objectname: 'Fusilli - Tricolor Pasta', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardPasta'},
    { id: 13, title: 'bb Combo', objectname: 'Happy Chef Pasta- Penne Rigate 500g +Sauce - Arrabiata 270g +Borges Olive Oil 1L', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardPasta'},
    { id: 14, title: 'Disano', objectname: 'Pasta - Fusilli', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6, card_link:'CardPasta' },
    { id: 15, title: 'BORGES', objectname: 'Durum Wheat Pasta - Farfalle', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardPasta'},
    { id: 16, title: 'Disano', objectname: 'Pasta - Spaghetti', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardPasta'},
  ];
