...
import slide1 from'../../assets/Gourmetslide4.jpg'
import slide2 from'../../assets/Gourmetslide5.jpg'
import slide3 from'../../assets/Gourmetslide3.jpg'
import card1 from'../../assets/snack1.jpg'
import card2 from'../../assets/snack2.jpg'
import card3 from'../../assets/snack3.jpg'
import card4 from'../../assets/snack4.jpg'
import card5 from'../../assets/snack5.jpg'
import card6 from'../../assets/snack6.jpg'
import card7 from'../../assets/snack7.jpg'
import card8 from'../../assets/snack8.jpg'
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Snacks, Dry Fruits, Nuts</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Snacks, Dry Fruits, Nuts</label>
                        </div>
...
const categorydatas = [
    ...
    {
        datas: "Dry Fruits & Berries",
        url:"/Snacks"
    },
    {
        datas: "Gourmet Popcorn",
        url:"/Snacks"
    },
    {
        datas: "Healthy, Baked Snacks",
        url:"/Snacks"
    ...
    {
        datas: "Roasted Seeds & Nuts",
        url:"/Snacks"
        
    },
    {
        datas: "Trail & Cocktail Mixes",
        url:"/Snacks"
...
const griditems = [
    { id: 1, title: 'Cornitos', objectname: 'Nacho Crisps - Sizzlin Jalapeno', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardSnacks'},
    { id: 2, title: 'Cornitos', objectname: 'Nacho Crisps - Cheese & Herbs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardSnacks'},
    { id: 3, title: 'GoodDiet', objectname: 'Multigrain Puffs - Butter Makhana', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardSnacks'},
    { id: 4, title: 'GoodDiet', objectname: 'Multigrain Puffs - Tangy Tomato', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardSnacks'},
    { id: 5, title: 'GoodDiet', objectname: 'Healthy Spicy Mix', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardSnacks'},
    { id: 6, title: 'GoodDiet', objectname: 'Family Snack', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardSnacks'},
    { id: 7, title: 'GoodDiet', objectname: 'Quinoa Puffs - Onion Masala', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardSnacks'},
    { id: 8, title: 'GoodDiet', objectname: 'Healthy Multigrain Mix', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardSnacks'},
    { id: 9, title: 'Cornitos', objectname: 'Nacho Crisps - Sizzlin Jalapeno', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardSnacks'},
    { id: 10, title: 'Cornitos', objectname: 'Nacho Crisps - Cheese & Herbs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardSnacks'},
    { id: 11, title: 'GoodDiet', objectname: 'Multigrain Puffs - Butter Makhana', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardSnacks'},
    { id: 12, title: 'GoodDiet', objectname: 'Multigrain Puffs - Tangy Tomato', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardSnacks' },
    { id: 13, title: 'GoodDiet', objectname: 'Healthy Spicy Mix', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardSnacks'},
    { id: 14, title: 'GoodDiet', objectname: 'Family Snack', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardSnacks'},
    { id: 15, title: 'GoodDiet', objectname: 'Quinoa Puffs - Onion Masala', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardSnacks'},
    { id: 16, title: 'GoodDiet', objectname: 'Healthy Multigrain Mix', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardSnacks'},
    { id: 17, title: 'Cornitos', objectname: 'Nacho Crisps - Sizzlin Jalapeno', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardSnacks'},
    { id: 18, title: 'Cornitos', objectname: 'Nacho Crisps - Cheese & Herbs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardSnacks'},
    { id: 19, title: 'GoodDiet', objectname: 'Multigrain Puffs - Butter Makhana', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardSnacks'},
    { id: 20, title: 'GoodDiet', objectname: 'Multigrain Puffs - Tangy Tomato', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardSnacks'},
  ];
