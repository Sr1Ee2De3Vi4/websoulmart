...
import slide1 from'../../assets/Gourmetslide3.jpg'
import slide2 from'../../assets/Gourmetslide2.jpg'
import slide3 from'../../assets/Gourmetslide4.jpg'
import card1 from'../../assets/drink1.jpg'
import card2 from'../../assets/drink2.jpg'
import card3 from'../../assets/drink3.jpg'
import card4 from'../../assets/drink4.jpg'
import card5 from'../../assets/drink5.jpg'
import card6 from'../../assets/drink6.jpg'
import card7 from'../../assets/drink7.jpg'
import card8 from'../../assets/drink8.jpg'
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Drinks & Beverages</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Drinks & Beverages</label>
                        </div>
...
const categorydatas = [
    ...
    {
        datas: "Aerated, Still, Sparkling",
        url:"/Drinks"
    },
    {
        datas: "Cocktail Mixes",
        url:"/Drinks"
    },
    {
        datas: "Coffee & Pre-Mix",
        url:"/Drinks"
        
    },
    {
        datas: "Gourmet Juices & Drinks",
        url:"/Drinks"
        
    },
{
        datas: "Gourmet Tea & Tea Bags",
        url:"/Drinks"
    },
    {
        datas: "Health Drinks",
...
const griditems = [
    { id: 1, title: 'Raw Pressery', objectname: '100% Natural Cold Pressed Juice - Valencia Orange', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardDrinks'},
    { id: 2, title: 'Nescafe', objectname: 'Gold Blend Instant Coffee Powder - Rich & Smooth', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardDrinks'},
    { id: 3, title: 'Davidoff', objectname: 'Coffee - Rich Aroma', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardDrinks'},
    { id: 4, title: 'Raw Pressery', objectname: '100% Natural Cold Pressed Juice - Pomegranate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardDrinks'},
    { id: 5, title: 'Brewhouse Tea Brewing Co.', objectname: 'Classic Lemon Ice Tea', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardDrinks'},
    { id: 6, title: 'Raw Pressery', objectname: 'Cold Pressed Juice - Life', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardDrinks'},
    { id: 7, title: 'Kapiva Ayurveda', objectname: 'Aloe Vera Juice', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardDrinks'},
    { id: 8, title: 'Raw Pressery', objectname: '100% Natural Cold Pressed Juice - Sugarcane', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardDrinks'},
    { id: 9, title: 'Raw Pressery', objectname: '100% Natural Cold Pressed Juice - Valencia Orange', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardDrinks'},
    { id: 10, title: 'Nescafe', objectname: 'Gold Blend Instant Coffee Powder - Rich & Smooth', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardDrinks'},
    { id: 11, title: 'Davidoff', objectname: 'Coffee - Rich Aroma', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardDrinks'},
    { id: 12, title: 'Raw Pressery', objectname: '100% Natural Cold Pressed Juice - Pomegranate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardDrinks'},
    { id: 13, title: 'Brewhouse Tea Brewing Co.', objectname: 'Classic Lemon Ice Tea', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardDrinks'},
    { id: 14, title: 'Raw Pressery', objectname: 'Cold Pressed Juice - Life', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardDrinks'},
    { id: 15, title: 'Kapiva Ayurveda', objectname: 'Aloe Vera Juice', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardDrinks'},
    { id: 16, title: 'Raw Pressery', objectname: '100% Natural Cold Pressed Juice - Sugarcane', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardDrinks'},
  ];
