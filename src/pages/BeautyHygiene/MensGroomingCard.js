...
function MensGroomingCard(props) {
    let { id } = useParams();
    return (
...
const griditems = [
    { id: 1, title: 'Glow & Lovely', objectname: 'Pure Coconut Oil', select1: '600ml', select2: '', oldprice: 'Rs. 80', newprice: 'Rs. 79', pic: slide1 },
    { id: 2, title: 'Pink Line', objectname: 'Keratin Smooth Shampoo', select1: '580ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide18 },
    { id: 3, title: 'Pink Line', objectname: 'Hair Fall Rescue Shampoo', select1: '650ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide12 },
    { id: 4, title: 'Pink Line', objectname: 'Bringha Oil', select1: '250ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide13 },
    { id: 5, title: 'Pink Line', objectname: 'Anti-Dandruff Shampoo - Anti Hairfall', select1: '650ml', select2: '', oldprice: 'Rs.199 ', newprice: 'Rs. 79.60', pic: slide14 },
    { id: 6, title: 'Olivia', objectname: 'Strong & Long Health Shampoo', select1: '650ml', select2: '', oldprice: 'Rs. 170', newprice: 'Rs. 144.50', pic: slide15 },
    { id: 7, title: 'Olivia', objectname: 'Advansed Aloe Vera Enriched Coconut Hair Oil', select1: '250ml', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide16 },
    { id: 8, title: 'Olivia', objectname: 'Anti-Dandruff Shampoo - Cool Menthol', select1: '650ml', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide17 },

    { id: 9, title: 'Glow & Lovely', objectname: 'Pure Coconut Oil', select1: '600ml', select2: '', oldprice: 'Rs. 80', newprice: 'Rs. 79', pic: slide1 },
    { id: 10, title: 'Pink Line', objectname: 'Keratin Smooth Shampoo', select1: '580ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide18 },
    { id: 11, title: 'Pink Line', objectname: 'Hair Fall Rescue Shampoo', select1: '650ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide12 },
    { id: 12, title: 'Pink Line', objectname: 'Bringha Oil', select1: '250ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide13 },
    { id: 13, title: 'Pink Line', objectname: 'Anti-Dandruff Shampoo - Anti Hairfall', select1: '650ml', select2: '', oldprice: 'Rs.199 ', newprice: 'Rs. 79.60', pic: slide14 },
    { id: 14, title: 'Olivia', objectname: 'Strong & Long Health Shampoo', select1: '650ml', select2: '', oldprice: 'Rs. 170', newprice: 'Rs. 144.50', pic: slide15 },
    { id: 15, title: 'Olivia', objectname: 'Advansed Aloe Vera Enriched Coconut Hair Oil', select1: '250ml', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide16 },
    { id: 16, title: 'Olivia', objectname: 'Anti-Dandruff Shampoo - Cool Menthol', select1: '650ml', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide17 },

    { id: 17, title: 'Glow & Lovely', objectname: 'Pure Coconut Oil', select1: '600ml', select2: '', oldprice: 'Rs. 80', newprice: 'Rs. 79', pic: slide1 },
    { id: 18, title: 'Pink Line', objectname: 'Keratin Smooth Shampoo', select1: '580ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide18 },
    { id: 19, title: 'Pink Line', objectname: 'Hair Fall Rescue Shampoo', select1: '650ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide12 },
    { id: 20, title: 'Pink Line', objectname: 'Bringha Oil', select1: '250ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide13 },

];


export default MensGroomingCard;