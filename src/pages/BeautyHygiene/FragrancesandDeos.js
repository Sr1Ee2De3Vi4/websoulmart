...
import slide1 from '../../assets/Beauti&Hygine/FragrancesandDeos/1.jpg'
import card23 from '../../assets/truck.svg'
import slide18 from '../../assets/Beauti&Hygine/FragrancesandDeos/2.jpg'
import slide12 from '../../assets/Beauti&Hygine/FragrancesandDeos/3.jpg'
import slide13 from '../../assets/Beauti&Hygine/FragrancesandDeos/4.jpg'
import slide14 from '../../assets/Beauti&Hygine/FragrancesandDeos/5.jpg'
import slide15 from '../../assets/Beauti&Hygine/FragrancesandDeos/6.jpg'
import slide16 from '../../assets/Beauti&Hygine/FragrancesandDeos/7.jpg'
import slide17 from '../../assets/Beauti&Hygine/FragrancesandDeos/8.jpg'



function FragrancesandDeos() {
    const refreshPage = () => {
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Fragrances & Deos</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Fragrances & Deos </label>
                        </div>
...
const categorydatas = [
    {
        ...
        content: [
            ...
            {
                datas: " Body Sprays & Mists ",
                url: "/FragrancesandDeos"
            },
            {
                datas: " Eau De Cologne  ",
                url: "/FragrancesandDeos"
            },
            {
                datas: " Eau De Parfum  ",
...
const griditems = [
    { id: 1, title: 'Nivea', objectname: 'Deodorant Roll On - Whitening Smooth Skin', select1: '50 ml', select2: '', oldprice: 'Rs. 80', newprice: 'Rs. 79', pic: slide1, card_link: 'FragrancesandDeosCard' },
    { id: 2, title: 'Nivea', objectname: 'Deodorant - Fresh Active', select1: '150 ml', select2: 'Attitude Red', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide18, card_link: 'FragrancesandDeosCard' },
    { id: 3, title: 'Eva', objectname: 'Skin Friendly Deodorant - Wild', select1: '2x150 ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide12, card_link: 'FragrancesandDeosCard' },
    { id: 4, title: 'Axe', objectname: 'Signature Gold Temptation', select1: '154 ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide13, card_link: 'FragrancesandDeosCard' },
    { id: 5, title: 'Rexona', objectname: 'Fresh Rose Whitening Underarm Roll On Deodorant For Women', select1: '50 ml', select2: '', oldprice: 'Rs.199 ', newprice: 'Rs. 79.60', pic: slide14, card_link: 'FragrancesandDeosCard' },
    { id: 6, title: 'Rexona', objectname: 'Fresh Lily Whitening Underarm Roll On Deodorant For Women', select1: '50 ml', select2: '', oldprice: 'Rs. 170', newprice: 'Rs. 144.50', pic: slide15, card_link: 'FragrancesandDeosCard' },
    { id: 7, title: 'Eva', objectname: 'Skin Friendly Deodorant - Fresh', select1: '2x150 ml', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide16, card_link: 'FragrancesandDeosCard' },
    { id: 8, title: 'Eva', objectname: 'Skin Friendly Deodorant - Sweet', select1: '2x150 ml', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide17, card_link: 'FragrancesandDeosCard' },

    { id: 9, title: 'Nivea', objectname: 'Deodorant Roll On - Whitening Smooth Skin', select1: '50 ml', select2: '', oldprice: 'Rs. 80', newprice: 'Rs. 79', pic: slide1, card_link: 'FragrancesandDeosCard' },
    { id: 10, title: 'Nivea', objectname: 'Deodorant - Fresh Active', select1: '150 ml', select2: 'Attitude Red', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide18, card_link: 'FragrancesandDeosCard' },
    { id: 11, title: 'Eva', objectname: 'Skin Friendly Deodorant - Wild', select1: '2x150 ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide12, card_link: 'FragrancesandDeosCard' },
    { id: 12, title: 'Axe', objectname: 'Signature Gold Temptation', select1: '154 ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide13, card_link: 'FragrancesandDeosCard' },
    { id: 13, title: 'Rexona', objectname: 'Fresh Rose Whitening Underarm Roll On Deodorant For Women', select1: '50 ml', select2: '', oldprice: 'Rs.199 ', newprice: 'Rs. 79.60', pic: slide14, card_link: 'FragrancesandDeosCard' },
    { id: 14, title: 'Rexona', objectname: 'Fresh Lily Whitening Underarm Roll On Deodorant For Women', select1: '50 ml', select2: '', oldprice: 'Rs. 170', newprice: 'Rs. 144.50', pic: slide15, card_link: 'FragrancesandDeosCard' },
    { id: 15, title: 'Eva', objectname: 'Skin Friendly Deodorant - Fresh', select1: '2x150 ml', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide16, card_link: 'FragrancesandDeosCard' },
    { id: 16, title: 'Eva', objectname: 'Skin Friendly Deodorant - Sweet', select1: '2x150 ml', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide17, card_link: 'FragrancesandDeosCard' },
...
export default FragrancesandDeos;
