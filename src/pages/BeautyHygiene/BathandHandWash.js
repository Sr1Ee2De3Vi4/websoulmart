...
import slide1 from '../../assets/Beauti&Hygine/BathandHandWash/1.jpg'
import card23 from '../../assets/truck.svg'
import slide18 from '../../assets/Beauti&Hygine/BathandHandWash/2.jpg'
import slide12 from '../../assets/Beauti&Hygine/BathandHandWash/3.jpg'
import slide13 from '../../assets/Beauti&Hygine/BathandHandWash/4.jpg'
import slide14 from '../../assets/Beauti&Hygine/BathandHandWash/5.jpg'
import slide15 from '../../assets/Beauti&Hygine/BathandHandWash/6.jpg'
import slide16 from '../../assets/Beauti&Hygine/BathandHandWash/7.jpg'
import slide17 from '../../assets/Beauti&Hygine/BathandHandWash/8.jpg'
import slide19 from '../../assets/Beauti&Hygine/BathandHandWash/9.jpg'


function BathandHandWash() {
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Bath & Hand Wash</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Bath & Hand Wash </label>
                        </div>
...
const categorydatas = [
    {
        ...
        content: [
            ...
            {
                datas: "Bath Salts & Oils",
                url: "/BathandHandWash"
            },
            {
                datas: "Bathing Accessories",
                url: "/BathandHandWash"
            },
            {
                datas: "Bathing Bars & Soaps",
                url: "/BathandHandWash"
            },
            {
                datas: "Hand Wash & Sanitizers",
                url: "/BathandHandWash"
            },
            {
                datas: "Shower Gel & Body Wash",
                url: "/BathandHandWash"
            },
            {
                datas: "Talcum Powder",
...
const griditems = [
    { id: 1, title: 'Glow & Lovely', objectname: 'Alcohol Based Germ Protection Hand Sanitizer', select1: '100ml', select2: '', oldprice: 'Rs. 80', newprice: 'Rs. 79', pic: slide1, card_link: 'BathandHandWashCard' },
    { id: 2, title: 'Pink Line', objectname: 'Original Hand Wash Liquid Refill', select1: '100ml', select2: '200ml', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide18, card_link: 'BathandHandWashCard' },
    { id: 3, title: 'Pink Line', objectname: 'Bathing Bar Soap - Germ Protection, Original', select1: '26 g ', select2: '', oldprice: 'Rs. 99', newprice: 'Rs. 79.60', pic: slide12, card_link: 'BathandHandWashCard' },
    { id: 4, title: 'Pink Line', objectname: 'Handwash - Skin Care', select1: '50ml', select2: '100ml', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide13, card_link: 'BathandHandWashCard' },
    { id: 5, title: 'Pink Line', objectname: 'Cream Beauty Bathing Bar', select1: '18 g', select2: '', oldprice: 'Rs.199 ', newprice: 'Rs. 79.60', pic: slide14, card_link: 'BathandHandWashCard' },
    { id: 6, title: 'Olivia', objectname: 'Bathing Soap', select1: '43 g', select2: '', oldprice: 'Rs. 170', newprice: 'Rs. 144.50', pic: slide15, card_link: 'BathandHandWashCard' },
    { id: 7, title: 'Olivia', objectname: 'Pure & Gentle Bathing Bar (Buy 4 Get 1 Free)', select1: '43 g', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide16, card_link: 'BathandHandWashCard' },
    { id: 8, title: 'Olivia', objectname: 'Original Germ Protection Alcohol Based Hand Sanitizer Refill', select1: '100ml ', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide17, card_link: 'BathandHandWashCard' },

    { id: 9, title: 'Glow & Lovely', objectname: 'Alcohol Based Germ Protection Hand Sanitizer', select1: '100ml ', select2: '', oldprice: 'Rs. 80', newprice: 'Rs. 79', pic: slide1, card_link: 'BathandHandWashCard' },
    { id: 10, title: 'Pink Line', objectname: 'Original Hand Wash Liquid Refill', select1: '100ml', select2: '200ml', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide18, card_link: 'BathandHandWashCard' },
    { id: 11, title: 'Pink Line', objectname: 'Bathing Bar Soap - Germ Protection, Original', select1: '26 g ', select2: '', oldprice: 'Rs. 99', newprice: 'Rs. 79.60', pic: slide12, card_link: 'BathandHandWashCard' },
    { id: 12, title: 'Pink Line', objectname: 'Handwash - Skin Care', select1: '50ml', select2: '100ml', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide13, card_link: 'BathandHandWashCard' },
    { id: 13, title: 'Pink Line', objectname: 'Cream Beauty Bathing Bar', select1: '18 g', select2: '', oldprice: 'Rs.199 ', newprice: 'Rs. 79.60', pic: slide14, card_link: 'BathandHandWashCard' },
    { id: 14, title: 'Olivia', objectname: 'Bathing Soap', select1: '43 g', select2: '', oldprice: 'Rs. 170', newprice: 'Rs. 144.50', pic: slide15, card_link: 'BathandHandWashCard' },
    { id: 15, title: 'Olivia', objectname: 'Pure & Gentle Bathing Bar (Buy 4 Get 1 Free)', select1: '43 g', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide16, card_link: 'BathandHandWashCard' },
    { id: 16, title: 'Olivia', objectname: 'Original Germ Protection Alcohol Based Hand Sanitizer Refill', select1: '100ml', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide17, card_link: 'BathandHandWashCard' },

];



export default BathandHandWash;
