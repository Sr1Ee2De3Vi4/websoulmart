...
function FragrancesandDeosCard(props) {
    let { id } = useParams();
    return (
...
const griditems = [
    { id: 1, title: 'Nivea', objectname: 'Deodorant Roll On - Whitening Smooth Skin', select1: '50 ml', select2: '', oldprice: 'Rs. 80', newprice: 'Rs. 79', pic: slide1 },
    { id: 2, title: 'Nivea', objectname: 'Deodorant - Fresh Active', select1: '150 ml', select2: 'Attitude Red', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide18 },
    { id: 3, title: 'Eva', objectname: 'Skin Friendly Deodorant - Wild', select1: '2x150 ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide12 },
    { id: 4, title: 'Axe', objectname: 'Signature Gold Temptation', select1: '154 ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide13 },
    { id: 5, title: 'Rexona', objectname: 'Fresh Rose Whitening Underarm Roll On Deodorant For Women', select1: '50 ml', select2: '', oldprice: 'Rs.199 ', newprice: 'Rs. 79.60', pic: slide14 },
    { id: 6, title: 'Rexona', objectname: 'Fresh Lily Whitening Underarm Roll On Deodorant For Women', select1: '50 ml', select2: '', oldprice: 'Rs. 170', newprice: 'Rs. 144.50', pic: slide15 },
    { id: 7, title: 'Eva', objectname: 'Skin Friendly Deodorant - Fresh', select1: '2x150 ml', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide16 },
    { id: 8, title: 'Eva', objectname: 'Skin Friendly Deodorant - Sweet', select1: '2x150 ml', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide17 },

    { id: 9, title: 'Nivea', objectname: 'Deodorant Roll On - Whitening Smooth Skin', select1: '50 ml', select2: '', oldprice: 'Rs. 80', newprice: 'Rs. 79', pic: slide1 },
    { id: 10, title: 'Nivea', objectname: 'Deodorant - Fresh Active', select1: '150 ml', select2: 'Attitude Red', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide18 },
    { id: 11, title: 'Eva', objectname: 'Skin Friendly Deodorant - Wild', select1: '2x150 ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide12 },
    { id: 12, title: 'Axe', objectname: 'Signature Gold Temptation', select1: '154 ml', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide13 },
    { id: 13, title: 'Rexona', objectname: 'Fresh Rose Whitening Underarm Roll On Deodorant For Women', select1: '50 ml', select2: '', oldprice: 'Rs.199 ', newprice: 'Rs. 79.60', pic: slide14 },
    { id: 14, title: 'Rexona', objectname: 'Fresh Lily Whitening Underarm Roll On Deodorant For Women', select1: '50 ml', select2: '', oldprice: 'Rs. 170', newprice: 'Rs. 144.50', pic: slide15 },
    { id: 15, title: 'Eva', objectname: 'Skin Friendly Deodorant - Fresh', select1: '2x150 ml', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide16 },
    { id: 16, title: 'Eva', objectname: 'Skin Friendly Deodorant - Sweet', select1: '2x150 ml', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide17 },


];


export default FragrancesandDeosCard;