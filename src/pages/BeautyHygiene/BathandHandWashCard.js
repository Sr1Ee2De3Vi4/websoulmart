...
function BathandHandWashCard(props) {
    let { id } = useParams();
    return (
...
const griditems = [
    { id: 1, title: 'Glow & Lovely', objectname: 'Alcohol Based Germ Protection Hand Sanitizer', select1: '100ml', select2: '', oldprice: 'Rs. 80', newprice: 'Rs. 79', pic: slide1 },
    { id: 2, title: 'Pink Line', objectname: 'Original Hand Wash Liquid Refill', select1: '100ml', select2: '200ml', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide18 },
    { id: 3, title: 'Pink Line', objectname: 'Bathing Bar Soap - Germ Protection, Original', select1: '26 g ', select2: '', oldprice: 'Rs. 99', newprice: 'Rs. 79.60', pic: slide12 },
    { id: 4, title: 'Pink Line', objectname: 'Handwash - Skin Care', select1: '50ml', select2: '100ml', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide13 },
    { id: 5, title: 'Pink Line', objectname: 'Cream Beauty Bathing Bar', select1: '18 g', select2: '', oldprice: 'Rs.199 ', newprice: 'Rs. 79.60', pic: slide14 },
    { id: 6, title: 'Olivia', objectname: 'Bathing Soap', select1: '43 g', select2: '', oldprice: 'Rs. 170', newprice: 'Rs. 144.50', pic: slide15 },
    { id: 7, title: 'Olivia', objectname: 'Pure & Gentle Bathing Bar (Buy 4 Get 1 Free)', select1: '43 g', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide16 },
    { id: 8, title: 'Olivia', objectname: 'Original Germ Protection Alcohol Based Hand Sanitizer Refill', select1: '100ml ', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide17 },

    { id: 9, title: 'Glow & Lovely', objectname: 'Alcohol Based Germ Protection Hand Sanitizer', select1: '100ml ', select2: '', oldprice: 'Rs. 80', newprice: 'Rs. 79', pic: slide1 },
    { id: 10, title: 'Pink Line', objectname: 'Original Hand Wash Liquid Refill', select1: '100ml', select2: '200ml', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide18 },
    { id: 11, title: 'Pink Line', objectname: 'Bathing Bar Soap - Germ Protection, Original', select1: '26 g ', select2: '', oldprice: 'Rs. 99', newprice: 'Rs. 79.60', pic: slide12 },
    { id: 12, title: 'Pink Line', objectname: 'Handwash - Skin Care', select1: '50ml', select2: '100ml', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide13 },
    { id: 13, title: 'Pink Line', objectname: 'Cream Beauty Bathing Bar', select1: '18 g', select2: '', oldprice: 'Rs.199 ', newprice: 'Rs. 79.60', pic: slide14 },
    { id: 14, title: 'Olivia', objectname: 'Bathing Soap', select1: '43 g', select2: '', oldprice: 'Rs. 170', newprice: 'Rs. 144.50', pic: slide15 },
    { id: 15, title: 'Olivia', objectname: 'Pure & Gentle Bathing Bar (Buy 4 Get 1 Free)', select1: '43 g', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide16 },
    { id: 16, title: 'Olivia', objectname: 'Original Germ Protection Alcohol Based Hand Sanitizer Refill', select1: '100ml', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide17 },

];


export default BathandHandWashCard;