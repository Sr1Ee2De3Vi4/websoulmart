...
function HealthandMedicineCard(props) {
    let { id } = useParams();
    return (
...
const griditems = [
    { id: 1, title: 'Glow & Lovely', objectname: 'Antiseptic Disinfectant Liquid', select1: '550ml', select2: '', oldprice: 'Rs. 80', newprice: 'Rs. 79', pic: slide1 },
    { id: 2, title: 'Pink Line', objectname: 'Fruit Salt - Regular', select1: '10g', select2: '', oldprice: 'Rs. 13', newprice: 'Rs. 9.60', pic: slide18 },
    { id: 3, title: 'Pink Line', objectname: 'Surgical/ Disposable Face Mask - 3 Ply', select1: '30 pcs', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide12 },
    { id: 4, title: 'Pink Line', objectname: 'Chyawanprash - 2X Immunity', select1: '500g', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide13 },
    { id: 5, title: 'Pink Line', objectname: 'Fruit Salt - Lemon Flavor', select1: '20 g', select2: '', oldprice: 'Rs.100', newprice: 'Rs. 79.60', pic: slide14 },
    { id: 6, title: 'Olivia', objectname: 'Disposable Finger Gloves', select1: '2 pcs', select2: '', oldprice: 'Rs. 170', newprice: 'Rs. 144.50', pic: slide15 },
    { id: 7, title: 'Olivia', objectname: 'Surgical Face Mask 3-Layer- Disposable, Anti-Dust & Anti-Pollution, With Earloop', select1: '40 pcs', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide16 },
    { id: 8, title: 'Olivia', objectname: 'Antiseptic - Disinfectant Liquid', select1: '500ml', select2: '', oldprice: 'Rs. 150', newprice: 'Rs. 127.50', pic: slide17 },

    { id: 9, title: 'Glow & Lovely', objectname: 'Antiseptic Disinfectant Liquid', select1: '550ml', select2: '', oldprice: 'Rs. 80', newprice: 'Rs. 79', pic: slide1 },
    { id: 10, title: 'Pink Line', objectname: 'Fruit Salt - Regular', select1: '10g', select2: '', oldprice: 'Rs. 13', newprice: 'Rs. 9.60', pic: slide18 },
    { id: 11, title: 'Pink Line', objectname: 'Surgical/ Disposable Face Mask - 3 Ply', select1: '30 pcs', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide12 },
    { id: 12, title: 'Pink Line', objectname: 'Chyawanprash - 2X Immunity', select1: '500g', select2: '', oldprice: 'Rs. 199', newprice: 'Rs. 79.60', pic: slide13 },
];


export default HealthandMedicineCard;