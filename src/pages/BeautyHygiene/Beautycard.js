...
import card11 from '../../assets/truck.svg'
                    ...
                    <div className="uk-width-3-4" style={{}}>
                        {griditems.map(item => (
                            ...
                            <button class="uk-button uk-button-default">Save</button></div> <br />
                                                <div class="uk-margin-small-left uk-margin-top sss uk-padding-remove-left"><img src={card11} className="  " alt="" width="25px" height="25px" />&nbsp;<span style={{ color: "#979797", fontSize: "13px" }}>Standard: Today 5:00PM - 8:00PM</span></div>
...
const categorydatas = [
    {
        ...
        content: [
            ...
            {
                datas: "Makeup Accessories",
                url: "/Makeup"
            },
            {
                datas: "Makeup Kits & Gift Sets",
                url: "/Makeup"
            },
            {
                datas: "Nails",
