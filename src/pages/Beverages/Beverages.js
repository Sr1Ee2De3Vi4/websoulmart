...
import slide2 from'../../assets/Slide1Bev.jpg'
import slide3 from'../../assets/Slide2Bev.jpg'
import slide4 from'../../assets/Slide3Bev.jpg'
import slide8 from'../../assets/Slide4Bev.jpg'
import veg from'../../assets/veg.png'
import Bevimg from'../../assets/Bevimg.jpg'
import card1 from'../../assets/Bournvita-pro-health-drink-chocolate.jpg'
import card2 from'../../assets/cafe-coffee-classic.webp'
import card3 from'../../assets/tea-premium-leaf-tea.jpg'
import card4 from'../../assets/coconut-water.jpg'
import card5 from'../../assets/tea-gold-leaf-tea.jpg'
import card6 from'../../assets/coca-cola-soft-drink-original-taste.webp'
import card7 from'../../assets/frooti-drink-fresh-n-juicy-mango.jpg'
import card8 from'../../assets/cafe-coffee-classic.webp'
...
<div class="uk-container uk-visible@m">
            ...
            <div class="col-3 uk-visible col-width">
                <div class="uk-margin-left border-right">
                    <div class="uk-width-expand uk-margin-medium-top">
                        ...
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"36%",paddingBottom:"5px"}}>Category</label></h4> 
                            <li class="uk-parent">
                                <a class="parent uk-margin-remove-bottom"style={{color:"#bf1961",fontWeight:"500"}} href="!#">Beverages</a>
                                 <ul class="nav-sub">
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Coffee</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Energy & Soft Drinks</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Fruit Juices & Drinks</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Health Drink, Supplement</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Tea</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Water</a></label></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"24%",paddingBottom:"5px"}}>Brand</label></h4> 
                    ...
                    <div>   
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"69%",paddingBottom:"5px"}}>Food Preference</label></h4> 
                        <ul class="uk-list">
                                <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">Vegetarian</a></label></label></li>
                                <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Non Vegetarian</a></label></label></li>
                        </ul>
                    </div>
                    <div>
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"35%",paddingBottom:"5px"}}>Flavours</label></h4> 
                        <ul class="uk-list">
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">Apple</a></label></label></li>
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">Cola</a></label></label></li>
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">Vanilla</a></label></label></li>
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">Orange</a></label></label></li>
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">Mixed</a></label></label></li>
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">Soda</a></label></label></li>
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Lemon</a></label></label></li>
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text "><a href="!#">Others</a></label></label></li>
                        </ul>
                    </div>
                    <div>
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"73%",paddingBottom:"5px"}}>Country Of Origin</label></h4> 
                        <ul class="uk-list">
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">America</a></label></label></li>
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">Australia</a></label></label></li>
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">China</a></label></label></li>
                            ...
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">Italy</a></label></label></li>
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">Spain</a></label></label></li>
                    ...
                    <div>
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"53%",paddingBottom:"5px"}}>Allergen Info</label></h4> 
                        <ul class="uk-list">
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Gluten Free</a></label></label></li>
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text "><a href="!#">Nut Free</a></label></label></li>
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Dairy Free</a></label></label></li> 
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Trans Fat Free</a></label></label></li>
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text "><a href="!#">Fish Free</a></label></label></li>
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Contains Milk</a></label></label></li> 
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">No Added Sugar</a></label></label></li> 
                        </ul>
                    </div>
                    <div>
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"21%",paddingBottom:"5px"}}>Price</label></h4> 
                        <ul class="uk-list">
                    ...
                    <div>
                         <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"35%",paddingBottom:"5px"}}>Discount</label></h4> 
                         <ul class="uk-list">
                    ...
                    <div>
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"40%",paddingBottom:"5px"}}>Pack Size</label></h4> 
                            <div class="uk-inline search-brand">
                                <a class="uk-form-icon uk-form-icon-flip" href="#" uk-icon="icon: search"style={{width:"15px"}}></a>
        ...
        <label class="header-label  ">Beverages</label>  
        </div>
        <div class="col-3">
        ...
        <div class="uk-flex flex-style uk-margin-top border-card uk-visible@m">
            <div class="uk-margin-right">
                    ...
                    <h3 class="uk-text-muted fresho ">Bournvita</h3>
                    <h3 class="items">Bournvita-health-drink</h3>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    ...
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Nescafe</h3>
                    <h3 class="items ">Cafe-coffee-classic</h3>
                    <select class="uk-select mrp-style uk-height-small uk-text-bolder"style={{height:"23px"}}>
                        <option>1 Kg Rs:20.00</option>
                        <option>2 Kg Rs:40.00</option>
                    </select>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    ...
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Tata Tea Premium</h3>
                    <h3 class="items ">Leaf-tea</h3>
                    <select class="uk-select mrp-style uk-height-small uk-text-bolder"style={{height:"23px"}}>
                        <option>1 Kg Rs:20.00</option>
                        <option>2 Kg Rs:40.00</option>
                    </select>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                    <Link to="Bourn"><img src={card5} className="  "  alt="slide1"/></Link><br/>
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Tata Tea Premium</h3>
                    <h3 class="items ">Leaf-tea</h3>
                    <select class="uk-select mrp-style uk-height-small uk-text-bolder"style={{height:"23px"}}>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                    <Link to="Bourn"><img src={card6} className="  "  alt="slide1"/></Link><br/>
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Coca-Cola</h3>
                    <h3 class="items ">Coca-cola-soft-drink</h3>
                    <select class="uk-select mrp-style uk-height-small uk-text-bolder"style={{height:"23px"}}>
                        <option>1 Kg Rs:20.00</option>
                        <option>2 Kg Rs:40.00</option>
                    </select>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                    <Link to="Bourn"><img src={card7} className="  "  alt="slide1"/></Link><br/>
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Frooti</h3>
                    <h3 class="items ">Frooti-drink</h3>
                    <select class="uk-select mrp-style uk-height-small uk-text-bolder"style={{height:"23px"}}>
                        <option>1 Kg Rs:20.00</option>
                        <option>2 Kg Rs:40.00</option>
                    </select>
        ...
        <div class="uk-flex flex-style uk-margin-top">
            <div class="uk-margin-right">
                    <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                    <Link to="Bourn"><img src={card8} className="  "  alt="slide1"/></Link><br/>
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Nescafe</h3>
                    <h3 class="items ">Cafe-coffee</h3>
                    <select class="uk-select mrp-style uk-height-small uk-text-bolder"style={{height:"23px"}}>
                        <option>1 Kg Rs:20.00</option>
                        <option>2 Kg Rs:40.00</option>
                    </select>
...
{/* side nave and main section end */}
        ...
        <div class="uk-hidden@l uk-hidden@m">
            <img src={Bevimg} class="" alt="" uk-cover/>
        </div>
        <div class="uk-container uk-hidden@l uk-hidden@m">
            <label class="header-labels uk-margin-remove-bottom uk-margin-medium-top ">Beverages</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <div class="uk-text-left">
                                    <div class="uk-width-expand uk-margin-medium-top">
                                        ...
                                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"21%",paddingBottom:"5px"}}>Category</label></h4> 
                                            <li class="uk-parent">
                                                <a class="parent uk-margin-remove-bottom"style={{color:"#bf1961",fontWeight:"500"}} href="/FruitsVeg">Beverages</a>
                                                <ul class="nav-sub">
                                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Coffee</a></label></li>
                                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Energy & Soft Drinks</a></label></li>
                                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Fruit Juices & Drinks</a></label></li>
                                    ...
                                    <div>
                                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"14%",paddingBottom:"5px"}}>Brand</label></h4> 
                                        <div class="uk-inline search-brand">
                                            <a class="uk-form-icon uk-form-icon-flip" href="#" uk-icon="icon: search"style={{width:"15px"}}></a>
                                            <input class="uk-input search-brand   "placeholder="Search by Brand" style={{fontFamily:"Proxima Nova",fontSize:"14px",width:"300px"}}type="text"/>
                                        </div><br/>
                                    ...
                                    <div>   
                                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"38%",paddingBottom:"5px"}}>Food Preference</label></h4> 
                                        <ul class="uk-list">
                                                <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">Vegetarian</a></label></label></li>
                                                <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Non Vegetarian</a></label></label></li>
                                        </ul>
                                    ...
                                    <div>
                                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"20%",paddingBottom:"5px"}}>Flavours</label></h4> 
                                        <ul class="uk-list">
                                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">Apple</a></label></label></li>
                                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">Cola</a></label></label></li>
                                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">Vanilla</a></label></label></li>
                                    ...
                                    <div>
                                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"40%",paddingBottom:"5px"}}>Country Of Origin</label></h4> 
                                        <ul class="uk-list">
                                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">America</a></label></label></li>
                                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">Australia</a></label></label></li>
                                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">China</a></label></label></li>
                                    ...
                                    <div>
                                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"29%",paddingBottom:"5px"}}>Allergen Info</label></h4> 
                                        <ul class="uk-list">
                                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Gluten Free</a></label></label></li>
                                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text "><a href="!#">Nut Free</a></label></label></li>
                                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Dairy Free</a></label></label></li> 
                                    ...
                                    <div>
                                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"12%",paddingBottom:"5px"}}>Price</label></h4> 
                                        <ul class="uk-list">
                                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Less than Rs 20</a></label></label></li>
                                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text "><a href="!#">Rs 21 to Rs 50</a></label></label></li>
                                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Rs 51 to Rs 100</a></label></label></li> 
                                    ...
                                    <div>
                                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"20%",paddingBottom:"5px"}}>Discount</label></h4> 
                                        <ul class="uk-list">
                                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Upto 5%</a></label></label></li>
                                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text "><a href="!#">5%-10%</a></label></label></li>
                                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">10%-15%</a></label></label></li>
                                    ...
                                    <div>
                                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"22%",paddingBottom:"5px"}}>Pack Size</label></h4> 
                                            <div class="uk-inline search-brand">
                                                <a class="uk-form-icon uk-form-icon-flip" href="#" uk-icon="icon: search"style={{width:"15px"}}></a>
                                                <input class="uk-input search-brand   "placeholder="Search by pack size" style={{fontFamily:"Proxima Nova",fontSize:"14px",width:"300px"}}type="text"/>
                                            </div><br/>
                            ...
                            <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                                <div>
                                    ...
                                    <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                        <h3 class="uk-text-muted fresho ">Bournvita</h3>
                                        <h3 class="items ">Bournvita-health-drink</h3><br/>
                        ...
                        <div class="uk-flex flex-style uk-padding-remove-left"style={{borderStyle:"ridge"}}>
                            <div class=" ">
                                <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                                    <div>
                                    <div class="uk-align-left uk-margin-remove-right uk-margin-remove-bottom">
                                            <Link to="Bourn"><img src={card5} className="img-size uk-margin-left"  alt="slide1"/></Link><br/>
                                            <img src={veg} className=" veg-size"  alt="slide1"/><br/>
                                    </div>
                                    <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                        <h3 class="uk-text-muted fresho ">Tata Tea Premium</h3>
                        ...
                        <div class="uk-flex flex-style uk-padding-remove-left"style={{borderStyle:"ridge"}}>
                            <div class=" ">
                                <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                                    <div>
                                    <div class="uk-align-left uk-margin-remove-right uk-margin-remove-bottom">
                                            <Link to="Bourn"><img src={card6} className="img-size uk-margin-left"  alt="slide1"/></Link><br/>
                                            <img src={veg} className=" veg-size"  alt="slide1"/><br/>
                                    </div>
                                    <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                        <h3 class="uk-text-muted fresho ">Coca-cola</h3>
                        ...
                        <div class="uk-flex flex-style uk-padding-remove-left"style={{borderStyle:"ridge"}}>
                            <div class=" ">
                                <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                                    <div>
                                    <div class="uk-align-left uk-margin-remove-right uk-margin-remove-bottom">
                                            <Link to="Bourn"><img src={card7} className="img-size uk-margin-left"  alt="slide1"/></Link><br/>
                                            <img src={veg} className=" veg-size"  alt="slide1"/><br/>
                                    </div>
                                    <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                        <h3 class="uk-text-muted fresho ">Frooti</h3>
                        ...
                        <div class="uk-flex flex-style uk-padding-remove-left"style={{borderStyle:"ridge"}}>
                            <div class=" ">
                                <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                                    <div>
                                    <div class="uk-align-left uk-margin-remove-right uk-margin-remove-bottom">
                                            <Link to="Bourn"><img src={card8} className="img-size uk-margin-left"  alt="slide1"/></Link><br/>
                                            <img src={veg} className=" veg-size"  alt="slide1"/><br/>
                                    </div>
                                    <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                        <h3 class="uk-text-muted fresho ">Nescafe</h3>
...
const griditems = [
    { id: 1, title: 'Bournvita', objectname: 'Bournvita-health-drink', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 2, title: 'Nescafe',objectname: 'Cafe-coffee-classic', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 3, title: 'Tata Tea Premium',objectname: 'Leaf-tea', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 4, title: 'bb Royal',objectname: 'Coconut-water', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
    { id: 5, title: 'Tata Tea Premium', objectname: 'Leaf-tea', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 },
    { id: 6, title: 'Coca-Cola', objectname: 'Coca-cola-soft-drink', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 },
    { id: 7, title: 'Frooti', objectname: 'Frooti-drink', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 },
    { id: 8, title: 'Nescafe', objectname: 'Cafe-coffee', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 },
