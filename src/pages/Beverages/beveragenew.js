...
import card1 from'../../assets/cof1.jpg'
import card2 from'../../assets/cof2.jpg'
import card3 from'../../assets/Ecoca-cola-soft-drink.webp'
import card4 from'../../assets/Edrink-black-slim.webp'
import card5 from'../../assets/tea-gold-leaf-tea.jpg'
import card6 from'../../assets/coca-cola-soft-drink-original-taste.webp'
import card7 from'../../assets/teaa1.jpg'
import card8 from'../../assets/teaa2.jpg'
...
const categorydatas = [
    ...
    {
        datas: "Energy and SoftDrinks",
        url:"/EnergySoftDrinks"
    },
    {
        datas: "Fruit Juice and Drink",
...
const griditems = [
    { id: 1, title: 'Bournvita', objectname: 'Instant Coffee', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1, card_link : 'Bevcard' },
    { id: 2, title: 'Nescafe',objectname: 'Bru Coffee', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link : 'Bevcard' },
    { id: 3, title: 'Tata Tea Premium',objectname: 'Diet Coke Soft Drink', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link : 'Bevcard' },
    { id: 4, title: 'bb Royal',objectname: 'Pepsi', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4, card_link : 'Bevcard' },
    { id: 5, title: 'Tata Tea Premium', objectname: 'Leaf-tea', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5, card_link : 'Bevcard' },
    { id: 6, title: 'red label', objectname: 'Tea', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6, card_link : 'Bevcard' },
    { id: 7, title: 'Frooti', objectname: 'Frooti-drink', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7, card_link : 'Bevcard' },
    { id: 8, title: 'Nescafe', objectname: 'Cafe-coffee', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8, card_link : 'Bevcard' },
    { id: 9, title: 'Bournvita', objectname: 'Bournvita-health-drink', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1, card_link : 'Bevcard' },
    { id: 10, title: 'Nescafe',objectname: 'Cafe-coffee-classic', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link : 'Bevcard' },
    { id: 11, title: 'Tata Tea Premium',objectname: 'Leaf-tea', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link : 'Bevcard' },
    { id: 12, title: 'bb Royal',objectname: 'Coconut-water', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4, card_link : 'Bevcard' },
    { id: 13, title: 'Tata Tea Premium', objectname: 'Leaf-tea', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5, card_link : 'Bevcard' },
    { id: 14, title: 'Coca-Cola', objectname: 'Coca-cola-soft-drink', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6, card_link : 'Bevcard' },
    { id: 15, title: 'Frooti', objectname: 'Frooti-drink', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7, card_link : 'Bevcard' },
    { id: 16, title: 'Nescafe', objectname: 'Cafe-coffee', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8, card_link : 'Bevcard' },
