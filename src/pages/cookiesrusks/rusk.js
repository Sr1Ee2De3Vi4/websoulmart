...
import './rusk.css';
import slide2 from'../../assets/ruskslide1.webp'
import slide4 from'../../assets/ruslslide2.jpg'
import slide6 from'../../assets/ruskslide3.jpg'



import veg from'../../assets/veg.png'
import card1 from'../../assets/rusks1.jpg'
import card2 from'../../assets/rusks2.jpg'
import card3 from'../../assets/rusks3.jpg'
import card4 from'../../assets/rusks4.jpg'
import card5 from'../../assets/rusks5.jpg'
import card6 from'../../assets/rusks6.jpg'
import card7 from'../../assets/rusks7.jpg'
import card8 from'../../assets/rusks8.jpg'
    ...
    <div class="modal-dialog-full-width modal-dialog momodel modal-fluid" role="document" style={{ width: "100%", margin: "0px", padding: "0px" }}>
      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide slider_width uk-align-center" data-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <img class="d-block w-100" src={slide6} alt="First slide" />
          </div>
...
<div className="uk-width-3-4" style={{}}>
 {/* fruits and veg cards */}
        ...
        <label class="header-label  ">Cookies, Rusk & Khari</label> 
        </div>
        <div class="col-3">
...
const categorydatas = [
    {
    title: "Category",
    pagename:"Cookies, Rusk & Khari  ",
    
    pageurl:"/rusks",
    content: [
    {
        datas: "Khari & Cream Rolls ",
        url:"/rusks"
    },
    {
        datas: "Premium Cookies",
        
        
        url:"/rusks"
    },
    {
        datas: "Bakery Biscuits, Cookies",
        url:"/rusks"
    },
...
const griditems = [
    { id: 1, title: 'Nourish Organics', objectname: 'Oats Cranberry Cookies', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'Ruskcard' },
    { id: 2, title: 'Nourish Organics',objectname: 'Chocolate Coconut Cookies', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link:'Ruskcard' },
    { id: 3, title: 'Nourish Organics',objectname: 'Methi Khakhra', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link:'Ruskcard' },
    { id: 4, title: 'Nourish Organics',objectname: 'Assorted Cookies', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'Ruskcard' },
    { id: 5, title: 'Nourish Organics', objectname: 'Cheese Crunchy Layer Crackers', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5,card_link:'Ruskcard' },
    { id: 6, title: 'Nourish Organics', objectname: 'Fette Biscottate Rusk - Gluten Free', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6,card_link:'Ruskcard' },
    { id: 7, title: 'Nourish Organics', objectname: 'Weelz Crunchy Choco Coated Biscuit', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7,card_link:'Ruskcard' },
    { id: 8, title: 'Nourish Organics', objectname: 'Bakery Biscuit - Ajwain', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8,card_link:'Ruskcard' },
    { id: 9, title: 'Nourish Organics', objectname: 'Oats Cranberry Cookies', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'Ruskcard' },
    { id: 10, title: 'Nourish Organics',objectname: 'Chocolate Coconut Cookies', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link:'Ruskcard' },
    { id: 11, title: 'Nourish Organics',objectname: 'Methi Khakhra', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link:'Ruskcard' },
    { id: 12, title: 'Nourish Organics',objectname: 'Assorted Cookies', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'Ruskcard' },
    { id: 13, title: 'Nourish Organics', objectname: 'Cheese Crunchy Layer Crackers', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5,card_link:'Ruskcard' },
    { id: 14, title: 'Nourish Organics', objectname: 'Fette Biscottate Rusk - Gluten Free', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6,card_link:'Ruskcard' },
    { id: 15, title: 'Nourish Organics', objectname: 'Weelz Crunchy Choco Coated Biscuit', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7,card_link:'Ruskcard' },
    { id: 16, title: 'Nourish Organics', objectname: 'Bakery Biscuit - Ajwain', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8,card_link:'Ruskcard' },
