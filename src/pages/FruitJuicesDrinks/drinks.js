...
import card1 from'../../assets/fruit1.jpg'
import card2 from'../../assets/fruit2.jpg'
import card3 from'../../assets/fruit3.jpg'
import card4 from'../../assets/fruit4.jpg'
import card5 from'../../assets/fruit5.jpg'
import card6 from'../../assets/fruit6.jpg'
import card7 from'../../assets/fruit7.jpg'
import card8 from'../../assets/fruit8.jpg'
...
<label class="header-labels ">Fruit Juices & Drinks</label>
</div>
<div>
...
const dataItems = [
    ...
    {
        datas: "Fresho Signature"
    },
    {
        datas: "Schar"
    },
    {
        datas: "The Baker's Dozen"
    },
...
const categorydatas = [
    {
    title: "Category",
    pagename:" Fruit Juices & Drinks",
    pageurl:"/FruitJuicesDrinks",
    content: [
    {
        datas: "Juices",
        
        url:"/FruitJuicesDrinks"
    },
    {
        datas: "Syrups & Concentrates",
        url:"/FruitJuicesDrinks"
    },
    {
        datas: "Unsweetened, Cold Press",
        url:"/FruitJuicesDrinks"
    },
...
const griditems = [
    { id: 1, title: 'Paper Boat', objectname: 'Coconut Water', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1, card_link :'Drinkcard' },
    { id: 2, title: 'Paper Boat',objectname: 'Frooti', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link :'Drinkcard' },
    { id: 3, title: 'Paper Boat',objectname: '100% Natural Coconut Water', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link :'Drinkcard' },
    { id: 4, title: 'Paper Boat',objectname: 'Masti Buttermilk - Spice', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4, card_link :'Drinkcard' },

    { id: 5, title: 'Paper Boat', objectname: 'Hot Chocolate Drink Powder Mix', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5, card_link :'Drinkcard' },
    { id: 6, title: 'Paper Boat',objectname: 'Pro-Health Drink - Chocolate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6, card_link :'Drinkcard' },
    { id: 7, title: 'Paper Boat',objectname: 'Mango Slim Shake - Weight Control Powered By Ayurveda', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7, card_link :'Drinkcard' },
    { id: 8, title: 'Paper Boat',objectname: 'Aloe Vera and Turmeric Juice', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8, card_link :'Drinkcard' },

    { id: 9, title: 'Paper Boat', objectname: 'Coconut Water', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1, card_link :'Drinkcard' },
    { id: 10, title: 'Paper Boat',objectname: 'Frooti', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link :'Drinkcard' },
    { id: 11, title: 'Paper Boat',objectname: '100% Natural Coconut Water', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link :'Drinkcard' },
    { id: 12, title: 'Paper Boat',objectname: 'Masti Buttermilk - Spice', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4, card_link :'Drinkcard' },
 
    { id: 13, title: 'Paper Boat', objectname: 'Hot Chocolate Drink Powder Mix', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5, card_link :'Drinkcard' },
    { id: 14, title: 'Paper Boat',objectname: 'Pro-Health Drink - Chocolate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6, card_link :'Drinkcard' },
    { id: 15, title: 'Paper Boat',objectname: 'Mango Slim Shake - Weight Control Powered By Ayurveda', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7, card_link :'Drinkcard' },
    { id: 16, title: 'Paper Boat',objectname: 'Aloe Vera and Turmeric Juice', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8, card_link :'Drinkcard' },
