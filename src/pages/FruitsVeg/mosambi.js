...
import card1 from "../../assets/orang.webp"
...
return (
    ...
    <div class="uk-container">
        <div class="row uk-visible@m">
            ...
            <div class="col-5">
                <div class="uk-margin-large-top uk-margin-left">
                    ...
                    <label><label class="chech-text"style={{fontSize: "18px",color: "#222",fontWeight:"400"}}>Fresho Orange - Kinnow, 2 kg</label></label>
                    <br/>
        ...
        <article class="uk-article uk-margin-left uk-padding-remove-left">
                <h1 class="uk-article-title"><a class="uk-link-reset zheading" href="">Fresho Orange</a></h1>
