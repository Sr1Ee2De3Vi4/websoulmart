...
import slide1 from '../../assets/season_fruits_460.webp'
import slide2 from '../../assets/season_grapes.webp'
import slide3 from '../../assets/season_orange.webp'
...
import card2 from '../../assets/banana.webp'
import card3 from '../../assets/carrot.webp'
import card4 from '../../assets/grapes.webp'
import card5 from '../../assets/orange.webp'
import card6 from '../../assets/pomegranate.webp'
import card7 from '../../assets/mosambi.webp'
import card8 from '../../assets/apple530.webp'
import card14 from '../../assets/apple520.webp'
import card9 from '../../assets/cabbage.webp'
import card10 from '../../assets/cauliflower.webp'
    ...
    return (
        <div>
            ...
            <div className=" ">
                ...
                {/* image bar */}
                <img src={fruitsveg} class=" uk-align-center img_width" alt="" />
                {/* image bar end */}
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Fruits and Vegetables</label>
                                </div>
                                <div class="col-3">
...
const griditems = [
    { id: 1, title: 'Fresho', objectname: 'Onion - Medium/Payaj', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1, card_link: 'anar' },
    { id: 2, title: 'Fresho', objectname: 'Banana - Robusta/Kela', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link: 'anar' },
    { id: 3, title: 'Fresho', objectname: 'Carrot Red Halwa', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link: 'anar' },
    { id: 4, title: 'Fresho', objectname: 'Grapes - Red Globe', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4, card_link: 'anar' },
    { id: 5, title: 'Fresho', objectname: 'Orange Imported/Malta', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5, card_link: 'anar' },
    { id: 6, title: 'Fresho', objectname: 'Pomegranate - Small', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6, card_link: 'anar' },
    { id: 7, title: 'Fresho', objectname: 'Mosambi', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7, card_link: 'anar' },
    { id: 8, title: 'Fresho', objectname: 'Apple - Red Delicious / Washington, Regular', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8, card_link: 'anar' },
    { id: 9, title: 'Fresho', objectname: 'Cabbage Small/Patta Gobhi', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card9, card_link: 'anar' },
    { id: 10, title: 'Fresho', objectname: 'Cauliflower (Medium)/Phool - Gobhi', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card10, card_link: 'anar' },
    { id: 11, title: 'Fresho', objectname: 'Onion - Medium/Payaj', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1, card_link: 'anar' },
    { id: 12, title: 'Fresho', objectname: 'Banana - Robusta/Kela', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link: 'anar' },
    { id: 13, title: 'Fresho', objectname: 'Carrot Red Halwa', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link: 'anar' },
    { id: 14, title: 'Fresho', objectname: 'Grapes - Red Globe', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4, card_link: 'anar' },
    { id: 15, title: 'Fresho', objectname: 'Orange Imported/Malta', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5, card_link: 'anar' },
    { id: 16, title: 'Fresho', objectname: 'Pomegranate - Small', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6, card_link: 'anar' },
