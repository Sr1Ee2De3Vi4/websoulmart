...
import card5 from'../../assets/capsicum-green.webp'
    ...
    <div class="uk-container uk-visible@m">
                ...
                <div class="uk-margin-left border-right">
                    <div class="uk-width-expand uk-margin-medium-top">
                        ...
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",paddingBottom:"5px"}}>Category</label></h4> 
                            <li class="uk-parent">
                               <a class="parent uk-margin-remove-bottom"style={{color:"#bf1961",fontWeight:"500"}} href="/FruitsVeg">Fruits & Vegetables</a>
                                 <ul class="nav-sub">
        ...
        <div class="uk-flex flex-style uk-margin-top border-card uk-visible@m">
            <div class="uk-margin-right">
                    ...
                    <Link to="/onion"><img src={card6} className="  "  alt="slide1"/></Link><br/>
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Fresho</h3>
                    <h3 class="items">Onion</h3><br/>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                    <Link to="anar"><img src={card11} className="  "  alt="slide1"/></Link><br/>
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Fresho</h3>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                    <Link to="/banana"><img src={card7} className="  "  alt="slide1"/></Link><br/>
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Fresho</h3>
        ...
        <div class="uk-flex flex-style uk-margin-top">
            <div class="uk-margin-right">
                    <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                    <Link to="/carrot"><img src={card8} className="  "  alt="slide1"/></Link><br/>
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Fresho</h3>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                    <Link to="/grapes"><img src={card9} className="  "  alt="slide1"/></Link><br/>
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Fresho</h3>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                    <Link to="/orange"><img src={card10} className="  "  alt="slide1"/></Link><br/>
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Fresho</h3>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                    <Link to="/potato"><img src={card2} className="  "  alt="slide1"/></Link><br/>
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Fresho</h3>
                    <h3 class="items ">Potato</h3><br/>
                    <select class="uk-select mrp-style uk-height-small uk-text-bolder"style={{height:"23px"}}>
                        <option>1 Kg Rs:20.00</option>
                        <option>2 Kg Rs:40.00</option>
                    </select>
        ...
        <div class="uk-flex flex-style uk-margin-top">
            <div class="uk-margin-right">
                    <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                    <Link to="/mosambi"><img src={card12} className="  "  alt="slide1"/></Link><br/>
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Fresho</h3>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                    <Link to="/capsicum"><img src={card5} className="  "  alt="slide1"/></Link><br/>
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Fresho</h3>
...
{/* side nave and main section end */}
        ...
        <div class="uk-container uk-hidden@l uk-hidden@m">
            <label class="header-labels uk-margin-remove-bottom uk-margin-medium-top ">Fruits and Vegetables</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class=" ">
                            <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                                <div>
                                    ...
                                    <Link to="/onion"><img src={card6} className="img-size uk-margin-left"  alt="slide1"/></Link><br/>
                        ...
                        <div class="uk-flex flex-style uk-padding-remove-left"style={{borderStyle:"ridge"}}>
                            <div class=" ">
                                <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                                    <div>
                                    <div class="uk-align-left uk-margin-remove-right uk-margin-remove-bottom">
                                    <Link to="/anar"><img src={card11} className="img-size uk-margin-left"  alt="slide1"/></Link><br/>
                                            <img src={veg} className=" veg-size"  alt="slide1"/><br/>
                                    </div>
                                    <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                        <h3 class="uk-text-muted fresho ">Fresho</h3>
                        ...
                        <div class="uk-flex flex-style uk-padding-remove-left"style={{borderStyle:"ridge"}}>
                            <div class=" ">
                                <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                                    <div>
                                    <div class="uk-align-left uk-margin-remove-right uk-margin-remove-bottom">
                                    <Link to="/banana"><img src={card7} className="img-size uk-margin-left"  alt="slide1"/></Link><br/>
                                            <img src={veg} className=" veg-size"  alt="slide1"/><br/>
                                    </div>
                                    <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                        <h3 class="uk-text-muted fresho ">Fresho</h3>
                        ...
                        <div class="uk-flex flex-style uk-padding-remove-left"style={{borderStyle:"ridge"}}>
                            <div class=" ">
                                <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                                    <div>
                                    <div class="uk-align-left uk-margin-remove-right uk-margin-remove-bottom">
                                    <Link to="/carrot"><img src={card8} className="img-size uk-margin-left"  alt="slide1"/></Link><br/>
                                            <img src={veg} className=" veg-size"  alt="slide1"/><br/>
                                    </div>
                                    <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                        <h3 class="uk-text-muted fresho ">Fresho</h3>
                        ...
                        <div class="uk-flex flex-style uk-padding-remove-left"style={{borderStyle:"ridge"}}>
                            <div class=" ">
                                <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                                    <div>
                                    <div class="uk-align-left uk-margin-remove-right uk-margin-remove-bottom">
                                    <Link to="/grapes"><img src={card9} className="img-size uk-margin-left"  alt="slide1"/></Link><br/>
                                            <img src={veg} className=" veg-size"  alt="slide1"/><br/>
                                    </div>
                                    <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                        <h3 class="uk-text-muted fresho ">Fresho</h3>
                        ...
                        <div class="uk-flex flex-style uk-padding-remove-left"style={{borderStyle:"ridge"}}>
                            <div class=" ">
                                <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                                    <div>
                                    <div class="uk-align-left uk-margin-remove-right uk-margin-remove-bottom">
                                    <Link to="/orange"><img src={card10} className="img-size uk-margin-left"  alt="slide1"/></Link><br/>
                                            <img src={veg} className=" veg-size"  alt="slide1"/><br/>
                                    </div>
                                    <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                        <h3 class="uk-text-muted fresho ">Fresho</h3>
                        ...
                        <div class="uk-flex flex-style uk-padding-remove-left"style={{borderStyle:"ridge"}}>
                            <div class=" ">
                                <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                                    <div>
                                    <div class="uk-align-left uk-margin-remove-right uk-margin-remove-bottom">
                                    <Link to="/potato"><img src={card2} className="img-size uk-margin-left"  alt="slide1"/></Link><br/>
                                            <img src={veg} className=" veg-size"  alt="slide1"/><br/>
                                    </div>
                                    <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                        <h3 class="uk-text-muted fresho ">Fresho</h3>
                        ...
                        <div class="uk-flex flex-style uk-padding-remove-left"style={{borderStyle:"ridge"}}>
                            <div class=" ">
                                <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                                    <div>
                                    <div class="uk-align-left uk-margin-remove-right uk-margin-remove-bottom">
                                    <Link to="/mosambi"><img src={card12} className="img-size uk-margin-left"  alt="slide1"/></Link><br/>
                                            <img src={veg} className=" veg-size"  alt="slide1"/><br/>
                                    </div>
                                    <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                        <h3 class="uk-text-muted fresho ">Fresho</h3>
                        ...
                        <div class="uk-flex flex-style uk-padding-remove-left"style={{borderStyle:"ridge"}}>
                            <div class=" ">
                                <div class="uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                                    <div>
                                    <div class="uk-align-left uk-margin-remove-right uk-margin-remove-bottom">
                                    <Link to="/capsicum"><img src={card5} className="img-size uk-margin-left"  alt="slide1"/></Link><br/>
                                            <img src={veg} className=" veg-size"  alt="slide1"/><br/>
                                    </div>
                                    <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                        <h3 class="uk-text-muted fresho ">Fresho</h3>
