...
import card1 from "../../assets/carrotred.webp"
...
return (
    ...
    <div class="uk-container">
        <div class="row uk-visible@m">
                    ...
                    <div class="uk-width-expand uk-margin-medium-top">
                        ...
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",paddingBottom:"5px"}}>Brand</label></h4> <br/>
                                <ul class="nav-sub">
                                    ...
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Fresho Potato, Onion & Tomato</a></label></li>
                                </ul>                      
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-5">
                <div class="uk-margin-large-top uk-margin-left">
                    ...
                    <label><label class="chech-text"style={{fontSize: "18px",color: "#222",fontWeight:"400"}}>Fresho Carrot Red - Organically Grown, 500 g</label></label>
                    <br/>
        ...
        <article class="uk-article uk-margin-left uk-padding-remove-left">
                <h1 class="uk-article-title"><a class="uk-link-reset zheading" href="">Fresho Carrot</a></h1>
                <p class="uk-text-lead zhead">About the Product</p>
                <p class="zpara">carrot is a vegetable which is almost like a staple in Indian food. This is also known to be one of the essential ingredients of raw salads. They come in different colours like white, red or yellow and are quite in demand in cold salads and hot soups. You can dice, slice or cut it in rings and put it in burgers and sandwiches. carrots emit a sharp flavour and fragrance once they are fried; it is due to the sulphur compound in the vegetable.</p>               
            <hr/>       
                <p class="uk-text-lead zhead">Nutritional Facts</p>
                <p class="zpara">carrots are known to be rich in biotin. Most of the flavonoids which are known as anti-oxidants are concentrated more in the outer layers, so when you peel off the layers, you should remove as little as possible. carrots, like garlic, are also rich in sulphur compounds. carrots are known to contain manganese, copper, Vitamin B6, Vitamin C and dietary fibers along with phosphorus, folate and copper.</p>
            <hr/>      
                <p class="uk-text-lead zhead">Benefits</p>
                <p class="zpara">carrots are known to have antiseptic, antimicrobial and antibiotic properties which help you to get rid of infections. If a piece of carrot is inhaled, it can slow down or stop nose bleeding. Those who have sleeping disorders or insomnia can have a good night sleep if they have an carrot every day. carrots also help to improve the functions of the digestive system; because it releases the digestive juices and cures any problem related to digestion.</p>           
            <hr/>
