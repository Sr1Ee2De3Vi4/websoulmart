                    ...
                    <div class="uk-width-expand uk-margin-medium-top">
                        ...
                        <li class="uk-parent">
                            <label class="main-item uk-margin-remove-bottom"><Link to="FruitsVeg"><a href="!#">Fruits & Vegetables</a></Link></label>
                                <a class="parent uk-margin-small-left uk-margin-remove-bottom"style={{color:"#bf1961",fontWeight:"500"}} href="!#">Fresh Vegetables</a>
...
{/* side nave and main section end */}
        ...
        <div class="uk-container uk-hidden@l uk-hidden@m">
            <label class="header-labels uk-margin-remove-bottom uk-margin-medium-top ">Fresh Vegetables </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
