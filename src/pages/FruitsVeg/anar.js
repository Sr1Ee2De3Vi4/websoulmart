...
import card1 from "../../assets/anar.webp"
...
const griditems = [
    { id: 1, title:'Fresho' , objectname: 'Onion - Medium/Payaj', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 },
    { id: 2, title:'Fresho' , objectname: 'Banana - Robusta/Kela', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 },
    { id: 3, title:'Fresho' , objectname: 'Carrot Red Halwa', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 },
    { id: 4, title:'Fresho' , objectname: 'Grapes - Red Globe', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card9 },
    { id: 5, title:'Fresho' , objectname: 'Orange Imported/Malta', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card10 },
    { id: 6, title:'Fresho' , objectname: 'Pomegranate - Small', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card11 },
    { id: 7, title:'Fresho' , objectname: 'Mosambi', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card12 },
    { id: 8, title:'Fresho' , objectname: 'Apple - Red Delicious / Washington, Regular', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card13 },
    { id: 9, title:'Fresho' , objectname: 'Cabbage Small/Patta Gobhi', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card15 },
    { id: 10, title:'Fresho' , objectname: 'Cauliflower (Medium)/Phool - Gobhi', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card16 },
