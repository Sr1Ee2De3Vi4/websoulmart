...
import slide1 from'../../assets/EnergySlide.jpg'
...
<div class="uk-container uk-visible@m">
                    ...
                    <div class="uk-width-expand uk-margin-medium-top">
                        ...
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",paddingBottom:"5px"}}>Category</label></h4> 
                            <li class="uk-parent">
                                ...
                                <a class="parent uk-margin-small-left uk-margin-remove-bottom"style={{color:"#bf1961",fontWeight:"500"}} href="!#">Energy & Soft Drinks</a>
                                 <ul class="nav-sub uk-margin-left">
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Cold Drinks</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Icetea, Non Aerated Drink</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Non Alcoholic Drinks</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Soda & Cocktail Mix</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Sports & Energy Drinks</a></label></li><br/>
                                 </ul>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card uk-visible@m">
            <div class="uk-margin-right">
                    ...
                    <h3 class="items">Diet Coke Soft Drink</h3>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    ...
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Thums Up</h3>
                    <h3 class="items ">Soft Drink</h3>
                    <select class="uk-select mrp-style uk-height-small uk-text-bolder"style={{height:"23px"}}>
                        <option>1 Kg Rs:20.00</option>
                        <option>2 Kg Rs:40.00</option>
                    </select>
...
{/* side nave and main section end */}
        ...
        <div class="uk-container uk-hidden@l uk-hidden@m">
            <label class="header-labels uk-margin-remove-bottom uk-margin-medium-top ">Energy & Soft Drinks</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <div class="   uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                                <div>
                                    ...
                                    <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                        <h3 class="uk-text-muted fresho ">Coca-Cola</h3>
                                        <h3 class="items ">Diet Coke Soft Drink</h3><br/>
                        ...
                        <div class="uk-flex flex-style uk-padding-remove-left"style={{borderStyle:"ridge"}}>
                            <div class=" ">
                                <div class="   uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                                    ...
                                    <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                        <h3 class="uk-text-muted fresho ">Thums Up</h3>
                                        <h3 class="items ">Soft Drink</h3><br/>
                                        <select class="uk-select mrp-style uk-height-small uk-text-bolder">
                                            <option>1 Kg Rs:20.00</option>
                                            <option>2 Kg Rs:40.00</option>
                                        </select>
