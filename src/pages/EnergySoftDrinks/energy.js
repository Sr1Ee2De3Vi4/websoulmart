...
import './energy.css';
import slide2 from'../../assets/EnergySlide.jpg'
import card1 from'../../assets/Ecoca-cola-soft-drink.webp'
import card2 from'../../assets/Edrink-black-slim.webp'
import card3 from'../../assets/Esoft-drink.jpg'
import card4 from'../../assets/coca-cola-soft-drink-original-taste.webp'
...
<div className="uk-width-3-4" style={{}}>
 {/* fruits and veg cards */}
        ...
        <label class="header-label  "> Energy & Soft Drinks</label> 
        </div>
        <div class="col-3">
...
<label class="header-labels ">Energy & Soft Drinks
</label>
</div>
<div>
...
const categorydatas = [
    {
    title: "Category",
    pagename:"Energy & Soft Drinks",
    pageurl:"/EnergySoftDrinks",
    content: [
    {
        datas: "Cold Drinks",
    ...
    {
        datas: "Icetea, Non Aerated Drink",
        url:"/EnergySoftDrinks"
    },
    {
        datas: "Non Alcoholic Drinks",
        url:"/EnergySoftDrinks"
    },
...
const griditems = [
    { id: 1, title: 'Coca-Cola', objectname: 'Diet Coke Soft Drink', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link :'Energycard'},
    { id: 2, title: 'Coca-Cola',objectname: 'Pepsi', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link :'Energycard'},
    { id: 3, title: 'Coca-Cola',objectname: 'Soft Drink', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link :'Energycard'},
    { id: 4, title: 'Thums Up',objectname: 'Soft Drink', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4, card_link :'Energycard'},
    { id: 5, title: 'Coca-Cola', objectname: 'Diet Coke Soft Drink', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4, card_link :'Energycard'},
    { id: 6, title: 'Coca-Cola',objectname: 'Pepsi', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link :'Energycard'},
    { id: 7, title: 'Coca-Cola',objectname: 'Soft Drink', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1, card_link :'Energycard'},
    { id:8, title: 'Thums Up',objectname: 'Soft Drink', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link :'Energycard'},
