...
import card1 from "../../assets/amul.webp"
    ...
    <div class="uk-container">
        <div class="row uk-visible@m">
                ...
                <div class="uk-margin-left border-right">
                    <div class="uk-width-expand uk-margin-large-top">
                        ...
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",paddingBottom:"5px"}}>Category</label></h4> 
                            <li class="uk-parent">
                                <a class="parent uk-margin-remove-bottom"style={{color:"#bf1961",fontWeight:"500"}} href="!#">Bakery, Cakes & Dairy</a>
                                <ul class="nav-sub">
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Buttermilk & Lassi</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Cheese</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Condensed, Powdered Milk</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Curd</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Flavoured, Soya Milk</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Milk</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Paneer, Tofu & Cream</a></label></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                    <div class="uk-width-expand uk-margin-medium-top">
                        <ul class="uk-nav uk-nav-default">
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"18%",paddingBottom:"5px"}}>Brand</label></h4> <br/>
                                <ul class="nav-sub">
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Amul</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Amul Butter & Margarine</a></label></li>
                                </ul>                      
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-5">
                <div class="uk-margin-large-top uk-margin-left">
                    <label><label class="chech-text"style={{textDecoration:"underline",color: "#222",fontSize: "13px"}}>Amul</label></label><br/>
                    <label><label class="chech-text"style={{fontSize: "18px",color: "#222",fontWeight:"400"}}>Amul Butter - Pasteurized, 4x100 g Multipack</label></label>
                    <br/>
        ...
        <div class="uk-hidden@m">
            <div class="uk-align-left uk-margin-top">
                <label><button class="chech-text"style={{height:"24px",color: "#222",fontSize: "13px"}}>Amul</button></label><br/>
                    <label><label class="chech-text"style={{fontSize: "18px",color: "#222",fontWeight:"400"}}>Amul Butter - Pasteurized, 4x100 g Multipack</label></label>
                    <br/>
                            <span style={{font:"12px Proxima Nova",color: "#6e6e71"}}>MRP:</span>
                            <span style={{font:"12px Proxima Nova",color: "#6e6e71",textDecoration:"line-through"}}>Rs 65.50</span>
        ...
        <article class="uk-article uk-margin-left uk-padding-remove-left">
                <h1 class="uk-article-title"><a class="uk-link-reset zheading" href="">Amul Butter</a></h1>
