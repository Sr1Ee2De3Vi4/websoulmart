...
import slide2 from'../../assets/Slide1Foodgrains.webp'
import slide3 from'../../assets/Slide2Foodgrains.webp'
import slide4 from'../../assets/Slide3Foodgrains.webp'
import slide8 from'../../assets/Slide4Foodgrains.webp'
import veg from'../../assets/veg.png'
import card1 from'../../assets/atta1.jpg'
import card2 from'../../assets/atta2.jpg'
import card3 from'../../assets/dals1.jpg'
import card4 from'../../assets/dals2.jpg'
import card5 from'../../assets/dry5.jpg'
import card6 from'../../assets/dry6.jpg'
import card7 from'../../assets/dry7.jpg'
import card8 from'../../assets/dry8.jpg'
...
<label class="header-labels ">Foodgrains, Oil & Masala</label>
</div>
<div>
...
const categorydatas = [
    {
    title: "Category",
    pagename:"Foodgrains, Oil & Masala",
    pageurl:"/Food",
    content: [
    {
        datas: "Atta, Flours & Sooji",
        url:"/AttaFloursSooji"
    },
    {
        datas: "Dals & Pulses",
    ...
    {
        datas: "Rice & Rice Products",
        url:"/riceproducts"
    },
    {
        datas: "Masalas & Spices",
        url:"/masala"
    },
    {
        datas: "Edible Oils & Ghee",
        url:"/edibleoil"
    },
...
const griditems = [
    { id: 1, title: 'bb Royal', objectname: 'Atta - Shudh, Chakki', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1, card_link:'Foodcard' },
    { id: 2, title: 'bb Royal',objectname: 'Maida', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link:'Foodcard' },
    { id: 3, title: 'bb Royal',objectname: 'Rajma - White/Chitra', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link:'Foodcard' },
    { id: 4, title: 'bb Royal',objectname: 'Green Moong Whole/Sabut', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4, card_link:'Foodcard' },
    { id: 5, title: 'bb Royal', objectname: 'Flavoured Cashews - Thai Chilli', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5, card_link:'Foodcard' },
    { id: 6, title: 'bb Royal', objectname: 'Flavoured Cashews - Thai Chilli', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6, card_link:'Foodcard' },
    { id: 7, title: 'bb Royal', objectname: 'Almond/Badam - Californian, Giri', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7, card_link:'Foodcard' },
    { id: 8, title: 'bb Royal', objectname: 'Dry Dates/Chuara', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8, card_link:'Foodcard' },
    { id: 9, title: 'bb Royal', objectname: 'Nutflix Trail Mix', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1, card_link:'Foodcard' },
    { id: 10, title: 'bb Royal',objectname: 'Dry Dates/Chuara', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link:'Foodcard' },
    { id: 11, title: 'bb Royal',objectname: 'Flavoured Cashews - Thai Chilli', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link:'Foodcard' },
    { id: 12, title: 'bb Royal',objectname: 'Almond/Badam - Californian, Giri', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4, card_link:'Foodcard' },
    { id: 13, title: 'bb Royal', objectname: 'Flavoured Cashews - Thai Chilli', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5, card_link:'Foodcard' },
    { id: 14, title: 'bb Royal', objectname: 'Flavoured Cashews - Thai Chilli', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6, card_link:'Foodcard' },
    { id: 15, title: 'bb Royal', objectname: 'Flavoured Cashews - Chatpat Chaat', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7, card_link:'Foodcard' },
    { id: 16, title: 'bb Royal', objectname: 'Dry Dates/Chuara', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8, card_link:'Foodcard' },
