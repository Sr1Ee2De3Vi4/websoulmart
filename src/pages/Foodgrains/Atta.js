...
import card1 from "../../assets/Atta.webp"
    ...
    <div class="uk-container">
        <div class="row uk-visible@m">
                ...
                <div class="uk-margin-left border-right">
                    <div class="uk-width-expand uk-margin-large-top">
                        ...
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",paddingBottom:"5px"}}>Category</label></h4> 
                            <li class="uk-parent">
                                <a class="parent uk-margin-remove-bottom"style={{color:"#bf1961",fontWeight:"500"}} href="!#">Foodgrains, Oil & Masala</a>
                                <ul class="nav-sub">
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Atta, Flours & Sooji</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Atta Whole Wheat</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Rice & Other Flours</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Sooji, Maida & Besan</a></label></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                    <div class="uk-width-expand uk-margin-medium-top">
                        ...
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"18%",paddingBottom:"5px"}}>Brand</label></h4> <br/>
                                <ul class="nav-sub">
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Aashirvaad</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Aashirvaad Atta Whole Wheat</a></label></li>
                                </ul>                      
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-5">
                <div class="uk-margin-large-top uk-margin-left">
                    <label><label class="chech-text"style={{textDecoration:"underline",color: "#222",fontSize: "13px"}}>Aashirvaad</label></label><br/>
                    <label><label class="chech-text"style={{fontSize: "18px",color: "#222",fontWeight:"400"}}>Aashirvaad Shudh Chakki Atta, 5 kg</label></label>
                    <br/>
        ...
        <div class="uk-hidden@m">
            <div class="uk-align-left uk-margin-top">
                <label><button class="chech-text"style={{height:"24px",color: "#222",fontSize: "13px"}}>Aashirvaad</button></label><br/>
                    <label><label class="chech-text"style={{fontSize: "18px",color: "#222",fontWeight:"400"}}>Aashirvaad Shudh Chakki Atta, 5 kg</label></label>
                    <br/>
                            <span style={{font:"12px Proxima Nova",color: "#6e6e71"}}>MRP:</span>
                            <span style={{font:"12px Proxima Nova",color: "#6e6e71",textDecoration:"line-through"}}>Rs 65.50</span>
        ...
        <article class="uk-article uk-margin-left uk-padding-remove-left">
                <h1 class="uk-article-title"><a class="uk-link-reset zheading" href="">Aashirvaad Shudh Chakki Atta</a></h1>
