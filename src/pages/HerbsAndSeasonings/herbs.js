...
import './herbs.css';
import slide2 from'../../assets/herbslide1.webp'


import veg from'../../assets/veg.png'
import card1 from'../../assets/herbs1.jpg'
import card2 from'../../assets/herbs2.jpg'
import card3 from'../../assets/herbs3.jpg'
import card4 from'../../assets/herbs4.jpg'
import card5 from'../../assets/herbs5.jpg'
import card6 from'../../assets/herbs6.jpg'
import card7 from'../../assets/herbs7.jpg'
import card8 from'../../assets/herbs8.jpg'
...
<div className="uk-width-3-4" style={{}}>
 {/* fruits and veg cards */}
        ...
        <label class="header-label  ">Herbs & Seasonings</label> 
        </div>
        <div class="col-3">
...
<label class="header-labels ">Herbs & Seasonings</label>
</div>
<div>
...
const categorydatas = [
    {
    title: "Category",
    pagename:"Herbs & Seasonings",
    pageurl:"/Herbs",
    content: [
    {
        datas: "Indian & Exotic Herbs",
               url:"/Herbs"
    },
    {
         
        datas: "Lemon, Ginger & Garlic",
        url:"/Herbs"
    },
...
const griditems = [
    { id: 1, title: 'Amul', objectname: 'Lemon/Limboo', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link : 'Herbcard' },
    { id: 2, title: 'Amul',objectname: 'Ginger - Organically Grown', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link : 'Herbcard' },
    { id: 3, title: 'Amul',objectname: 'Fresh Garlic/Taje Lasun', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link : 'Herbcard' },
    { id: 4, title: 'Amul',objectname: 'Chilli - Hybrid', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link : 'Herbcard' },
    { id: 5, title: 'Amul', objectname: 'Fresh Ginger - Grade A/Taje Aale- Grade A', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5,card_link : 'Herbcard' },
    { id: 6, title: 'Amul', objectname: 'Coriander Leaves 100 g + Garlic 250 g + Ginger 250 g + Chilli Green Long 250 g', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6,card_link : 'Herbcard' },
    { id: 7, title: 'Amul', objectname: 'Garlic - Organically Grown', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7,card_link : 'Herbcard' },
    { id: 8, title: 'Amul', objectname: 'Black Garlic', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8,card_link : 'Herbcard' },
    { id: 9, title: 'Amul', objectname: 'Lemon/Limboo', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link : 'Herbcard' },
    { id: 10, title: 'Amul',objectname: 'Ginger - Organically Grown', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link : 'Herbcard' },
    { id: 11, title: 'Amul',objectname: 'Fresh Garlic/Taje Lasun', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link : 'Herbcard' },
    { id: 12, title: 'Amul',objectname: 'Chilli - Hybrid', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link : 'Herbcard' },
    { id: 13, title: 'Amul', objectname: 'Fresh Ginger - Grade A/Taje Aale- Grade A', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5,card_link : 'Herbcard' },
    { id: 14, title: 'Amul', objectname: 'Coriander Leaves 100 g + Garlic 250 g + Ginger 250 g + Chilli Green Long 250 g', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6,card_link : 'Herbcard' },
    { id: 15, title: 'Amul', objectname: 'Garlic - Organically Grown', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7,card_link : 'Herbcard' },
    { id: 16, title: 'Amul', objectname: 'Black Garlic', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8,card_link : 'Herbcard' },
