...
import card1 from'../../assets/vegg1.jpg'
import card2 from'../../assets/vegg2.jpg'
import card3 from'../../assets/vegg3.jpg'
import card4 from'../../assets/vegg4.jpg'
import card5 from'../../assets/vegg5.jpg'
import card6 from'../../assets/vegg6.jpg'
import card7 from'../../assets/vegg7.jpg'
import card8 from'../../assets/vegg8.jpg'
...
<div className="uk-width-3-4" style={{}}>
 {/* fruits and veg cards */}
        ...
        <label class="header-label  ">Fresh Vegetables</label> 
        </div>
        <div class="col-3">
...
const categorydatas = [
    {
    title: "Category",
    pagename:"Fresh Vegetables ",
    pageurl:"/vegetable",
    content: [
    {
        datas: "Beans, Brinjals & Okra (18)",
        url:"/vegetable"
    },
    {
         
        datas: " Cabbage & Cauliflower",
        url:"/vegetable"
    },
    {
        datas: "Cucumber & Capsicum",
        url:"/vegetable"
    },
    {
        datas: "Gourd, Pumpkin, Drumstick",
        url:"/vegetable"
    },
    {
        datas: "Leafy Vegetables",
        url:"/vegetable"
    },
...
const griditems = [
    { id: 1, title: 'Fresho', objectname: 'Onion', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1, card_link: 'Vegcard' },
    { id: 2, title: 'Fresho',objectname: 'Potato/Batate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link: 'Vegcard' },
    { id: 3, title: 'Fresho',objectname: 'Tomato Hybrid/Tomato Sankarit', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link: 'Vegcard' },
    { id: 4, title: 'Fresho',objectname: 'Carrot English/Gajar English (L', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4, card_link: 'Vegcard' },
    { id: 5, title: 'Fresho', objectname: 'Mushrooms - Button/Alambe-Batan', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5, card_link: 'Vegcard' },
    { id: 6, title: 'Fresho', objectname: 'Capsicum Hybrid Green/Sankarit Dhobli Mirchi', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6, card_link: 'Vegcard' },
    { id: 7, title: 'Fresho', objectname: 'Ladies Finger/Bhendi', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7, card_link: 'Vegcard' },
    { id: 8, title: 'Fresho', objectname: 'Cucumber - White/Kakdi- Safed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8, card_link: 'Vegcard' },
    { id: 9, title: 'Fresho', objectname: 'Onion', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1, card_link: 'Vegcard' },
    { id: 10, title: 'Fresho',objectname: 'Potato/Batate', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link: 'Vegcard' },
    { id: 11, title: 'Fresho',objectname: 'Tomato Hybrid/Tomato Sankarit', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link: 'Vegcard' },
    { id: 12, title: 'Fresho',objectname: 'Carrot English/Gajar English (L', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4, card_link: 'Vegcard' },
    { id: 13, title: 'Fresho', objectname: 'Mushrooms - Button/Alambe-Batan', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5, card_link: 'Vegcard' },
    { id: 14, title: 'Fresho', objectname: 'Capsicum Hybrid Green/Sankarit Dhobli Mirchi', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6, card_link: 'Vegcard' },
    { id: 15, title: 'Fresho', objectname: 'Ladies Finger/Bhendi', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7, card_link: 'Vegcard' },
    { id: 16, title: 'Fresho', objectname: 'Cucumber - White/Kakdi- Safed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8, card_link: 'Vegcard' },

  ];



export default vegss;
