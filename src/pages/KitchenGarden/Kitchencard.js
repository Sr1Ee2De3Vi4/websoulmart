...
import card1 from "../../assets/spoon.webp"
    ...
    <div class="uk-container">
        <div class="row uk-visible@m">
                ...
                <div class="uk-margin-left border-right">
                    <div class="uk-width-expand uk-margin-large-top">
                        ...
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",paddingBottom:"5px"}}>Category</label></h4> 
                            <li class="uk-parent">
                                <a class="parent uk-margin-remove-bottom"style={{color:"#bf1961",fontWeight:"500"}} href="!#">Kitchen, Garden & Pets</a>
                                <ul class="nav-sub">
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Cups, Mugs & Tumblers</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Cutlery, Spoon & Fork</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Dinner Sets</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Glassware</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Plates & Bowls</a></label></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                    <div class="uk-width-expand uk-margin-medium-top">
                        ...
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",paddingBottom:"5px"}}>Brand</label></h4> <br/>
                                <ul class="nav-sub">
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Iveo</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Iveo Plates & Bowls</a></label></li>
                                </ul>                      
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-5">
                <div class="uk-margin-large-top uk-margin-left">
                    <label><label class="chech-text"style={{textDecoration:"underline",color: "#222",fontSize: "13px"}}>Iveo</label></label><br/>
                    <label><label class="chech-text"style={{fontSize: "18px",color: "#222",fontWeight:"400"}}>Iveo 100% Melamine Soup Spoon STS Set, 4 pcs</label></label>
                    <br/>
        ...
        <div class="uk-hidden@m">
            <div class="uk-align-left uk-margin-top">
                <label><button class="chech-text"style={{height:"24px",color: "#222",fontSize: "13px"}}>Iveo</button></label><br/>
                    <label><label class="chech-text"style={{fontSize: "18px",color: "#222",fontWeight:"400"}}>Iveo 100% Melamine Soup Spoon STS Set, 4 pcs</label></label>
                    <br/>
                            <span style={{font:"12px Proxima Nova",color: "#6e6e71"}}>MRP:</span>
                            <span style={{font:"12px Proxima Nova",color: "#6e6e71",textDecoration:"line-through"}}>Rs 65.50</span>
        ...
        <article class="uk-article uk-margin-left uk-padding-remove-left">
                <h1 class="uk-article-title"><a class="uk-link-reset zheading" href="">Iveo 100% Melamine Soup Spoon</a></h1>
