...
import card1 from'../../assets/kitchen1.jpg'
import card2 from'../../assets/kitchen2.jpg'
import card3 from'../../assets/kitchen3.jpg'
import card4 from'../../assets/kitchen4.jpg'
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Kitchen Accessories</label>
                        </div>
                        <div class="col-3">
...
const categorydatas = [
    ...
    {
        datas: "Choppers & Graters",
        url:"/Kitchen"
    },
    {
        datas: "Kitchen Tools & Other Accessories",
        url:"/Kitchen"
    },
    {
        datas: "Knives & Peelers",
        url:"/Kitchen"
...
const griditems = [
    { id: 1, title: 'Anjali', objectname: 'Utility Set - Knife, Lighter, Peeler, Vibgyor, Green', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'KitchenAcceCard'},
    { id: 2, title: 'Anjali', objectname: 'Vegetable-Fruit Easy Chopper With Lassi Blade', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'KitchenAcceCard'},
    { id: 3, title: 'Anjali', objectname: 'Chopping-Cutting Board - Vibgyor, Green', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link:'KitchenAcceCard' },
    { id: 4, title: 'Anjali', objectname: 'Royal Mesh Strainer - Steel Mesh with Plastic Handle', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'KitchenAcceCard' },
    { id: 5, title: 'Anjali', objectname: 'Chopping-Cutting Board - Vibgyor, Green', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'KitchenAcceCard'},
    { id: 6, title: 'Anjali', objectname: 'Utility Set - Knife, Lighter, Peeler, Vibgyor, Green', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'KitchenAcceCard'},
    { id: 7, title: 'Anjali', objectname: 'Royal Mesh Strainer - Steel Mesh with Plastic Handle', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'KitchenAcceCard' },
    { id: 8, title: 'Anjali', objectname: 'Vegetable-Fruit Easy Chopper With Lassi Blade', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link:'KitchenAcceCard' },
    { id: 9, title: 'Anjali', objectname: 'Utility Set - Knife, Lighter, Peeler, Vibgyor, Green', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'KitchenAcceCard' },
    { id: 10, title: 'Anjali', objectname: 'Vegetable-Fruit Easy Chopper With Lassi Blade', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'KitchenAcceCard'},
    { id: 11, title: 'Anjali', objectname: 'Chopping-Cutting Board - Vibgyor, Green', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'KitchenAcceCard'},
    { id: 12, title: 'Anjali', objectname: 'Royal Mesh Strainer - Steel Mesh with Plastic Handle', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'KitchenAcceCard' },
    { id: 13, title: 'Anjali', objectname: 'Chopping-Cutting Board - Vibgyor, Green', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'KitchenAcceCard'},
    { id: 14, title: 'Anjali', objectname: 'Utility Set - Knife, Lighter, Peeler, Vibgyor, Green', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'KitchenAcceCard'},
    { id: 15, title: 'Anjali', objectname: 'Royal Mesh Strainer - Steel Mesh with Plastic Handle', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'KitchenAcceCard'},
    { id: 16, title: 'Anjali', objectname: 'Vegetable-Fruit Easy Chopper With Lassi Blade', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'KitchenAcceCard'},
  ];
