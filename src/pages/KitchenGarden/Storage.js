...
import card1 from'../../assets/storage1.jpg'
import card2 from'../../assets/storage2.jpg'
import card3 from'../../assets/storage3.jpg'
import card4 from'../../assets/storage4.jpg'
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Storage & Accessories</label>
                        </div>
                        <div class="col-3">
...
const categorydatas = [
    ...
    {
        datas: "Cloth Dryer & Iron Table",
        url:"/Storage"
    },
    {
        datas: "Containers Sets",
        url:"/Storage"
    },
    {
        datas: "Lunch Boxes",
    ...
    {
        datas: "Wall Hooks & Hangers",
        url:"/Storage"
        
    },
    {
        datas: "Water & Fridge Bottles",
        url:"/Storage"
...
const griditems = [
    { id: 1, title: 'BB Home', objectname: 'Octa Plastic Pet Water Bottle - White, Narrow Mouth', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'StorageCard' },
    { id: 2, title: 'BB Home', objectname: 'Octa Plastic Pet Water Bottle - Black, Narrow Mouth', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'StorageCard' },
    { id: 3, title: 'Asian', objectname: 'Stylo Storage Plastic Container - Printed, Blue', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'StorageCard' },
    { id: 4, title: 'BB Home', objectname: 'Penta Plastic Pet Water Bottle - Black, Wide Mouth', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'StorageCard' },
    { id: 5, title: 'Asian', objectname: 'Stylo Storage Plastic Container - Printed, Blue', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link:'StorageCard'  },
    { id: 6, title: 'BB Home', objectname: 'Octa Plastic Pet Water Bottle - White, Narrow Mouth', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'StorageCard' },
    { id: 7, title: 'BB Home', objectname: 'Penta Plastic Pet Water Bottle - Black, Wide Mouth', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'StorageCard' },
    { id: 8, title: 'BB Home', objectname: 'Octa Plastic Pet Water Bottle - Black, Narrow Mouth', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'StorageCard' },
    { id: 9, title: 'BB Home', objectname: 'Octa Plastic Pet Water Bottle - White, Narrow Mouth', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'StorageCard'  },
    { id: 10, title: 'BB Home', objectname: 'Octa Plastic Pet Water Bottle - Black, Narrow Mouth', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'StorageCard' },
    { id: 11, title: 'Asian', objectname: 'Stylo Storage Plastic Container - Printed, Blue', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'StorageCard' },
    { id: 12, title: 'BB Home', objectname: 'Penta Plastic Pet Water Bottle - Black, Wide Mouth', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'StorageCard' },
    { id: 13, title: 'Asian', objectname: 'Stylo Storage Plastic Container - Printed, Blue', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'StorageCard' },
    { id: 14, title: 'BB Home', objectname: 'Octa Plastic Pet Water Bottle - White, Narrow Mouth', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'StorageCard'  },
    { id: 15, title: 'BB Home', objectname: 'Penta Plastic Pet Water Bottle - Black, Wide Mouth', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'StorageCard' },
    { id: 16, title: 'BB Home', objectname: 'Octa Plastic Pet Water Bottle - Black, Narrow Mouth', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'StorageCard' },
  ];
