...
import slide4 from'../../assets/KitchenSlide3.jpg'
import slide2 from'../../assets/KitchenSlide4.jpg'
import slide3 from'../../assets/KitchenSlide1.jpg'

import card1 from'../../assets/Appl1.jpg'
import card2 from'../../assets/Appl2.jpg'
import card3 from'../../assets/Appl3.jpg'
import card4 from'../../assets/Appl4.jpg'
import card5 from'../../assets/Appl5.jpg'
import card6 from'../../assets/Appl6.jpg'
import card7 from'../../assets/Appl7.jpg'
import card8 from'../../assets/Appl8.jpg'
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Appliances & Electricals</label>
                        </div>
                        <div class="col-3">
...
const griditems = [
    { id: 1, title: 'Duracell', objectname: 'Ultra-Alkaline Battery AAA', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'AppliancesCard'},
    { id: 2, title: 'Philips', objectname: 'LED Bulb - 0.5 Watt, White, Deco Mini Base B22', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'AppliancesCard'},
    { id: 3, title: 'Mansaa', objectname: 'USB String Fairy Lights 3M 30 LED For Decoration - Multicolour', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'AppliancesCard'},
    { id: 4, title: 'Philips', objectname: 'LED Lamp - 20 Watt, Cool Daylight, T-Bulb/Beamer Base B22', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'AppliancesCard' },
    { id: 5, title: 'Philips', objectname: 'LED Batten - 20 Watt, Slimline Next', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 ,card_link:'AppliancesCard'},
    { id: 6, title: 'Syska', objectname: 'LED T-Bulb 10 Watt Lumispread - Cool Daylight White, B22', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6,card_link:'AppliancesCard' },
    { id: 7, title: 'Energizer', objectname: 'Alkaline Battery Max AAA (8+4 Free)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7,card_link:'AppliancesCard' },
    { id: 8, title: 'Philips', objectname: 'Rechargeable Emergency Inverter Bulb - 12 Watt, Cool Daylight, B22', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8,card_link:'AppliancesCard' },
    { id: 9, title: 'Duracell', objectname: 'Ultra-Alkaline Battery AAA', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'AppliancesCard'},
    { id: 10, title: 'Philips', objectname: 'LED Bulb - 0.5 Watt, White, Deco Mini Base B22', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link:'AppliancesCard' },
    { id: 11, title: 'Mansaa', objectname: 'USB String Fairy Lights 3M 30 LED For Decoration - Multicolour', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'AppliancesCard'},
    { id: 12, title: 'Philips', objectname: 'LED Lamp - 20 Watt, Cool Daylight, T-Bulb/Beamer Base B22', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'AppliancesCard'},
    { id: 13, title: 'Philips', objectname: 'LED Batten - 20 Watt, Slimline Next', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5,card_link:'AppliancesCard' },
    { id: 14, title: 'Syska', objectname: 'LED T-Bulb 10 Watt Lumispread - Cool Daylight White, B22', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6,card_link:'AppliancesCard' },
    { id: 15, title: 'Energizer', objectname: 'Alkaline Battery Max AAA (8+4 Free)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7,card_link:'AppliancesCard' },
    { id: 16, title: 'Philips', objectname: 'Rechargeable Emergency Inverter Bulb - 12 Watt, Cool Daylight, B22', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 ,card_link:'AppliancesCard'},
  ];
