...
import slide2 from'../../assets/KitchenSlide1.jpg'
...
import card1 from'../../assets/bake1.jpg'
import card2 from'../../assets/bake2.jpg'
import card3 from'../../assets/bake3.jpg'
import card4 from'../../assets/bake4.jpg'
import card5 from'../../assets/bake5.jpg'
import card6 from'../../assets/bake6.jpg'
import card7 from'../../assets/bake7.jpg'
import card8 from'../../assets/bake8.jpg'
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Bakeware</label>
                        </div>
                        <div class="col-3">
...
const categorydatas = [
    ...
    {
        datas: "Bakeware Accessories",
        url:"/Bakeware"
        
    },
    {
        datas: "Bakeware Moulds, Cutters",
        url:"/Bakeware"
    },
    {
        datas: "Baking Tools & Brushes",
        url:"/Bakeware"
...
const griditems = [
    { id: 1, title: 'Seven seas', objectname: 'Silicone Cupcake & Cake Pop Stand - Plastic, Assorted Colourt', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'BakewareCard'},
    { id: 2, title: 'Seven seas', objectname: 'Plastic Cupcake & Cookie Decorating Set - Assorted Colour', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link:'BakewareCard' },
    { id: 3, title: 'Seven seas', objectname: 'Carbon Steel 12 Cup Muffin Pan - Assorted Colour', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'BakewareCard'},
    { id: 4, title: 'Seven seas', objectname: 'Carbon Steel Tart Pan - Assorted Colourr', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'BakewareCard' },
    { id: 5, title: 'Seven seas', objectname: 'Carbon Steel Round Pie Pan - Assorted Colour', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5,card_link:'BakewareCard' },
    { id: 6, title: 'Seven seas', objectname: 'Silicone Cup Cake/Muffin Mould - Assorted Design & Colour', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6,card_link:'BakewareCard' },
    { id: 7, title: 'Seven seas', objectname: 'Silicone Cake Mould - 6 Cavity, Rose, Assorted Colour', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 ,card_link:'BakewareCard'},
    { id: 8, title: 'Seven seas', objectname: 'Silicone Baking Tray - Round, Assorted Colour', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 ,card_link:'BakewareCard'},
    { id: 9, title: 'Seven seas', objectname: 'Silicone Cupcake & Cake Pop Stand - Plastic, Assorted Colourt', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'BakewareCard'},
    { id: 10, title: 'Seven seas', objectname: 'Plastic Cupcake & Cookie Decorating Set - Assorted Colour', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'BakewareCard'},
    { id: 11, title: 'Seven seas', objectname: 'Carbon Steel 12 Cup Muffin Pan - Assorted Colour', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link:'BakewareCard' },
    { id: 12, title: 'Seven seas', objectname: 'Carbon Steel Tart Pan - Assorted Colourr', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'BakewareCard' },
    { id: 13, title: 'Seven seas', objectname: 'Carbon Steel Round Pie Pan - Assorted Colour', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 ,card_link:'BakewareCard'},
    { id: 14, title: 'Seven seas', objectname: 'Silicone Cup Cake/Muffin Mould - Assorted Design & Colour', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 ,card_link:'BakewareCard'},
    { id: 15, title: 'Seven seas', objectname: 'Silicone Cake Mould - 6 Cavity, Rose, Assorted Colour', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7,card_link:'BakewareCard' },
    { id: 16, title: 'Seven seas', objectname: 'Silicone Baking Tray - Round, Assorted Colour', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 ,card_link:'BakewareCard'},
  ];
