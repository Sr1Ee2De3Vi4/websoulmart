...
import slide1 from'../../assets/KitchenSlide4.jpg'
import slide2 from'../../assets/KitchenSlide3.jpg'
import slide3 from'../../assets/KitchenSlide2.jpg'
import slide4 from'../../assets/KitchenSlide1.jpg'

import card1 from'../../assets/pet1.jpg'
import card2 from'../../assets/pet2.jpg'
import card3 from'../../assets/pet3.jpg'
import card4 from'../../assets/pet4.jpg'
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Pet Food & Accessories</label>
                        </div>
                        <div class="col-3">
...
const categorydatas = [
    ...
    {
        datas: "Health Supplements",
        url:"/Pet"
    },
    {
        datas: "Pet Cleaning & Grooming",
        url:"/Pet"
    },
    {
        datas: "Pet Collars & Leashes",
        url:"/Pet"
        
    },
    {
        datas: "Pet Feeding Support",
        url:"/Pet"
        
    },
    {
        datas: "Pet Meals & Treats",
        url:"/Pet"
...
const griditems = [
    { id: 1, title: 'Pedigree', objectname: 'Dry Dog Food - Chicken & Vegetables, For Adult Dogs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'PetCard' },
    { id: 2, title: 'Pedigree', objectname: 'Wet Dog Food - Chicken & Liver Chunks In Gravy, For Adult Dogs(Pack of 15)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'PetCard'},
    { id: 3, title: 'Pedigree', objectname: 'Dentastix Dog Treat Oral Care For Adult Medium Breed - 10-25 kg, 28 Sticks', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'PetCard'},
    { id: 4, title: 'Pedigree', objectname: 'Wet Dog Food - Chicken & Liver Chunks In Gravy, For Adult Dogs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'PetCard'},
    { id: 5, title: 'Pedigree', objectname: 'Dentastix Dog Treat Oral Care For Adult Medium Breed - 10-25 kg, 28 Sticks', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'PetCard'},
    { id: 6, title: 'Pedigree', objectname: 'Dry Dog Food - Chicken & Vegetables, For Adult Dogs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'PetCard'},
    { id: 7, title: 'Pedigree', objectname: 'Wet Dog Food - Chicken & Liver Chunks In Gravy, For Adult Dogs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'PetCard' },
    { id: 8, title: 'Pedigree', objectname: 'Wet Dog Food - Chicken & Liver Chunks In Gravy, For Adult Dogs(Pack of 15)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'PetCard'},
    { id: 9, title: 'Pedigree', objectname: 'Dry Dog Food - Chicken & Vegetables, For Adult Dogs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'PetCard' },
    { id: 10, title: 'Pedigree', objectname: 'Wet Dog Food - Chicken & Liver Chunks In Gravy, For Adult Dogs(Pack of 15)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'PetCard'},
    { id: 11, title: 'Pedigree', objectname: 'Dentastix Dog Treat Oral Care For Adult Medium Breed - 10-25 kg, 28 Sticks', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link:'PetCard' },
    { id: 12, title: 'Pedigree', objectname: 'Wet Dog Food - Chicken & Liver Chunks In Gravy, For Adult Dogs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'PetCard'},
    { id: 13, title: 'Pedigree', objectname: 'Dentastix Dog Treat Oral Care For Adult Medium Breed - 10-25 kg, 28 Sticks', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link:'PetCard' },
    { id: 14, title: 'Pedigree', objectname: 'Dry Dog Food - Chicken & Vegetables, For Adult Dogs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'PetCard' },
    { id: 15, title: 'Pedigree', objectname: 'Wet Dog Food - Chicken & Liver Chunks In Gravy, For Adult Dogs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'PetCard'},
    { id: 16, title: 'Pedigree', objectname: 'Wet Dog Food - Chicken & Liver Chunks In Gravy, For Adult Dogs(Pack of 15)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'PetCard'},
  ];
