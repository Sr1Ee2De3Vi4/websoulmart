...
import card1 from'../../assets/cookware1.jpg'
import card2 from'../../assets/cookware2.jpg'
import card3 from'../../assets/cookware3.jpg'
import card4 from'../../assets/cookware4.jpg'
import card5 from'../../assets/cookware5.jpg'
import card6 from'../../assets/cookware6.jpg'
import card7 from'../../assets/cookware7.jpg'
import card8 from'../../assets/cookware8.jpg'
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Cookware & Non Stick</label>
                        </div>
                        <div class="col-3">
...
const categorydatas = [
    ...
    {
        datas: "Kadai & Fry Pans",
        url:"/Cookware"
        
    },
    {
        datas: "Pressure Cookers",
        url:"/Cookware"
        
    },
    {
        datas: "Tawa & Sauce Pan",
        url:"/Cookware"
...
const griditems = [
    { id: 1, title: 'Le Kaviraj', objectname: 'Appam Patra/Panniyarkal - 7 Rounds, Maroon', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'CookwareCard' },
    { id: 2, title: 'Nirlon', objectname: 'Non-Stick Tadka Pan/Vagaria', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'CookwareCard' },
    { id: 3, title: 'Kitchen Essentials', objectname: 'Home Zone Stainless Steel Milk Pan - Induction Bottom', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link:'CookwareCard'  },
    { id: 4, title: 'Hawkins Futura', objectname: 'Hard Anodised Tawa - AT28, 28 Cm', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'CookwareCard'  },
    { id: 5, title: 'Vinod', objectname: 'Stainless Steel Kadai - Induction Bottom With Glass Lid, 26 cm', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 ,card_link:'CookwareCard' },
    { id: 6, title: 'Nirlon', objectname: 'Non-Stick Cookware Set With Steel Lid - Maroon', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 ,card_link:'CookwareCard' },
    { id: 7, title: 'Hawkins', objectname: 'Contura Aluminium Pressure Cooker - HC20', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 ,card_link:'CookwareCard' },
    { id: 8, title: 'Hawkins', objectname: 'Contura Aluminium Pressure Cooker HC30', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 ,card_link:'CookwareCard' },
    { id: 9, title: 'Le Kaviraj', objectname: 'Appam Patra/Panniyarkal - 7 Rounds, Maroon', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'CookwareCard'  },
    { id: 10, title: 'Nirlon', objectname: 'Non-Stick Tadka Pan/Vagaria', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'CookwareCard' },
    { id: 11, title: 'Kitchen Essentials', objectname: 'Home Zone Stainless Steel Milk Pan - Induction Bottom', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link:'CookwareCard'  },
    { id: 12, title: 'Hawkins Futura', objectname: 'Hard Anodised Tawa - AT28, 28 Cm', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'CookwareCard' },
    { id: 13, title: 'Vinod', objectname: 'Stainless Steel Kadai - Induction Bottom With Glass Lid, 26 cm', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 ,card_link:'CookwareCard' },
    { id: 14, title: 'Nirlon', objectname: 'Non-Stick Cookware Set With Steel Lid - Maroon', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6,card_link:'CookwareCard'  },
    { id: 15, title: 'Hawkins', objectname: 'Contura Aluminium Pressure Cooker - HC20', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7,card_link:'CookwareCard'  },
    { id: 16, title: 'Hawkins', objectname: 'Contura Aluminium Pressure Cooker HC30', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 ,card_link:'CookwareCard' },
  ];
