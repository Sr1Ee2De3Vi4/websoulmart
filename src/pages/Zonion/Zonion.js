...
import card1 from "../../assets/bigonion.webp"
import veg from'../../assets/veg.png'
import card2 from '../../assets/truck.svg'
import card3 from "../../assets/onion.webp"
import './Zonion.css';
...
return (
    ...
    <div class="uk-container">
        <div class="row uk-visible@m">
            <div class="col-3">
                <div class="uk-margin-left border-right">
                    <div class="uk-width-expand uk-margin-large-top">
                        ...
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"26%",paddingBottom:"5px"}}>Category</label></h4> 
                            <li class="uk-parent">
                                <a class="parent uk-margin-remove-bottom"style={{color:"#bf1961",fontWeight:"500"}} href="!#">Fruits & Vegetables</a>
                                <ul class="nav-sub">
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Cuts & Sprouts</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Exotic Fruits & Veggies</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Fresh Fruits</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Fresh Vegetables</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Herbs & Seasonings</a></label></li>
                                    <li><label class="main-items uk-margin-remove-bottom"><a href="!#">Organic Fruits & Vegetables</a></label></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-5">
                <div class="uk-margin-large-top uk-margin-left">
                    ...
                    <label><label class="chech-text"style={{fontSize: "18px",color: "#222",fontWeight:"400"}}>Fresho Onion, 1 kg</label></label>
                    <br/>
        ...
        <article class="uk-article uk-margin-left">
                <h1 class="uk-article-title"><a class="uk-link-reset zheading" href="">Fresho Onion</a></h1>
