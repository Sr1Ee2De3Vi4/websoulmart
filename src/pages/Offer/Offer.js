...
import card1 from'../../assets/offer1img.jpg'
import card2 from'../../assets/offer2img.jpg'
import card3 from'../../assets/offer3img.jpg'
import card4 from'../../assets/offer4img.jpg'
import card6 from'../../assets/Edrink-black-slim.webp'
import card7 from'../../assets/tea-gold-leaf-tea.jpg'
import card8 from'../../assets/peanuts-raw.webp'
...
function Offer() {
    ...
    return ( 
        <div >
        {/* banner container */}
        <div class="uk-container uk-margin-small-top uk-visible@m ">
        <h5 class="banner-style  s ">Bigbasketeers have saved upto Rs. 2531 on their last month's shopping. Shop now to save more!</h5>
        </div>
        <div class="uk-container uk-margin-small-top uk-hidden@m ">
        <h6 class="banner-styles  s ">Bigbasketeers have saved upto Rs. 2531 on their last month's shopping. Shop now to save more!</h6>
        </div>
                ...
                <div class="uk-margin-left border-right">
                    <div class="uk-width-expand uk-margin-small-top">
                        ...
                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",paddingBottom:"5px"}}>Category</label></h4> 
                            <li class="uk-parent">
                                 <ul class="nav-sub">
                                    <Link to="BeautyHygiene"><li><label class="main-item uk-margin-remove-bottom"><a href="!#">Beauty & Hygiene</a></label></li></Link>
                                    <Link to="CleanHousehold"><li><label class="main-item uk-margin-remove-bottom"><a href="!#">Cleaning & Household</a></label></li></Link><br></br>
                                </ul>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="uk-list">
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Rs 51 - Rs 100</a></label></label></li>
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text "><a href="!#">Rs 101 - Rs 200</a></label></label></li>
                            <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Rs 201 - Rs 500</a></label></label></li> 
                    ...
                    <div>
                        ...
                        <div class="uk-panel uk-margin-xsmall-top scroll-list uk-panel-scrollable">
                            <ul class="uk-list">
                                ...
                                <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">4700BC</a></label></label></li>
                                <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text "><a href="!#">Aashirvaad</a></label></label></li>
                                <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Abbies</a></label></label></li> 
                                <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="  seasonal-text"><a href="!#">Amul</a></label></label></li>
                                <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Bali Kitchen</a></label></label></li>
                                ...
                                <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Britannia</a></label></label></li>
                                <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Maggi</a></label></label></li>
                                <li class="uk-margin-remove-top"><label><input class="uk-checkbox  " type="checkbox"/><label class="seasonal-text"><a href="!#">Lays</a></label></label></li>
                            </ul>
...
<div class="row">
        ...
        <div class="uk-flex flex-style uk-margin-top border-card uk-visible@m">
            <div class="uk-margin-right">
                    ...
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Duracell</h3>
                    <h3 class="items">Ultra Alkaline Battery AA</h3>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    ...
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Pedigree</h3>
                    <h3 class="items ">Dry Dog Food</h3>
                    <select class="uk-select mrp-style uk-height-small uk-text-bolder"style={{height:"23px"}}>
                        <option>1 Kg Rs:20.00</option>
                        <option>2 Kg Rs:40.00</option>
                    </select>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    ...
                    <h3 class="items ">Kitchen Knife Set</h3>
                    <select class="uk-select mrp-style uk-height-small uk-text-bolder"style={{height:"23px"}}>
                        <option>1 Kg Rs:20.00</option>
                        <option>2 Kg Rs:40.00</option>
                    </select>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    ...
                    <h3 class="items ">Dishwash Bar - Lemon</h3>
                    <select class="uk-select mrp-style uk-height-small uk-text-bolder"style={{height:"23px"}}>
                        <option>1 Kg Rs:20.00</option>
                        <option>2 Kg Rs:40.00</option>
                    </select>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    ...
                    <img src={veg} className=" veg-size"  alt="slide1"/>
                    <h3 class="uk-text-muted fresho ">Pepsi</h3>
                    <h3 class="items ">Pepsi</h3>
                    <select class="uk-select mrp-style uk-height-small uk-text-bolder"style={{height:"23px"}}>
                        <option>1 Kg Rs:20.00</option>
                        <option>2 Kg Rs:40.00</option>
                    </select>
        ...
        <div class="uk-flex flex-style uk-margin-top border-card">
            <div class="uk-margin-right">
                    ...
                    <h3 class="items ">Peanuts/Shengdana - Raw</h3>
                    <select class="uk-select mrp-style uk-height-small uk-text-bolder"style={{height:"23px"}}>
                        <option>1 Kg Rs:20.00</option>
                        <option>2 Kg Rs:40.00</option>
                    </select>
...
<div class="uk-container uk-hidden@l uk-hidden@m">
            <label class="header-labels uk-margin-remove-bottom uk-margin-medium-top ">All Offers</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <div class="uk-text-left">
                                    <div class="uk-width-expand uk-margin-medium-top">
                                        ...
                                        <h4 class="category-style"><label class="uk-margin-remove-bottom"style={{borderBottom:"2px solid #bf1961",width:"21%",paddingBottom:"5px"}}>Category</label></h4> 
                                            <li class="uk-parent">
                                                <a class="parent uk-margin-remove-bottom"style={{color:"#bf1961",fontWeight:"500"}} href="/FruitsVeg">All Offers</a>
                                                <ul class="nav-sub">
                                                    <Link to="BeautyHygiene"><li><label class="main-item uk-margin-remove-bottom"><a href="!#">Beauty & Hygiene</a></label></li></Link>
                                                    <Link to="CleanHousehold"><li><label class="main-item uk-margin-remove-bottom"><a href="!#">Cleaning & Household</a></label></li></Link><br></br>
                                                </ul>
                ...
                <div class="uk-flex flex-style uk-padding-remove-left"style={{borderStyle:"ridge"}}>
                    <div class=" ">
                        <div class="  uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                            ...
                            <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                <h3 class="uk-text-muted fresho ">Pedigree</h3>
                                <h3 class="items ">Dry Dog Food</h3><br/>
                                <select class="uk-select mrp-style uk-height-small uk-text-bolder">
                                    <option>1 Kg Rs:20.00</option>
                                    <option>2 Kg Rs:40.00</option>
                                </select>
                ...
                <div class="uk-flex flex-style uk-padding-remove-left"style={{borderStyle:"ridge"}}>
                    <div class=" ">
                        <div class="  uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                            ...
                            <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                <h3 class="uk-text-muted fresho ">DM HOME</h3>
                                <h3 class="items ">Kitchen Knife Set</h3><br/>
                                <select class="uk-select mrp-style uk-height-small uk-text-bolder">
                                    <option>1 Kg Rs:20.00</option>
                                    <option>2 Kg Rs:40.00</option>
                                </select>
                ...
                <div class="uk-flex flex-style uk-padding-remove-left"style={{borderStyle:"ridge"}}>
                    <div class=" ">
                        <div class="  uk-width-expand off uk-card uk-card-default uk-card-small"> GET 24% OFF<span class="asterisk-icon uk-margin-small-top"></span> </div>
                            ...
                            <div class="uk-align-right uk-margin-remove-left uk-margin-remove-bottom">
                                <h3 class="uk-text-muted fresho ">bb Royal</h3>
                                <h3 class="items ">Peanuts/Shengdana - Raw</h3><br/>
                                <select class="uk-select mrp-style uk-height-small uk-text-bolder">
                                    <option>1 Kg Rs:20.00</option>
                                    <option>2 Kg Rs:40.00</option>
                                </select>
