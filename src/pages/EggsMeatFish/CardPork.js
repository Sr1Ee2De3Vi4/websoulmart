...
import card1 from'../../assets/40177264_3-prasuma-pork-momos-original.jpg'

import '../FruitsVeg/fv.css';

function CardPork(props) {
    let { id } = useParams();
    return (
...
const dataItems = [
    {
        ...
        content: [
        {datas: "Prasuma"},
        {datas: "Prasuma Frozen Non-Veg Snacks"},
        ]
},
];
...
const categorydatas = [
    ...
    content: [
    {
        datas: "Frozen Veggies & Snacks",
        url:"/EggMeatFish"
    },
    {
        datas: "Frozen Indian Breads",
        url:"/EggMeatFish"
    },
    {
        datas: "Frozen Non-Veg Snacks",
        url:"/EggMeatFish"
    },
    {
        datas: "Frozen Veg Snacks",
        url:"/EggMeatFish"
        
    },
    {
        datas: "Frozen Vegetables",
        url:"/EggMeatFish"
...
const griditems = [
    { id: 1, title: 'Prasuma', objectname: 'Pork - Momos, Original', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
  ];
