                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Pork & Other Meats</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Pork & Other Meats</label>
                        </div>
...
const categorydatas = [
    ...
    content: [
    {
        datas: "Pork & Other Meats",
        url:"/Pork"
    },
    {
        datas: "Fresh & Frozen Pork",
        url:"/Pork"
    },
    ]
}
...
const griditems = [
    { id: 1, title: 'Prasuma', objectname: 'Pork - Momos, Original', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardPork'},
  ];
