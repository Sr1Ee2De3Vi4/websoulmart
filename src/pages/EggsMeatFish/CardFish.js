...
const griditems = [
    { id: 1, title: 'Fresho', objectname: 'Rohu Cut Pieces - Preservative Free, 4-6 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 2, title: 'Fresho', objectname: 'Basa Fish Fillet - Preservative Free', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 3, title: 'Fresho', objectname: 'Catla Fish - Large, Curry Cut/Bengali Cut, Preservative Free, 12-15 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 4, title: 'Fresho', objectname: 'Mackerel Fish - Large, Whole Cleaned, Preservative Free, 3-4 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
    { id: 5, title: 'ITC Master Chef', objectname: 'Prawns - Medium, Peeled & Deveined', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 },
    { id: 6, title: 'Buffet', objectname: 'Ready to Cook - Large Prawns (Peeled & Deveined)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 },
    { id: 7, title: 'Fresho', objectname: 'Sardine Fish - Large, Whole Cleaned, Preservative Free, 8-12 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 },
    { id: 8, title: 'ITC Master Chef', objectname: 'Prawns - Jumbo, Peeled & Deveined', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 },
    { id: 9, title: 'Fresho', objectname: 'Rohu Cut Pieces - Preservative Free, 4-6 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 10, title: 'Fresho', objectname: 'Basa Fish Fillet - Preservative Free', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 11, title: 'Fresho', objectname: 'Catla Fish - Large, Curry Cut/Bengali Cut, Preservative Free, 12-15 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 12, title: 'Fresho', objectname: 'Mackerel Fish - Large, Whole Cleaned, Preservative Free, 3-4 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
  ];
