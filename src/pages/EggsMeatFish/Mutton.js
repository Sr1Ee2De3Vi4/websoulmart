...
import slide3 from'../../assets/MeetSlide1.jpg'
import slide8 from'../../assets/MeetSlide4.jpg'

import card1 from'../../assets/mutton1.jpg'
import card2 from'../../assets/mutton2.jpg'
import card3 from'../../assets/mutton3.jpg'
import card4 from'../../assets/mutton4.jpg'
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Mutton & Lamb</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Mutton & Lamb</label>
                        </div>
...
const griditems = [
    { id: 1, title: 'Fresho', objectname: 'Mutton - Curry Cut, From Whole Carcass 8-10 Kgs. Antibiotic Residue-Free, Growth Hormone-Free', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardMutton'},
    { id: 2, title: 'Fresho', objectname: 'Mutton - Boneless, 2-3 pcs, Antibiotic Residue-Free, Growth Hormone-Free', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardMutton'},
    { id: 3, title: 'Fresho', objectname: 'Mutton - Mince, Antibiotic Residue-Free, Growth Hormone-Free', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardMutton'},
    { id: 4, title: 'Carnivore', objectname: 'Mutton Seekh Kabab', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardMutton'},
    { id: 5, title: 'Fresho', objectname: 'Rohu Fish (Large)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardMutton'},
    { id: 6, title: 'Fresho', objectname: 'Prawns-medium', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardMutton'},
    { id: 7, title: 'Fresho', objectname: 'Chicken Nuggets', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardMutton'},
    { id: 8, title: 'Fresho', objectname: 'Chicken - Curry Cut Without Skin', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardMutton'},
