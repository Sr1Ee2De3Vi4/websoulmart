...
import slide8 from'../../assets/MeetSlide1.jpg'

import card1 from'../../assets/egg1.jpg'
import card2 from'../../assets/egg2.jpg'
import card3 from'../../assets/egg3.jpg'
import card4 from'../../assets/egg4.jpg'
import card5 from'../../assets/egg5.jpg'
import card6 from'../../assets/egg6.jpg'
import card7 from'../../assets/egg7.jpg'
import card8 from'../../assets/egg8.jpg'
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Eggs</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Eggs</label>
                        </div>
...
const griditems = [
    { id: 1, title: 'Fresho', objectname: 'Farm Eggs - Table Tray, Medium, Antibiotic Residue-Free, Growth Hormone-Free', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardEggs' },
    { id: 2, title: 'Fresho', objectname: 'Farm White Eggs - Medium, Antibiotic Residue-Free, Growth Hormone-Free', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link:'CardEggs' },
    { id: 3, title: 'HEN FRUIT', objectname: 'Eggs - Farm White', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link:'CardEggs' },
    { id: 4, title: 'Fresho', objectname: 'Eggs - Regular', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4, card_link:'CardEggs' },
    { id: 5, title: 'HEN FRUIT', objectname: 'Power Brown Eggs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5, card_link:'CardEggs' },
    { id: 6, title: 'HEN FRUIT', objectname: 'Max Protein', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardEggs'},
    { id: 7, title: 'Fresho', objectname: 'Farm Eggs - Brown, Medium, Antibiotic Residue-Free, Growth Hormone-Free', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7, card_link:'CardEggs' },
    { id: 8, title: 'HEN FRUIT', objectname: 'Cage Free Eggs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardEggs'},
    { id: 9, title: 'Fresho', objectname: 'Farm Eggs - Table Tray, Medium, Antibiotic Residue-Free, Growth Hormone-Free', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1, card_link:'CardEggs' },
    { id: 10, title: 'Fresho', objectname: 'Farm White Eggs - Medium, Antibiotic Residue-Free, Growth Hormone-Free', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link:'CardEggs' },
    { id: 11, title: 'HEN FRUIT', objectname: 'Eggs - Farm White', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link:'CardEggs' },
    { id: 12, title: 'Fresho', objectname: 'Eggs - Regular', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4, card_link:'CardEggs' },
  ];
