...
import slide1 from'../../assets/MeetSlide1.jpg'
import slide2 from'../../assets/MeetSlide2.jpg'
import slide3 from'../../assets/MeetSlide3.jpg'
import slide8 from'../../assets/MeetSlide4.jpg'

import card1 from'../../assets/fish1.jpg'
import card2 from'../../assets/fish2.jpg'
import card3 from'../../assets/fish3.jpg'
import card4 from'../../assets/fish4.jpg'
import card5 from'../../assets/fish5.jpg'
import card6 from'../../assets/fish6.jpg'
import card7 from'../../assets/fish7.jpg'
import card8 from'../../assets/fish8.jpg'
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Fish & Seafood</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Fish & Seafood</label>
                        </div>
...
},
{
    title: "Pack Size",
    content: [
        {datas: "700-900 g Tray"},
        {datas: "30 Egg"},
        {datas: "2x12 pcs Multipack"},
        {datas: "2x6 pcs Multipack"},
        {datas: "4x6 pcs Multipack"},
        {datas: "Combo 2 Items"},
...
const categorydatas = [
    {
    title: "Category",
    pagename:"Eggs, Meat & Fish",
    pageurl:"/EggsMeatFish",
    content: [
    {
        datas: "Fish & Seafood",
        url:"/Fish"
...
const griditems = [
    { id: 1, title: 'Fresho', objectname: 'Rohu Cut Pieces - Preservative Free, 4-6 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardFish'},
    { id: 2, title: 'Fresho', objectname: 'Basa Fish Fillet - Preservative Free', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardFish' },
    { id: 3, title: 'Fresho', objectname: 'Catla Fish - Large, Curry Cut/Bengali Cut, Preservative Free, 12-15 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardFish'},
    { id: 4, title: 'Fresho', objectname: 'Mackerel Fish - Large, Whole Cleaned, Preservative Free, 3-4 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardFish'},
    { id: 5, title: 'ITC Master Chef', objectname: 'Prawns - Medium, Peeled & Deveined', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5, card_link:'CardFish' },
    { id: 6, title: 'Buffet', objectname: 'Ready to Cook - Large Prawns (Peeled & Deveined)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardFish'},
    { id: 7, title: 'Fresho', objectname: 'Sardine Fish - Large, Whole Cleaned, Preservative Free, 8-12 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardFish'},
    { id: 8, title: 'ITC Master Chef', objectname: 'Prawns - Jumbo, Peeled & Deveined', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardFish'},
    { id: 9, title: 'Fresho', objectname: 'Rohu Cut Pieces - Preservative Free, 4-6 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardFish'},
    { id: 10, title: 'Fresho', objectname: 'Basa Fish Fillet - Preservative Free', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardFish'},
    { id: 11, title: 'Fresho', objectname: 'Catla Fish - Large, Curry Cut/Bengali Cut, Preservative Free, 12-15 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardFish'},
    { id: 12, title: 'Fresho', objectname: 'Mackerel Fish - Large, Whole Cleaned, Preservative Free, 3-4 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardFish'},
  ];
