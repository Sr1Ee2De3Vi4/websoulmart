...
import card1 from'../../assets/mar1.jpg'
import card2 from'../../assets/mar2.jpg'
import card3 from'../../assets/mar3.jpg'
import card4 from'../../assets/mar4.jpg'
import card5 from'../../assets/mar5.jpg'
import card6 from'../../assets/mar6.jpg'
import card7 from'../../assets/mar7.jpg'
import card8 from'../../assets/mar8.jpg'
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Marinades</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Marinades</label>
                        </div>
...
const griditems = [
    { id: 1, title: 'Fresho', objectname: 'Chicken Peri Peri', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardMarinades'},
    { id: 2, title: 'Fresho', objectname: 'Chicken Tandoori', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2, card_link:'CardMarinades' },
    { id: 3, title: 'Fresho', objectname: 'Chicken Wings - Hot & Spicy', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3, card_link:'CardMarinades' },
    { id: 4, title: 'Fresho', objectname: 'Fish Tikka With Schezwan Sauce', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardMarinades'},
    { id: 5, title: 'Fresho', objectname: 'Habanero Chicken Wings', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardMarinades'},
    { id: 6, title: 'Fresho', objectname: 'Tandoori Chicken Wings', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardMarinades'},
    { id: 7, title: 'Fresho', objectname: 'Chicken Malai Tikka', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardMarinades'},
    { id: 8, title: 'Fresho', objectname: 'Fish Tandoori Tikka', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardMarinades'},
  ];
