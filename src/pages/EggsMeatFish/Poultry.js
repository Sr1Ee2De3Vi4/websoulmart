...
import slide1 from'../../assets/MeetSlide4.jpg'
import slide2 from'../../assets/MeetSlide2.jpg'
import slide3 from'../../assets/MeetSlide3.jpg'
import slide8 from'../../assets/MeetSlide4.jpg'

import card1 from'../../assets/Meet-chicken-breast-boneless.jpg'
import card2 from'../../assets/Meet-carne-chicken-chorizo-sausage.jpg'
import card3 from'../../assets/40062708_2-total-chicken-gizzard.jpg'
import card4 from'../../assets/40021112_1-carnivore-chicken-seekh-kabab-regular.jpg'
import card5 from'../../assets/40085987_1-fresho-chicken-tandoori-chicken-without-skin.jpg'
import card6 from'../../assets/40209211_1-fresho-jhatka-chicken-curry-cut.jpg'
import card7 from'../../assets/Meet-venkys-nuggets-chicken.jpg'
import card8 from'../../assets/Meetchicken-curry-cut.jpg'
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Poultry</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Poultry</label>
                        </div>
...
const griditems = [
    { id: 1, title: 'Fresho', objectname: 'Chicken-Breast', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardPoultry'},
    { id: 2, title: 'Fresho', objectname: 'Carne-Chicken', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardPoultry'},
    { id: 3, title: 'Fresho', objectname: 'Chicken Nuggets', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardPoultry'},
    { id: 4, title: 'Fresho', objectname: 'Chicken - Curry Cut Without Skin', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardPoultry'},
    { id: 5, title: 'Total', objectname: 'Chicken - Gizzard', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardPoultry'},
    { id: 6, title: 'Carnivore', objectname: 'Chicken Seekh Kabab - Regular', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardPoultry'},
    { id: 7, title: 'Fresho', objectname: 'Chicken - Tandoori Chicken, Without Skin', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardPoultry'},
    { id: 8, title: 'Fresho', objectname: 'Jhatka Chicken Curry Cut', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardPoultry'},
    { id: 9, title: 'Fresho', objectname: 'Chicken-Breast', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardPoultry'},
    { id: 10, title: 'Fresho', objectname: 'Carne-Chicken', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardPoultry'},
    { id: 11, title: 'Fresho', objectname: 'Chicken Nuggets', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardPoultry'},
    { id: 12, title: 'Fresho', objectname: 'Chicken - Curry Cut Without Skin', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardPoultry'},
