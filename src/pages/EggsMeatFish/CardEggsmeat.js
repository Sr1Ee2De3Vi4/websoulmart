...
import card3 from'../../assets/Meet-eggs.jpg'
import card4 from'../../assets/Meet-eggs-medium.jpg'
import card5 from'../../assets/Meet-fish-large-curry.jpg'
import card6 from'../../assets/Meet-prawns-medium.jpg'
import card7 from'../../assets/Meet-venkys-nuggets-chicken.jpg'
import card8 from'../../assets/Meetchicken-curry-cut.jpg'
import card9 from'../../assets/fish1.jpg'
import card10 from'../../assets/fish2.jpg'
import card11 from'../../assets/fish3.jpg'
import card12 from'../../assets/fish4.jpg'

import '../FruitsVeg/fv.css';

function CardEggsmeat(props) {
    let { id } = useParams();
    return (
...
const griditems = [
    { id: 1, title: 'Fresho', objectname: 'Chicken-Breast', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 2, title: 'Meatzza', objectname: 'Chicken - Sausage', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 3, title: 'Fresho', objectname: 'Eggs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 4, title: 'Fresho', objectname: 'Eggs-Medium', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
    { id: 5, title: 'Fresho', objectname: 'Rohu Fish (Large)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 },
    { id: 6, title: 'Fresho', objectname: 'Prawns-medium', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 },
    { id: 7, title: 'Fresho', objectname: 'Chicken Nuggets', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 },
    { id: 8, title: 'Fresho', objectname: 'Chicken - Curry Cut Without Skin', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 },
    { id: 9, title: 'Fresho', objectname: 'Rohu Cut Pieces - Preservative Free, 4-6 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card9 },
    { id: 10, title: 'Fresho', objectname: 'Basa Fish Fillet - Preservative Free', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card10 },
    { id: 11, title: 'Fresho', objectname: 'Catla Fish - Large, Curry Cut/Bengali Cut, Preservative Free, 12-15 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card11 },
    { id: 12, title: 'Fresho', objectname: 'Mackerel Fish - Large, Whole Cleaned, Preservative Free, 3-4 pcs', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card12 },
  ];
  

export default CardEggsmeat;