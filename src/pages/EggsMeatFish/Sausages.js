...
import slide1 from'../../assets/MeetSlide2.jpg'
import slide2 from'../../assets/MeetSlide1.jpg'
import slide3 from'../../assets/MeetSlide3.jpg'
import slide8 from'../../assets/MeetSlide4.jpg'

import card1 from'../../assets/sau1.jpg'
import card2 from'../../assets/sau2.jpg'
import card3 from'../../assets/sau3.jpg'
import card4 from'../../assets/sau4.jpg'
                        ...
                        <div className="uk-width-3-4" style={{}}>
                            ...
                            <div class="row uk-margin-medium-top ">
                                <div class="col-9 uk-padding-remove-left">
                                    <label class="header-label  ">Sausages, Bacon & Salami</label>
                                </div>
                                <div class="col-3">
                ...
                <div className="sm_card_grid uk-align-center content_width">
                    <div className="uk-grid  uk-width-1-1">
                        <div className="uk-width-5-6@s uk-width-2-3">
                            <label class="header-labels ">Sausages, Bacon & Salami</label>
                        </div>
...
const categorydatas = [
    ...
    content: [
    {
        datas: "Sausages, Bacon & Salami",
        url:"/Sausages"
    },
    {
        datas: "Chicken Sausages",
        url:"/Sausages"
    },
    {
        datas: "Pork & Ham ",
...
const griditems = [
    { id: 1, title: 'Meatzza', objectname: 'Chicken - Sausage', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardSausages'},
    { id: 2, title: 'Meatzza', objectname: 'Chicken - Salami Masala Sliced', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardSausages'},
    { id: 3, title: 'Prasuma', objectname: 'Chicken - Momos, Original', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardSausages'},
    { id: 4, title: 'Meatzza', objectname: 'Chicken - Seek Kabab', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardSausages'},
    { id: 5, title: 'Meatzza', objectname: 'Chicken - Seek Kabab', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardSausages'},
    { id: 6, title: 'Prasuma', objectname: 'Chicken - Momos, Original', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardSausages'},
    { id: 7, title: 'Meatzza', objectname: 'Chicken - Sausage', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardSausages'},
    { id: 8, title: 'Meatzza', objectname: 'Chicken - Salami Masala Sliced', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardSausages'},
    { id: 9, title: 'Meatzza', objectname: 'Chicken - Sausage', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardSausages'},
    { id: 10, title: 'Meatzza', objectname: 'Chicken - Salami Masala Sliced', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardSausages'},
    { id: 11, title: 'Prasuma', objectname: 'Chicken - Momos, Original', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardSausages'},
    { id: 12, title: 'Meatzza', objectname: 'Chicken - Seek Kabab', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardSausages'},
  ];
