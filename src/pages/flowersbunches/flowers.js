...
import card1 from '../../assets/fl1.jpg'
import card2 from '../../assets/fl2.jpg'
import card3 from '../../assets/fl3.jpg'
import card4 from '../../assets/fl4.jpg'
...
<div className="uk-width-3-4" style={{}}>
 {/* fruits and veg cards */}
        ...
        <label class="header-label  ">Flower Bouquets, Bunches </label> 
        </div>
        <div class="col-3">
...
<label class="header-labels ">Flower Bouquets, Bunches
 </label>
</div>
<div>
...
const categorydatas = [
    {
    title: "Category",
    pagename:"Flower Bouquets, Bunches ",
    pageurl:"/flower",
    content: [
    {
        datas: "Marigold",
...
const griditems = [
    { id: 1, title: 'Fresho',  objectname: 'Marigold Flower - Orange', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'Flowercard' },
    { id: 2, title: 'Fresho', objectname: 'Mango Leaves', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link:'Flowercard' },
    { id: 3, title: 'Fresho',objectname: 'Marigold Flower - Yellow', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link:'Flowercard' },
    { id: 4, title: 'Fresho',objectname: 'Banana Leaf', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'Flowercard' },
