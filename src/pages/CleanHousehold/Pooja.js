...
import card1 from'../../assets/pooja1.jpg'
import card2 from'../../assets/pooja2.jpg'
import card3 from'../../assets/pooja3.jpg'
import card4 from'../../assets/pooja4.jpg'
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Pooja Needs</label>
                        </div>
                        <div class="col-3">
...
const categorydatas = [
    ...
    {
        datas: "Agarbatti, Incense Sticks",
        url:"/Pooja"
    },
    {
        datas: "Camphor & Wicks",
    ...
    {
        datas: "Other Pooja Needs",
        url:"/Pooja"
        
    },
    {
        datas: "Pooja Thali & Bells",
        url:"/Pooja"
    },
    ]
}
...
const griditems = [
    { id: 1, title: 'Mangaldeep', objectname: 'Sandal Agarbatti Sticks', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'PoojaCard'},
    { id: 2, title: 'Mangaldeep', objectname: 'Bouquet Agarbatti Sticks', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link:'PoojaCard' },
    { id: 3, title: 'Mangaldeep', objectname: 'Lavender Agarbatti Sticks', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'PoojaCard'},
    { id: 4, title: 'Mangalbhavan.in', objectname: 'Kapoor', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'PoojaCard'},
    { id: 5, title: 'Mangaldeep', objectname: 'Lavender Agarbatti Sticks', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'PoojaCard'},
    { id: 6, title: 'Mangaldeep', objectname: 'Sandal Agarbatti Sticks', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'PoojaCard' },
    { id: 7, title: 'Mangalbhavan.in', objectname: 'Kapoor', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'PoojaCard' },
    { id: 8, title: 'Mangaldeep', objectname: 'Bouquet Agarbatti Sticks', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'PoojaCard'},
    { id: 9, title: 'Mangaldeep', objectname: 'Sandal Agarbatti Sticks', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'PoojaCard'},
    { id: 10, title: 'Mangaldeep', objectname: 'Bouquet Agarbatti Sticks', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link:'PoojaCard' },
    { id: 11, title: 'Mangaldeep', objectname: 'Lavender Agarbatti Sticks', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'PoojaCard'},
    { id: 12, title: 'Mangalbhavan.in', objectname: 'Kapoor', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'PoojaCard'},
  ];
