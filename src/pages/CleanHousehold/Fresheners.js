...
import card1 from'../../assets/fresh1.jpg'
import card2 from'../../assets/fresh2.jpg'
import card3 from'../../assets/fresh3.jpg'
import card4 from'../../assets/fresh4.jpg'
import card5 from'../../assets/fresh5.jpg'
import card6 from'../../assets/fresh6.jpg'
import card7 from'../../assets/fresh7.jpg'
import card8 from'../../assets/fresh8.jpg'
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Fresheners & Repellents</label>
                        </div>
                        <div class="col-3">
...
const categorydatas = [
    ...
    {
        datas: "Insect Repellent",
        url:"/Fresheners"
        
    },
    {
        datas: "Mosquito Repellent",
        url:"/Fresheners"
...
const griditems = [
    { id: 1, title: 'bb Combo', objectname: 'Odonil Bathroom Air Freshener Blissful Citrus 10g + Vim Dishwash Gel Lemon 500ml', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'FreshenersCard'},
    { id: 2, title: 'Good Knight', objectname: 'Power Activ+ - Mosquito Repellent Refill', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'FreshenersCard'},
    { id: 3, title: 'BB Home', objectname: 'Naphthalene Balls', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'FreshenersCard'},
    { id: 4, title: 'All Out', objectname: 'Ultra Mosquito Repellant Refill', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'FreshenersCard' },
    { id: 5, title: 'Godrej', objectname: 'Aer Pocket Bathroom Freshener 30g Pack of 3 + Hand Wash - Masterblaster 750ml', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5,card_link:'FreshenersCard' },
    { id: 6, title: 'HIT', objectname: 'Mosquito & Fly Killer Spray', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 ,card_link:'FreshenersCard'},
    { id: 7, title: 'Aer', objectname: 'Power Pocket - Bathroom Air Fragrance', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7,card_link:'FreshenersCard' },
    { id: 8, title: 'Cleanzo', objectname: 'Napthalene Balls', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 ,card_link:'FreshenersCard'},
    { id: 9, title: 'bb Combo', objectname: 'Odonil Bathroom Air Freshener Blissful Citrus 10g + Vim Dishwash Gel Lemon 500ml', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'FreshenersCard' },
    { id: 10, title: 'Good Knight', objectname: 'Power Activ+ - Mosquito Repellent Refill', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'FreshenersCard'},
    { id: 11, title: 'BB Home', objectname: 'Naphthalene Balls', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'FreshenersCard'},
    { id: 12, title: 'All Out', objectname: 'Ultra Mosquito Repellant Refill', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'FreshenersCard' },
  ];
