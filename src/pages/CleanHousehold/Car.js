...
import slide4 from'../../assets/CleanSlide3.jpg'

import card1 from'../../assets/car1.jpg'
import card2 from'../../assets/car2.jpg'
import card3 from'../../assets/car3.jpg'
import card4 from'../../assets/car4.jpg'
import card5 from'../../assets/car5.jpg'
import card6 from'../../assets/car6.jpg'
import card7 from'../../assets/car7.jpg'
import card8 from'../../assets/car8.jpg'
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Car & Shoe Care</label>
                        </div>
                        <div class="col-3">
...
const griditems = [
    { id: 1, title: 'Ambi pur', objectname: 'Car Freshener Gel, Refreshing Lemon', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1  ,card_link:'CarCard'},
    { id: 2, title: 'Ambi pur', objectname: 'Car Freshener Gel, Relaxing Lavender', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'CarCard'},
    { id: 3, title: 'Cherry Blossom', objectname: 'Shoe Polish - Black', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'CarCard'},
    { id: 4, title: 'Cherry Blossom', objectname: 'Liquid Shoe Polish - Black', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'CarCard'},
    { id: 5, title: 'Aer', objectname: 'Twist Gel - Car Air Freshener, Fresh Lush Green', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 ,card_link:'CarCard'},
    { id: 6, title: 'Kiwi', objectname: 'Express Shine Sponge - For ALL Colours', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6,card_link:'CarCard' },
    { id: 7, title: 'Aer', objectname: 'Twist Gel - Car Air Freshener, Petal Crush Pink', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 ,card_link:'CarCard'},
    { id: 8, title: 'Aer', objectname: 'Twist Gel - Car Air Freshener, Rich Irish Cocktail', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 ,card_link:'CarCard'},
    { id: 9, title: 'Ambi pur', objectname: 'Car Freshener Gel, Refreshing Lemon', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'CarCard' },
    { id: 10, title: 'Ambi pur', objectname: 'Car Freshener Gel, Relaxing Lavender', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'CarCard'},
    { id: 11, title: 'Cherry Blossom', objectname: 'Shoe Polish - Black', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'CarCard'},
    { id: 12, title: 'Cherry Blossom', objectname: 'Liquid Shoe Polish - Black', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'CarCard'},
  ];
