...
import slide2 from'../../assets/CleanSlide1.jpg'
...
import card4 from'../../assets/prill.webp'
import card5 from'../../assets/all1.jpg'
import card6 from'../../assets/all2.jpg'
import card7 from'../../assets/all3.jpg'
import card8 from'../../assets/all4.jpg'
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">All Purpose Cleaners</label>
                        </div>
                        <div class="col-3">
...
const categorydatas = [
    ...
    {
        datas: "Disinfectant Spray & Cleaners",
        url:"/Allpurpose"
        
    },
    {
        datas: "Floor & Other Cleaners",
        url:"/Allpurpose"
    },
    {
        datas: "Kitchen, Glass & Drain",
        url:"/Allpurpose"
        
    },
    {
        datas: "Metal, Furniture Cleaner",
        url:"/Allpurpose"
        
    },
    {
        datas: "Toilet Cleaners",
        url:"/Allpurpose"
...
const griditems = [
    { id: 1, title: 'Dettol', objectname: 'Liquid Disinfectant for Multi-Purpose Germ Protection - Menthol Cool', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 ,card_link:'AllpurposeCard'},
    { id: 2, title: 'Lizol', objectname: 'Disinfectant Surface Cleaner - Floral', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 ,card_link:'AllpurposeCard'},
    { id: 3, title: 'Colin', objectname: 'Glass and Household Cleaner - Ultra Shine Formula', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 ,card_link:'AllpurposeCard'},
    { id: 4, title: 'bb Combo', objectname: 'Lizol Surface Cleaner-Floral 2 L + Harpic Power Plus Toilet Cleaner-Original 1 L', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8,card_link:'AllpurposeCard' },
    { id: 5, title: 'Vim', objectname: 'Dishwash Liquid Gel - Lemon', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'AllpurposeCard' },
    { id: 6, title: 'Harpic', objectname: 'Disinfectant Toilet Cleaner', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'AllpurposeCard'},
    { id: 7, title: 'Lizol', objectname: 'Floral-Lavender', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'AllpurposeCard'},
    { id: 8, title: 'Prill', objectname: 'Dishwash Liquid - Lime', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 ,card_link:'AllpurposeCard'},
    { id: 9, title: 'Dettol', objectname: 'Liquid Disinfectant for Multi-Purpose Germ Protection - Menthol Cool', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 ,card_link:'AllpurposeCard'},
    { id: 10, title: 'Lizol', objectname: 'Disinfectant Surface Cleaner - Floral', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6,card_link:'AllpurposeCard' },
    { id: 11, title: 'Colin', objectname: 'Glass and Household Cleaner - Ultra Shine Formula', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 ,card_link:'AllpurposeCard'},
    { id: 12, title: 'bb Combo', objectname: 'Lizol Surface Cleaner-Floral 2 L + Harpic Power Plus Toilet Cleaner-Original 1 L', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8,card_link:'AllpurposeCard' },
    { id: 13, title: 'Vim', objectname: 'Dishwash Liquid Gel - Lemon', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'AllpurposeCard' },
    { id: 14, title: 'Harpic', objectname: 'Disinfectant Toilet Cleaner', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'AllpurposeCard'},
    { id: 15, title: 'Lizol', objectname: 'Floral-Lavender', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'AllpurposeCard'},
    { id: 16, title: 'Prill', objectname: 'Dishwash Liquid - Lime', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 ,card_link:'AllpurposeCard'},
  ];
