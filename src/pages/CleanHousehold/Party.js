...
import card1 from'../../assets/party1.jpg'
import card2 from'../../assets/party2.jpg'
import card3 from'../../assets/party3.jpg'
import card4 from'../../assets/party4.jpg'
import card5 from'../../assets/party5.jpg'
import card6 from'../../assets/party6.jpg'
import card7 from'../../assets/party7.jpg'
import card8 from'../../assets/party8.jpg'
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Party & Festive Needs</label>
                        </div>
                        <div class="col-3">
...
const categorydatas = [
    ...
    {
        datas: "Disposable Cups & Plates",
        url:"/Party"
        
    },
    {
        datas: "Gift Wraps & Bags",
        url:"/Party"
        
    },
    {
        datas: "Holi Colours & Pichkari",
        url:"/Party"
        
    },
    {
        datas: "Seasonal Accessories",
        url:"/Party"
    },
    ]
}
...
const griditems = [
    { id: 1, title: 'B Vishal', objectname: 'Balloon - Polka Dot, 12 Inch', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'PartyCard' },
    { id: 2, title: 'B Vishal', objectname: 'Birthday Candle - No. 5', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'PartyCard'},
    { id: 3, title: 'B Vishal', objectname: 'Happy Birthday Foil Ballon For Girls - 1 Year', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'PartyCard'},
    { id: 4, title: 'B Vishal', objectname: 'Happy Birthday Cap - Chamki', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'PartyCard'},
    { id: 5, title: 'B Vishal', objectname: 'Printed Paper Plate For Party - 9 Inch, Assorted', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5,card_link:'PartyCard' },
    { id: 6, title: 'B Vishal', objectname: 'Party Poppers - Assorted, 30 Cm', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 ,card_link:'PartyCard'},
    { id: 7, title: 'B Vishal', objectname: 'Foil Balloon - Baby Girl', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7,card_link:'PartyCard' },
    { id: 8, title: 'B Vishal', objectname: 'Foil Balloon - Baby Boy', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 ,card_link:'PartyCard'},
    { id: 9, title: 'B Vishal', objectname: 'Balloon - Polka Dot, 12 Inch', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'PartyCard'},
    { id: 10, title: 'B Vishal', objectname: 'Birthday Candle - No. 5', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'PartyCard'},
    { id: 11, title: 'B Vishal', objectname: 'Happy Birthday Foil Ballon For Girls - 1 Year', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link:'PartyCard' },
    { id: 12, title: 'B Vishal', objectname: 'Happy Birthday Cap - Chamki', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'PartyCard'},
  ];
