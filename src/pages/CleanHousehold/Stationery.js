...
import card1 from'../../assets/sta1.jpg'
import card2 from'../../assets/sta2.jpg'
import card3 from'../../assets/sta3.jpg'
import card4 from'../../assets/sta4.jpg'
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Stationery</label>
                        </div>
                        <div class="col-3">
...
const categorydatas = [
    ...
    {
        datas: "Books & Magazines",
        url:"/Stationery"
    },
    {
        datas: "Colours & Crayons",
        url:"/Stationery"
        
    },
    {
        datas: "Electronic Accessories",
        url:"/Stationery"
        
    },
    {
        datas: "Erasers & Sharpeners",
        url:"/Stationery"
        
    },
    {
        datas: "Exam Pads & Pencil Box",
        url:"/Stationery"
        
    },
    {
        datas: "Games & Calculators",
        url:"/Stationery"
    },
    {
        datas: "Notebooks, Files, Folders",
        url:"/Stationery"
    },
    {
        datas: "Pen, Pencils",
...
const griditems = [
    { id: 1, title: 'Pidilite', objectname: 'Adhesive - Easy Flow White', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'StationeryCard'},
    { id: 2, title: 'Pidilite', objectname: 'Fevikwik - Gel', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link:'StationeryCard' },
    { id: 3, title: 'Pidilite', objectname: 'M Seal - Phataphat', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'StationeryCard'},
    { id: 4, title: 'Kaadoo', objectname: 'Koogu - Innovative Learning Card Game For Kids & Family, MultiColour, Fun Gift', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'StationeryCard' },
    { id: 5, title: 'Pidilite', objectname: 'M Seal - Phataphat', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'StationeryCard'},
    { id: 6, title: 'Pidilite', objectname: 'Adhesive - Easy Flow White', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'StationeryCard' },
    { id: 7, title: 'Kaadoo', objectname: 'Koogu - Innovative Learning Card Game For Kids & Family, MultiColour, Fun Gift', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'StationeryCard' },
    { id: 8, title: 'Pidilite', objectname: 'Fevikwik - Gel', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link:'StationeryCard' },
    { id: 9, title: 'Pidilite', objectname: 'Adhesive - Easy Flow White', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'StationeryCard'},
    { id: 10, title: 'Pidilite', objectname: 'Fevikwik - Gel', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link:'StationeryCard' },
    { id: 11, title: 'Pidilite', objectname: 'M Seal - Phataphat', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'StationeryCard'},
    { id: 12, title: 'Kaadoo', objectname: 'Koogu - Innovative Learning Card Game For Kids & Family, MultiColour, Fun Gift', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'StationeryCard'},
  ];
