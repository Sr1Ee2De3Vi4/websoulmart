...
import card1 from'../../assets/dis1.jpg'
import card2 from'../../assets/dis2.jpg'
import card3 from'../../assets/dis3.jpg'
import card4 from'../../assets/dis4.jpg'
import card5 from'../../assets/dis5.jpg'
import card6 from'../../assets/dis6.jpg'
import card7 from'../../assets/dis7.jpg'
import card8 from'../../assets/dis8.jpg'
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Disposables, Garbage Bag</label>
                        </div>
                        <div class="col-3">
...
const categorydatas = [
    ...
    {
        datas: "Aluminium Foil, Clingwrap",
        url:"/Disposables"
...
const griditems = [
    { id: 1, title: 'bb Combo', objectname: 'Selpak Kitchen Towel Paper Tissue Roll 100pcs + Vim Dishwash Gel - Lemon 500ml', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'DisposablesCard' },
    { id: 2, title: 'Origami', objectname: '2 Ply Kitchen Towels', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'DisposablesCard'},
    { id: 3, title: 'Origami', objectname: 'Klassic Plain Cocktail Napkins (22 X 22 cm)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'DisposablesCard'},
    { id: 4, title: 'BB Home', objectname: 'Facial Tissues - 2 Ply -100% Virgin Pulp/Paper', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'DisposablesCard' },
    { id: 5, title: 'Origami', objectname: 'Non-Woven Washable & Absorbent Kitchen Towels', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 ,card_link:'DisposablesCard'},
    { id: 6, title: 'BB Home', objectname: 'Toilet Roll - 2 Ply, Pack of 4', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 ,card_link:'DisposablesCard'},
    { id: 7, title: 'BB Home', objectname: 'Pocket Tissue - 3 Ply 10Sheets Pack of 6 + Facial Tissues - 2 Ply 100Pulls', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 ,card_link:'DisposablesCard'},
    { id: 8, title: 'BB Home', objectname: 'Compostable Garbage Bags - Medium, Blue, Mono-Carton (19x21 Inches)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8,card_link:'DisposablesCard' },
    { id: 9, title: 'bb Combo', objectname: 'Selpak Kitchen Towel Paper Tissue Roll 100pcs + Vim Dishwash Gel - Lemon 500ml', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'DisposablesCard' },
    { id: 10, title: 'Origami', objectname: '2 Ply Kitchen Towels', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'DisposablesCard'},
    { id: 11, title: 'Origami', objectname: 'Klassic Plain Cocktail Napkins (22 X 22 cm)', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link:'DisposablesCard' },
    { id: 12, title: 'BB Home', objectname: 'Facial Tissues - 2 Ply -100% Virgin Pulp/Paper', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'DisposablesCard' },
  ];
