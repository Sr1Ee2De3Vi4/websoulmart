...
import card1 from'../../assets/mop1.jpg'
import card2 from'../../assets/mop2.jpg'
import card3 from'../../assets/mop3.jpg'
import card4 from'../../assets/mop4.jpg'
import card5 from'../../assets/mop5.jpg'
import card6 from'../../assets/mop6.jpg'
import card7 from'../../assets/mop7.jpg'
import card8 from'../../assets/mop8.jpg'
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Mops, Brushes & Scrubs</label>
                        </div>
                        <div class="col-3">
...
const categorydatas = [
    ...
    {
        datas: "Brooms & Dust Pans",
        url:"/Mops"
    },
    {
        datas: "Dust Cloth & Wipes",
        url:"/Mops"
    ...
    {
        datas: "Toilet & Other Brushes",
        url:"/Mops"
    },
    {
        datas: "Utensil Scrub-Pad, Glove",
        url:"/Mops"
...
const griditems = [
    { id: 1, title: 'Scotch brite', objectname: 'Scrub Sponge Large', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'MopsCard' },
    { id: 2, title: 'Scotch brite', objectname: 'Steel Scrubber Combo', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 ,card_link:'MopsCard' },
    { id: 3, title: 'bb Combo', objectname: 'Lizol Surface Cleaner - Citrus 975 ml + Scotch Brite Floor Cleaning Cloth 1 pc', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link:'MopsCard'  },
    { id: 4, title: 'Scotch brite', objectname: 'Sponge Wipe Large', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 ,card_link:'MopsCard' },
    { id: 5, title: 'Scotch brite', objectname: 'Scrub Pad', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 ,card_link:'MopsCard' },
    { id: 6, title: 'BB Home', objectname: 'Mop Bucket 360 Degree Spin with 2 Refills,Blue 1pc + Floor Cleaner-Citrus 500ml', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 ,card_link:'MopsCard' },
    { id: 7, title: 'Exo', objectname: 'Safal Steel Scrubber', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 ,card_link:'MopsCard' },
    { id: 8, title: 'bb Combo', objectname: 'Colin Cleaner - Glass and Household 500 ml + Scotch Brite Sponge Wipe Large 1 pc', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 ,card_link:'MopsCard' },
    { id: 9, title: 'Scotch brite', objectname: 'Scrub Sponge Large', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 ,card_link:'MopsCard' },
    { id: 10, title: 'Scotch brite', objectname: 'Steel Scrubber Combo', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link:'MopsCard'  },
    { id: 11, title: 'bb Combo', objectname: 'Lizol Surface Cleaner - Citrus 975 ml + Scotch Brite Floor Cleaning Cloth 1 pc', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 ,card_link:'MopsCard' },
    { id: 12, title: 'Scotch brite', objectname: 'Sponge Wipe Large', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'MopsCard'  },
    { id: 13, title: 'Scotch brite', objectname: 'Scrub Pad', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 ,card_link:'MopsCard' },
    { id: 14, title: 'BB Home', objectname: 'Mop Bucket 360 Degree Spin with 2 Refills,Blue 1pc + Floor Cleaner-Citrus 500ml', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 ,card_link:'MopsCard' },
    { id: 15, title: 'Exo', objectname: 'Safal Steel Scrubber', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 ,card_link:'MopsCard' },
    { id: 16, title: 'bb Combo', objectname: 'Colin Cleaner - Glass and Household 500 ml + Scotch Brite Sponge Wipe Large 1 pc', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8,card_link:'MopsCard'  },
  ];
