...
import './edible.css';
import slide2 from'../../assets/edibleslide1.jpg'
import slide3 from'../../assets/edibleslide2.jpg'
import slide4 from'../../assets/edibleslide3.jpg'
import slide8 from'../../assets/edibleslide4.jpg'
...
<div className="uk-width-3-4" style={{}}>
 {/* fruits and veg cards */}
        ...
        <label class="header-label  ">Edible Oils & Ghee</label> 
        </div>
        <div class="col-3">
...
<label class="header-labels ">Edible Oils & Ghee</label>
</div>
<div>
...
const griditems = [
    { id: 1, title: 'BORGES', objectname: 'Olive Oil - Extra Light', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link : 'Ediblecard' },
    { id: 2, title: 'BORGES',objectname: 'Cow Ghee', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link : 'Ediblecard' },
    { id: 3, title: 'Parsi Dairy Far',objectname: 'Cow Ghee', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link : 'Ediblecard' },
    { id: 4, title: 'BORGES',objectname: 'Olive Oil - Extra Light', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link : 'Ediblecard' },
    { id: 5, title: 'Parsi Dairy Farm', objectname: 'Saffola Gold - Pro Healthy Lifestyle Edible Oil 2x5L Jar + BB Popular Sugar 5kg', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5,card_link : 'Ediblecard' },
    { id: 6, title: 'Parsi Dairy Farm', objectname: 'Sunflower Refined Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6,card_link : 'Ediblecard' },
    { id: 7, title: 'Fortune', objectname: 'Gold - Pro Healthy Lifestyle Edible Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7,card_link : 'Ediblecard' },
    { id: 8, title: 'Fortune', objectname: 'Saffola Tasty-Pro Fitness Conscious Edible Oil 3x1L + BB Royal Cumin Whole 100g', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8,card_link : 'Ediblecard' },
    { id: 9, title: 'BORGES', objectname: 'Olive Oil - Extra Light', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link : 'Ediblecard' },
    { id: 10, title: 'BORGES',objectname: 'Cow Ghee', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link : 'Ediblecard' },
    { id: 11, title: 'Parsi Dairy Far',objectname: 'Cow Ghee', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link : 'Ediblecard' },
    { id: 12, title: 'BORGES',objectname: 'Olive Oil - Extra Light', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link : 'Ediblecard' },
    { id: 13, title: 'Parsi Dairy Farm', objectname: 'Saffola Gold - Pro Healthy Lifestyle Edible Oil 2x5L Jar + BB Popular Sugar 5kg', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5,card_link : 'Ediblecard' },
    { id: 14, title: 'Parsi Dairy Farm', objectname: 'Sunflower Refined Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6,card_link : 'Ediblecard' },
    { id: 15, title: 'Fortune', objectname: 'Gold - Pro Healthy Lifestyle Edible Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7,card_link : 'Ediblecard' },
    { id: 16, title: 'Fortune', objectname: 'Saffola Tasty-Pro Fitness Conscious Edible Oil 3x1L + BB Royal Cumin Whole 100g', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8,card_link : 'Ediblecard' },
 
  ];



export default edible1;
