...
import './rice.css';
import slide2 from'../../assets/riceslide1.jpg'
import slide3 from'../../assets/riceslide2.png'
import slide4 from'../../assets/riceslide3.jpg'

import veg from'../../assets/veg.png'
import card1 from'../../assets/rices1.jpg'
import card2 from'../../assets/rices2.jpg'
import card3 from'../../assets/rices3.jpg'
import card4 from'../../assets/rices4.jpg'
import card5 from'../../assets/rices5.jpg'
import card6 from'../../assets/rices6.jpg'
import card7 from'../../assets/rices7.jpg'
import card8 from'../../assets/rices8.jpg'
...
<div className="uk-width-3-4" style={{}}>
 {/* fruits and veg cards */}
        ...
        <label class="header-label  ">Rice & Rice Products</label> 
        </div>
        <div class="col-3">
...
<label class="header-labels ">Rice & Rice Products</label>
</div>
<div>
...
const categorydatas = [
    {
    title: "Category",
    pagename:"Rice & Rice Products ",
    pageurl:"/riceproducts",
    content: [
    {
        datas: "Basmati Rice ",
        url:"/riceproducts"
    ...
    {
        datas: "Boiled & Steam Rice",
        url:"/riceproducts"
    },
    {
        datas: "Poha, Sabudana & Murmura ",
        url:"/riceproducts"
    },
...
const griditems = [
    { id: 1, title: 'bb Royal', objectname: 'Sabudana Big/Sabudana Motha', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'Ricecard' },
    { id: 2, title: 'bb Royal',objectname: 'Poha/Avalakki/Aval/Chivda - Thick', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link:'Ricecard' },
    { id: 3, title: 'bb Royal',objectname: 'Poha/Avalakki/Aval/Chivda - Thick', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link:'Ricecard' },
    { id: 4, title: 'bb Royal',objectname: 'Surti Kolam Rice/Surti Kolam Tandool', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'Ricecard' },
    { id: 5, title: 'bb Royal', objectname: 'Wada Kolam Rice', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5,card_link:'Ricecard' },
    { id: 6, title: 'bb Royal', objectname: 'Rice Surti Kolam/Tandool Surti Kolam', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6,card_link:'Ricecard' },
    { id: 7, title: 'bb Royal', objectname: 'Kolam Rice/Kolam Tandool', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7,card_link:'Ricecard' },
    { id: 8, title: 'bb Royal', objectname: 'Idli Rice', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8,card_link:'Ricecard' },
    { id: 9, title: 'bb Royal', objectname: 'Sabudana Big/Sabudana Motha', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1,card_link:'Ricecard' },
    { id: 10, title: 'bb Royal',objectname: 'Poha/Avalakki/Aval/Chivda - Thick', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2,card_link:'Ricecard' },
    { id: 11, title: 'bb Royal',objectname: 'Poha/Avalakki/Aval/Chivda - Thick', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3,card_link:'Ricecard' },
    { id: 12, title: 'bb Royal',objectname: 'Surti Kolam Rice/Surti Kolam Tandool', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4,card_link:'Ricecard' },
    { id: 13, title: 'bb Royal', objectname: 'Wada Kolam Rice', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5,card_link:'Ricecard' },
    { id: 14, title: 'bb Royal', objectname: 'Rice Surti Kolam/Tandool Surti Kolam', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6,card_link:'Ricecard' },
    { id: 15, title: 'bb Royal', objectname: 'Kolam Rice/Kolam Tandool', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7,card_link:'Ricecard' },
    { id: 16, title: 'bb Royal', objectname: 'Idli Rice', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8,card_link:'Ricecard' },
