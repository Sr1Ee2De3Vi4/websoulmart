...
const griditems = [
    { id: 1, title: 'Figaro', objectname: 'Pure Olive Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 2, title: 'Johnsons baby', objectname: 'No More Tears Baby Shampoo', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 3, title: 'Baby Dove', objectname: 'Rich Moisture Bar', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 4, title: 'Colgate', objectname: 'Kids Toothpaste - 6-9 Years, Natural Strawberry Mint Flavour, 0% Artificial', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
    { id: 5, title: 'Colgate', objectname: 'Kids Toothpaste - 3-5 years, Natural Strawberry Flavour, 0% Artificial', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 },
    { id: 6, title: 'Himalaya Baby', objectname: 'Shampoo - Gentle Baby', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 },
    { id: 7, title: 'Colgate', objectname: 'Toothbrush Superhero Assorted, Batman/Spiderman', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 },
    { id: 8, title: 'Colgate', objectname: 'Kids Toothpaste - 6+ Years, Strawberry Flavour, Barbie', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 },
    { id: 9, title: 'Figaro', objectname: 'Pure Olive Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 10, title: 'Johnsons baby', objectname: 'No More Tears Baby Shampoo', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 11, title: 'Baby Dove', objectname: 'Rich Moisture Bar', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 12, title: 'Colgate', objectname: 'Kids Toothpaste - 6-9 Years, Natural Strawberry Mint Flavour, 0% Artificial', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
   
  ];
  

export default CardBabybath;