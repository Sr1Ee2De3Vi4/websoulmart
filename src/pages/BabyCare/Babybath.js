...
import card1 from '../../assets/bath1.webp'
import card2 from '../../assets/bath2.webp'
import card3 from '../../assets/bath3.webp'
import card4 from '../../assets/bath4.webp'
import card5 from '../../assets/bath5.webp'
import card6 from '../../assets/bath6.webp'
import card7 from '../../assets/bath7.jpg'
import card8 from '../../assets/bath8.jpg'
...
function Babybath() {
  ...
  return (
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Baby Bath & Hygiene</label>
                        </div>
                        <div class="col-3">
        ...
        <div className="sm_card_grid uk-align-center content_width">
            <div className="uk-grid  uk-width-1-1">
                <div className="uk-width-5-6@s uk-width-2-3">
                    <label class="header-labels ">Baby Bath & Hygiene</label>
                </div>
    ...
    const categorydatas = [
        ...
        {
            datas: "Baby Creams & Lotions",
            url:"/Babybath"
        },
        {
            datas: "Baby Gift Sets",
            url:"/Babybath"
        },
        {
            datas: "Baby Health",
    ...
    {
            datas: "Baby Oil & Shampoo",
            url:"/Babybath"
        },
        {
            datas: "Baby Oral Care",
            url:"/Babybath"
        },
        {
            datas: "Baby Powder",
...
const griditems = [
    { id: 1, title: 'Figaro', objectname: 'Pure Olive Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardBabybath'},
    { id: 2, title: 'Johnsons baby', objectname: 'No More Tears Baby Shampoo', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardBabybath'},
    { id: 3, title: 'Baby Dove', objectname: 'Rich Moisture Bar', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardBabybath'},
    { id: 4, title: 'Colgate', objectname: 'Kids Toothpaste - 6-9 Years, Natural Strawberry Mint Flavour, 0% Artificial', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardBabybath'},
    { id: 5, title: 'Colgate', objectname: 'Kids Toothpaste - 3-5 years, Natural Strawberry Flavour, 0% Artificial', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardBabybath'},
    { id: 6, title: 'Himalaya Baby', objectname: 'Shampoo - Gentle Baby', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6, card_link:'CardBabybath'},
    { id: 7, title: 'Colgate', objectname: 'Toothbrush Superhero Assorted, Batman/Spiderman', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardBabybath'},
    { id: 8, title: 'Colgate', objectname: 'Kids Toothpaste - 6+ Years, Strawberry Flavour, Barbie', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardBabybath'},
    { id: 9, title: 'Figaro', objectname: 'Pure Olive Oil', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardBabybath'},
    { id: 10, title: 'Johnsons baby', objectname: 'No More Tears Baby Shampoo', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardBabybath'},
    { id: 11, title: 'Baby Dove', objectname: 'Rich Moisture Bar', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardBabybath'},
    { id: 12, title: 'Colgate', objectname: 'Kids Toothpaste - 6-9 Years, Natural Strawberry Mint Flavour, 0% Artificial', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardBabybath'},
