...
import card1 from '../../assets/access1.jpg'
import card2 from '../../assets/access2.jpg'
import card3 from '../../assets/access3.jpg'
import card4 from '../../assets/access4.jpg'
import card5 from '../../assets/access5.jpg'
import card6 from '../../assets/access6.jpg'
import card7 from '../../assets/access7.jpg'
import card8 from '../../assets/access8.jpg'
import icon1 from '../../assets/truck.svg'

function BabyAccessories() {
  ...
  return (
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Baby Accessories</label>
                        </div>
                        <div class="col-3">
        ...
        <div className="sm_card_grid uk-align-center content_width">
            <div className="uk-grid  uk-width-1-1">
                <div className="uk-width-5-6@s uk-width-2-3">
                    <label class="header-labels ">Baby Accessories</label>
                </div>
    ...
    const categorydatas = [
        ...
        {
            datas: "Combs, Brushes, Clippers",
            url:"/BabyAccessories"
        },
        {
            datas: "Other Baby Accessories",
            url:"/BabyAccessories"
        },
        ]
    }
    ...
    const griditems = [
        { id: 1, title: 'Morison Baby Dreams', objectname: 'Bib - Dolphin & Star Printed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardBabyaccess'},
        { id: 2, title: 'Morison Baby Dreams', objectname: 'Bib - Ice Cream Printed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardBabyaccess'},
        { id: 3, title: 'Morison Baby Dreams', objectname: 'Bib - Butterfly & Moon Printed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardBabyaccess'},
        { id: 4, title: 'Morison Baby Dreams', objectname: 'Bib - Car Printed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardBabyaccess'},
        { id: 5, title: 'Morison Baby Dreams', objectname: 'Quick Electric Sterilizer - 6 Bottles', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardBabyaccess'},
        { id: 6, title: 'Mee Mee', objectname: 'Baby Gentle Nail Clipper With Magnifier - White & Blue', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardBabyaccess'},
        { id: 7, title: 'Chicco', objectname: 'Nail Clipper Scissor Cutter Set - Girl', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardBabyaccess'},
        { id: 8, title: 'Munchkin', objectname: 'Fun Ice Chewy Teethers - Green & Pink, 4 m+', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardBabyaccess'},
        { id: 9, title: 'Morison Baby Dreams', objectname: 'Bib - Dolphin & Star Printed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardBabyaccess'},
        { id: 10, title: 'Morison Baby Dreams', objectname: 'Bib - Ice Cream Printed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardBabyaccess'},
        { id: 11, title: 'Morison Baby Dreams', objectname: 'Bib - Butterfly & Moon Printed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardBabyaccess'},
        { id: 12, title: 'Morison Baby Dreams', objectname: 'Bib - Car Printed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardBabyaccess'},
       
      ];



export default BabyAccessories;
