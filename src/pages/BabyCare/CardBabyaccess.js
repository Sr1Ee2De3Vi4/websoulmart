...
const categorydatas = [
    ...
    {
        datas: "Baby Fashion Accessories",
        url:"/BabyAccessories"
    },
    {
...
const griditems = [
    { id: 1, title: 'Morison Baby Dreams', objectname: 'Bib - Dolphin & Star Printed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 2, title: 'Morison Baby Dreams', objectname: 'Bib - Ice Cream Printed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 3, title: 'Morison Baby Dreams', objectname: 'Bib - Butterfly & Moon Printed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 4, title: 'Morison Baby Dreams', objectname: 'Bib - Car Printed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
    { id: 5, title: 'Morison Baby Dreams', objectname: 'Quick Electric Sterilizer - 6 Bottles', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 },
    { id: 6, title: 'Mee Mee', objectname: 'Baby Gentle Nail Clipper With Magnifier - White & Blue', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 },
    { id: 7, title: 'Chicco', objectname: 'Nail Clipper Scissor Cutter Set - Girl', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 },
    { id: 8, title: 'Munchkin', objectname: 'Fun Ice Chewy Teethers - Green & Pink, 4 m+', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 },
    { id: 9, title: 'Morison Baby Dreams', objectname: 'Bib - Dolphin & Star Printed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 10, title: 'Morison Baby Dreams', objectname: 'Bib - Ice Cream Printed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 11, title: 'Morison Baby Dreams', objectname: 'Bib - Butterfly & Moon Printed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 12, title: 'Morison Baby Dreams', objectname: 'Bib - Car Printed', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
   
  ];
  

export default CardBabyaccess;