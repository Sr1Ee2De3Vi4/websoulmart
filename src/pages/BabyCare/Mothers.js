...
import card1 from '../../assets/mother1.jpg'
import card2 from '../../assets/mother2.jpg'
import card3 from '../../assets/mother3.jpg'
import card4 from '../../assets/mother4.jpg'
import card5 from '../../assets/mother5.jpg'
import card6 from '../../assets/mother6.jpg'
import card7 from '../../assets/mother7.jpg'
import card8 from '../../assets/mother8.jpg'
...
function Mothers() {
  ...
  return (
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Mothers & Maternity</label>
                        </div>
                        <div class="col-3">
        ...
        <div className="sm_card_grid uk-align-center content_width">
            <div className="uk-grid  uk-width-1-1">
                <div className="uk-width-5-6@s uk-width-2-3">
                    <label class="header-labels ">Mothers & Maternity</label>
                </div>
    ...
    const categorydatas = [
        ...
        {
            datas: "Maternity Health Supplements",
            url:"/Mothers"
        },
        {
            datas: "Maternity Personal Care",
            url:"/Mothers"
        },
        ]
    }
...
const griditems = [
    { id: 1, title: 'Bio-Oil', objectname: 'Specialist Skin Care Oil - Scars, Stretch Mark, Ageing, Uneven Skin Tone', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardMothers'},
    { id: 2, title: 'Horlicks', objectname: 'Mothers Health & Nutrition Drink - Vanilla Flavour, No Added Sugar', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardMothers'},
    { id: 3, title: 'Sirona', objectname: 'Disposable Maternity & Nursing Breast Pads For Women', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardMothers'},
    { id: 4, title: 'Sirona', objectname: 'Premium Disposable Maternity Breast Pads', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardMothers'},
    { id: 5, title: 'Himalaya', objectname: 'Moisture Rich Rose Soap - For Moms', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardMothers'},
    { id: 6, title: 'Himalaya', objectname: 'Moisture Rich Jasmine Soap - For Moms', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardMothers'},
    { id: 7, title: 'Mee Mee', objectname: 'Ultra Thin Super Absorbent Breast Pads - Disposable Nursing', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardMothers'},
    { id: 8, title: 'The Moms Co', objectname: 'Natural Nipple Butter For Breastfeeding Moms', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardMothers'},
