...
const griditems = [
    { id: 1, title: 'Bio-Oil', objectname: 'Specialist Skin Care Oil - Scars, Stretch Mark, Ageing, Uneven Skin Tone', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 },
    { id: 2, title: 'Horlicks', objectname: 'Mothers Health & Nutrition Drink - Vanilla Flavour, No Added Sugar', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 },
    { id: 3, title: 'Sirona', objectname: 'Disposable Maternity & Nursing Breast Pads For Women', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 },
    { id: 4, title: 'Sirona', objectname: 'Premium Disposable Maternity Breast Pads', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 },
    { id: 5, title: 'Himalaya', objectname: 'Moisture Rich Rose Soap - For Moms', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 },
    { id: 6, title: 'Himalaya', objectname: 'Moisture Rich Jasmine Soap - For Moms', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 },
    { id: 7, title: 'Mee Mee', objectname: 'Ultra Thin Super Absorbent Breast Pads - Disposable Nursing', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 },
    { id: 8, title: 'The Moms Co', objectname: 'Natural Nipple Butter For Breastfeeding Moms', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 },
    
   
  ];
  

export default CardMothers;