...
import card1 from '../../assets/feeding1.jpg'
import card2 from '../../assets/feeding2.jpg'
import card3 from '../../assets/feeding3.jpg'
import card4 from '../../assets/feeding4.jpg'
import card5 from '../../assets/feeding5.jpg'
import card6 from '../../assets/feeding6.jpg'
import card7 from '../../assets/feeding7.jpg'
import card8 from '../../assets/feeding8.jpg'
                ...
                <div className="uk-width-3-4" style={{}}>
                    ...
                    <div class="row uk-margin-medium-top ">
                        <div class="col-9 uk-padding-remove-left">
                            <label class="header-label  ">Feeding & Nursing</label>
                        </div>
                        <div class="col-3">
        ...
        <div className="sm_card_grid uk-align-center content_width">
            <div className="uk-grid  uk-width-1-1">
                <div className="uk-width-5-6@s uk-width-2-3">
                    <label class="header-labels ">Feeding & Nursing</label>
                </div>
...
const griditems = [
    { id: 1, title: 'Vauva', objectname: 'Silicone Feeding Nipple/Teat Regular Neck - Size XL', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardFeeding'},
    { id: 2, title: 'Vauva', objectname: 'Baby Feeding Bottles For Milk & Water', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardFeeding'},
    { id: 3, title: 'Vauva', objectname: 'Baby Feeding Bottles For Milk & Water', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardFeeding'},
    { id: 4, title: 'Vauva', objectname: 'Baby Feeding Bottles For Milk & Water', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardFeeding'},
    { id: 5, title: 'Vauva', objectname: 'Baby Feeding Bottles For Milk & Water', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card5 , card_link:'CardFeeding'},
    { id: 6, title: 'Vauva', objectname: 'Baby Feeding Bottles For Milk & Water With Handle', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card6 , card_link:'CardFeeding'},
    { id: 7, title: 'Vauva', objectname: 'Silicone Feeding Nipple/Teat Regular Neck - Size S', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card7 , card_link:'CardFeeding'},
    { id: 8, title: 'Vauva', objectname: 'Silicone Feeding Nipple/Teat Regular Neck - Size M', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card8 , card_link:'CardFeeding'},
    { id: 9, title: 'Vauva', objectname: 'Silicone Feeding Nipple/Teat Regular Neck - Size XL', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card1 , card_link:'CardFeeding' },
    { id: 10, title: 'Vauva', objectname: 'Baby Feeding Bottles For Milk & Water', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card2 , card_link:'CardFeeding'},
    { id: 11, title: 'Vauva', objectname: 'Baby Feeding Bottles For Milk & Water', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card3 , card_link:'CardFeeding'},
    { id: 12, title: 'Vauva', objectname: 'Baby Feeding Bottles For Milk & Water', select1: '1 Kg Rs:20.00', select2: '2 Kg Rs:40.00', oldprice: 'Rs. 25', newprice: 'Rs. 20', pic: card4 , card_link:'CardFeeding'},
